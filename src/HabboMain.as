package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1023:Number = 0.71;
      ...
      private var var_1409:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1347,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_22);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1347,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1409 = HabboTracking.getInstance();
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_201,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_201,null);
         }
         if(this.var_26)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_201,null);
         }
      }
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1409 && !this.var_1409.disposed)
                  {
                     this.var_1409.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1023 + this.var_26.getNumberOfFilesLoaded() / _loc11_ * const_1023;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
