package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      public function ProfilerViewer(param1:IProfiler)
      {
         ...
         {
            this.var_230 = param1;
            this.var_230.addStopEventListener(this.refresh);
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_230)
            {
               this.var_230.removeStopEventListener(this.refresh);
               this.var_230 = null;
            }
            this._disposed = true;
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_230.getProfilerAgentsInArray();
