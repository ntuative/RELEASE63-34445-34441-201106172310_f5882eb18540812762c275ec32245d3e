package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_752:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_752.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_752.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_752.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_752.remove(param1);
         var_752.add(param1,param2);
      }
