   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               IDisposable(this.var_341[_loc1_]).dispose();
      ...
      {
         this.var_3042 = getTimer() - this.var_2010;
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_341)
         {
            _loc2_ = _loc3_ as IUpdateReceiver;
            if(IDisposable(_loc3_).disposed)
            {
               IDisposable(this.var_341[_loc3_]).dispose();
               delete this.var_341[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_341[_loc3_]);
            }
         }
         return _loc1_;
      }
      ...
      {
         var _loc2_:ProfilerAgent = this.var_341[param1];
