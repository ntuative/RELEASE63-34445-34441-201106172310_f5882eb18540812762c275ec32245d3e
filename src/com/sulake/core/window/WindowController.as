package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1399:String = "_COLORIZE";
      
      protected static const const_1400:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1111:Point = new Point();
      ...
      protected var var_729:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_391 = new Rectangle();
         if(_loc12_ != null)
         {
            var_421 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_421.clone();
            var_11 = var_421.clone();
         ...
         if(_loc13_)
         {
            ...
            var_499 = _loc13_.var_2991;
            if(var_500 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_260 != _loc13_.color)
            {
      ...
      {
         return this.var_729 != null ? this.var_729 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_500 = param1;
         var_260 = !!var_500 ? uint(var_260 | var_593) : uint(var_260 & 16777215);
      ...
      {
         var_593 = param1 & 4278190080;
         var_260 = !!var_500 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_593 = param1 << 24;
         var_260 = !!var_500 ? uint(var_593 | var_260) : uint(16777215 & var_260);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1335);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_874);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_91)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1400) == -1)
               {
                  _loc4_.style = var_91;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_391 = this._parent.rectangle.clone();
               var_68.x = var_11.x;
               var_68.y = var_11.y;
            ...
            else
            {
               this.var_391.x = 0;
               this.var_391.y = 0;
               this.var_391.width = 0;
               this.var_391.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1806,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_982,var_11);
            this.var_22.visible = var_318;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_91,var_21,_context,var_11,null,this.var_729,this.properties,var_908.concat(),_id) as WindowController;
         _loc2_.var_499 = var_499;
         _loc2_.var_188 = this.var_188;
         _loc2_._debug = this._debug;
         _loc2_.var_391 = this.var_391.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_421 = var_421.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2776 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_519)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_487)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_162 != null)
         {
            param3.x = var_162.x;
            param3.y = var_162.y;
            param3.width = var_162.width;
            param3.height = var_162.height;
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_162.x = param2.x;
            var_162.y = param2.y;
            var_162.width = param2.width;
            var_162.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_915))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  if(testParamFlag(WindowParam.const_439))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_371:
                  return false;
            }
         }
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_42:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_599,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_228,WindowParam.const_178))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_208,WindowParam.const_192))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
               ...
               case WindowEvent.const_447:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1309);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1767,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowEvent.const_599:
                  this._parent.getRegionProperties(null,this.var_391);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_499);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_499);
      }
         ...
         if(this.var_188 && var_499 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1111,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1111,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_91 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1400) == -1)
               {
                  _loc6_.style = var_91;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_143,WindowParam.const_178);
         var _loc2_:* = !testParamFlag(WindowParam.const_164,WindowParam.const_192);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_391.width;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_434)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_423)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_391.height;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_348)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_253)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_506)
         {
            return true;
         }
         _state = WindowState.const_506;
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_320,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1715,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1919,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1861,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1828,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2004,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_732,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_746,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1281 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_658,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1281 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_658,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_392,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function method_5(param1:uint, param2:Array, param3:Boolean = false) : uint
      {
         var _loc4_:* = null;
         var _loc5_:* = 0;
         for each(_loc4_ in this._children)
         {
            ...
            if(param3)
            {
               _loc5_ += _loc4_.method_5(param1,param2,param3);
            }
         }
         return _loc5_;
      }
