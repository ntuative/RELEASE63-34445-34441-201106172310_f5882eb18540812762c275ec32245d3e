package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_982:uint = 1;
      
      public static const const_1199:uint = 2;
      
      public static const const_889:uint = 4;
      
      public static const const_1926:uint = 8;
      
      public static const const_1705:uint = 16;
      
      public static const const_2161:uint = 64;
      
      public static const const_2084:uint = 128;
      
      public static const const_1364:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1199:
               ...
               break;
            case GraphicContext.const_1926:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1705:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_889:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1364:
               break;
            case GraphicContext.const_1988:
               break;
            default:
         ...
         if(this.var_914)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2217,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2217,16777215);
                  }
                  var_354 += bitmap.width * bitmap.height * 4;
               }
