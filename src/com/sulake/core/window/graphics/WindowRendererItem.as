package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_694:uint = 0;
      
      private static const const_1091:uint = 1;
      
      private static const const_1092:uint = 2;
       
      
      private var var_129:BitmapData;
      
      private var var_174:WindowRenderer;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1525 = 4294967295;
         this.var_1002 = 0;
         this.var_884 = new ColorTransform();
         this.var_1131 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1092) : uint(const_694);
         var _loc6_:Boolean = this.var_198.width > 0 && this.var_198.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1002))
            {
               _loc5_ = const_1091;
            }
         }
         ...
         if(_loc5_ != const_694)
         {
            this.var_1525 = this.var_1002;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1091)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_664)
                  {
                     ...
                     _loc7_.draw(param1,this.var_129,this.var_129.rect,this.var_1002,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1131.tx = param2.x;
                     this.var_1131.ty = param2.y;
                     this.var_884.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_129,this.var_1131,this.var_884,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1525;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1309:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_874:
               this.var_1002 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1002 != this.var_1525)
               {
                  this.var_664 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1335:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_664 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1214:
               _loc4_ = true;
         }
         if(_loc4_)
         {
