package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1577:String = "skin";
      
      private static const const_1573:String = "bitmap";
      
      private static const const_1575:String = "fill";
      
      private static const const_1574:String = "text";
      
      private static const const_1576:String = "label";
      
      private static const const_1572:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1957,this.var_2709);
         this.var_2710 = new Dictionary();
         this.var_2708 = new Dictionary();
         StateCodeTable.fillTables(this.var_2710,this.var_2708);
         this.var_458 = new Dictionary();
         this.var_458[const_1577] = BitmapSkinRenderer;
         this.var_458[const_1573] = BitmapDataRenderer;
         this.var_458[const_1575] = FillSkinRenderer;
         this.var_458[const_1574] = TextSkinRenderer;
         this.var_458[const_1576] = LabelRenderer;
         this.var_458[const_1572] = ShapeSkinRenderer;
         ...
         if(var_355 == null)
         {
            ...
            var_355.push(WindowState.const_97);
            var_355.push(WindowState.const_55);
            var_355.push(WindowState.const_92);
            var_355.push(WindowState.const_88);
            var_355.push(WindowState.const_93);
            var_355.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "TeleportErrorHandler" : false;
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1030[param1] = new Array(const_1101);
         }
         this.var_1030[param1][param2] = param3;
         if(this.var_1029[param1] == null)
         {
            this.var_1029[param1] = new Array(const_1101);
         }
