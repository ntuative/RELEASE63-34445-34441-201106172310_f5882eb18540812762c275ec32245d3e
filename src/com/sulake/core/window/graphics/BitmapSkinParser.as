package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "TeleportErrorHandler";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "TeleportErrorHandler";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_347 = SkinLayoutEntity.const_652;
                  break;
               case "move":
                  _loc5_.var_347 = SkinLayoutEntity.const_362;
                  break;
               case "strech":
                  _loc5_.var_347 = SkinLayoutEntity.const_544;
                  break;
               case "tiled":
                  _loc5_.var_347 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_347 = SkinLayoutEntity.const_563;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_349 = SkinLayoutEntity.const_652;
                  break;
               case "move":
                  _loc5_.var_349 = SkinLayoutEntity.const_362;
                  break;
               case "strech":
                  _loc5_.var_349 = SkinLayoutEntity.const_544;
                  break;
               case "tiled":
                  _loc5_.var_349 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_349 = SkinLayoutEntity.const_563;
            }
         }
