package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_596:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_596[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_596[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_596[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_596[param1.name];
         }
         return param1;
      }
