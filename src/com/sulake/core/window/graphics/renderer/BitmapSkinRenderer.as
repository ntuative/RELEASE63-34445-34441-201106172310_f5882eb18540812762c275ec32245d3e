package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_919:Dictionary;
      
      protected var var_918:Dictionary;
      
      private var var_298:Matrix;
      ...
      {
         super(param1);
         this.var_919 = new Dictionary(false);
         this.var_918 = new Dictionary(false);
         this.var_298 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_298 = null;
            this.var_884 = null;
            for(_loc1_ in this.var_919)
            {
               _loc2_ = this.var_919[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_919[_loc1_];
            }
            this.var_919 = null;
            for(_loc1_ in this.var_918)
            {
               _loc2_ = this.var_918[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_918[_loc1_];
            }
            this.var_918 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_884.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_884.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_884.blueMultiplier = (param1.color & 255) / 255;
               this.var_884.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_884);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_347 == SkinLayoutEntity.const_362)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_544)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_325)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_347 == SkinLayoutEntity.const_563)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_349 == SkinLayoutEntity.const_362)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_544)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_325)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_563)
                  {
                  ...
                  else if(_loc10_.var_349 == SkinLayoutEntity.const_325 || _loc10_.var_347 == SkinLayoutEntity.const_325)
                  {
                  ...
                  {
                     this.var_298.a = REGION.width;
                     this.var_298.d = REGION.height;
                     this.var_298.tx = REGION.x;
                     this.var_298.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_298,ALPHA);
                  }
                  else
                  {
                     this.var_298.a = 0 / _loc18_.width;
                     this.var_298.d = 0 / _loc18_.height;
                     this.var_298.tx = 0;
                     this.var_298.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_298);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_298,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_347 == SkinLayoutEntity.const_362)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_349 == SkinLayoutEntity.const_362)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_919[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_918[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
