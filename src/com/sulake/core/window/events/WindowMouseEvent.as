package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_155:String = "WME_DOUBLE_CLICK";
      
      public static const const_44:String = "WME_DOWN";
      
      public static const const_2140:String = "WME_MIDDLE_CLICK";
      
      public static const const_2148:String = "WME_MIDDLE_DOWN";
      
      public static const const_2128:String = "WME_MIDDLE_UP";
      ...
      public static const const_298:String = "WME_UP_OUTSIDE";
      
      public static const const_371:String = "WME_WHEEL";
      
      public static const const_2217:String = "WME_RIGHT_CLICK";
      
      public static const const_2121:String = "WME_RIGHT_DOWN";
      
      public static const const_2184:String = "WME_RIGHT_UP";
      
      public static const const_1920:String = "WME_ROLL_OUT";
      
      public static const const_1882:String = "WME_ROLL_OVER";
      
      public static const const_2260:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_730 = param3;
         _loc13_.var_165 = false;
         _loc13_.var_731 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_504 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
