package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_326:String = "WKE_KEY_UP";
      ...
      public static function allocate(param1:String, param2:Event, param3:IWindow, param4:IWindow, param5:Boolean = false) : WindowKeyboardEvent
      {
         ...
         _loc6_.var_730 = param4;
         _loc6_.var_165 = false;
         _loc6_.var_504 = param5;
         _loc6_.var_731 = POOL;
         return _loc6_;
      }
      ...
      {
         return "WindowKeyboardEvent { type: " + _type + " cancelable: " + var_504 + " window: " + _window + " charCode: " + this.charCode + " }";
      }
   }
}
