package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_733:Point;
      
      protected var var_1660:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_733);
         this._window.offset(this.var_733.x - this._offset.x,this.var_733.y - this._offset.y);
      }
