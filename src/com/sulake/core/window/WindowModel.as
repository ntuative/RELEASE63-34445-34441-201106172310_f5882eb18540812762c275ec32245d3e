package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_421:Rectangle;
      ...
      protected var var_500:Boolean = false;
      
      protected var var_260:uint = 16777215;
      
      protected var var_593:uint;
      
      protected var var_499:uint = 10;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_91 = param4;
         this.var_908 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_11 = param7.clone();
         this.var_421 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_506;
            this.var_908 = null;
         }
      }
      ...
      {
         return this.var_421.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_421.height;
      }
