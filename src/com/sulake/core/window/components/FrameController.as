package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1592:String = "_TITLE";
      
      private static const const_1663:String = "_HEADER";
      
      private static const const_1665:String = "_CONTENT";
      
      private static const const_1664:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1641:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1592) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1641 = findChildByTag(const_1663) as IHeaderWindow;
            if(!this.var_1641)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1665) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1664) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1399,_loc2_,false);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,_loc3_.left,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_305,_loc3_.top,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_309,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_271,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         return _loc1_;
      }
