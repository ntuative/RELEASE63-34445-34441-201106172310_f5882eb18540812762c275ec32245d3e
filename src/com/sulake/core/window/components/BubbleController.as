package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2043:String = "_POINTER_UP";
      
      private static const const_2041:String = "_POINTER_DOWN";
      
      private static const const_2042:String = "_POINTER_LEFT";
      
      private static const const_2040:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_957,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1972);
         }
         return _loc1_;
      }
