package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1622:String = "increment";
      
      private static const const_1621:String = "decrement";
      
      private static const const_1124:String = "slider_track";
      
      private static const const_703:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_732:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_188 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_538;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_19.removeEventListener(WindowEvent.const_42,this.onScrollableResized);
            this.var_19.removeEventListener(WindowEvent.const_574,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_42,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_574,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1066 = _loc3_.value as String;
               this.var_19 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1124) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_703) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_703:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_371)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_732;
                  }
                  else
                  {
                     this.scrollV -= this.var_732;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_1006)
         {
            ...
            else if(param2.name == const_1621)
            {
               if(this.var_19)
               {
                  this.var_1317 = true;
            ...
            else if(param2.name == const_1124)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_703).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_371)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1066) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1066) as IScrollableWindow;
               if(_loc1_)
               {
