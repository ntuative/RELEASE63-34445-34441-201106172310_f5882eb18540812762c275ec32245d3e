package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_462:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_462)
         {
            this.var_462.removeEventListener(WindowEvent.const_302,this.scrollBarEventProc);
            this.var_462.removeEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            this.var_462 = null;
         }
         if(this.var_1276)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_462)
         {
            this.var_462 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_462)
            {
               this.var_462.addEventListener(WindowEvent.const_302,this.scrollBarEventProc);
               this.var_462.addEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            }
         }
         return this.var_462;
      }
