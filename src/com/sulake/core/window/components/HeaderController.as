package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1591:String = "_CONTROLS";
      ...
      {
         return findChildByTag(const_1592) as ILabelWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1591) as IItemListWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1399,_loc2_,true);
