package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_958:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_770:String;
      
      private var var_1172:String = null;
      
      private var var_1782:StyleSheet = null;
      ...
      {
         this.var_770 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1172 == param2)
         {
            return;
         }
         param1.var_1172 = param2;
         param1.var_1782 = null;
         if(param1.var_1172 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1172);
            param1.var_1782 = _loc3_;
         }
      }
      ...
      {
         return this.var_770 == LinkTarget.const_30 ? defaultLinkTarget : this.var_770;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1782;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1307)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_770 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_833,this.var_770,PropertyStruct.const_51,true,PropertyDefaults.const_792));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_833)
            {
               this.var_770 = _loc2_.value as String;
               break;
            }
