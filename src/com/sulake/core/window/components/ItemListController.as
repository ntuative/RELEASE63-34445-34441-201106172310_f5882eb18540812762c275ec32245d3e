package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2227:Boolean = false;
      ...
      protected var var_737:Number = -1.0;
      ...
      protected var var_2225:int = 0;
      
      protected var var_1401:Number;
      
      protected var var_1399:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_122 = 0;
         this.var_108 = 0;
         this._horizontal = param2 == WindowType.const_389;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_188 = var_500 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_424,WindowStyle.const_100,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_42,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_392,this.containerEventHandler);
         ...
         this.resizeOnItemUpdate = this.var_1400;
      }
      ...
      {
         return new Rectangle(this.var_734 * this.maxScrollH,this.var_735 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_734 = param1;
            this._container.x = -this.var_734 * this.maxScrollH;
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_735 = param1;
            this._container.y = -this.var_735 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_574,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_392,this.containerEventHandler);
      ...
      {
         return this._container.method_5(param1,param2,param3);
      }
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_180:
               if(this.var_1398)
               {
                  ...
                  this.var_1399 = this.var_2225 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1399 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1399 / this.var_108;
                  }
                  this.var_2226 = _loc3_;
                  this.var_2225 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_298:
               if(this.var_1398)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1399);
                  }
                  this.var_1398 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1130 && !this.var_600 && this._container)
         {
            this.var_600 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_444,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1338);
         }
         if(this.var_1130 != PropertyDefaults.const_1151)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_971,this.var_1130,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1751);
         }
         if(this.var_507 != PropertyDefaults.const_1251)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_834,this.var_507,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1792);
         }
         if(this.var_1400 != PropertyDefaults.const_1313)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_857,this.var_1400,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1925);
         }
         if(this.var_736 != PropertyDefaults.const_1223)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_938,this.var_736,PropertyStruct.const_126,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1782);
         }
         if(this.var_737 != PropertyDefaults.const_1250)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_946,this.var_737,PropertyStruct.const_126,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_946:
                  this.var_737 = _loc2_.value as Number;
                  break;
            }
         }
