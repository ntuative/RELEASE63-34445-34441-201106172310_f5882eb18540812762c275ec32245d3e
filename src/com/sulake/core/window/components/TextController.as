package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      private var var_480:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_480,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_480 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_480,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_215);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_870 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_480);
      }
      ...
      {
         return new Rectangle(this.var_915 * this.maxScrollH,this.var_597 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_480);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_791,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1152));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1299 ? new PropertyStruct(PropertyDefaults.const_899,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1243) : PropertyDefaults.const_1992);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_243,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1265 ? new PropertyStruct(PropertyDefaults.const_1311,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1379) : PropertyDefaults.const_1913);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_934) ? new PropertyStruct(PropertyDefaults.const_391,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1180);
         _loc1_.push(this.var_480 != TextStyleManager.const_215 ? new PropertyStruct(PropertyDefaults.const_418,this.var_480,PropertyStruct.const_51,true,PropertyDefaults.const_819) : PropertyDefaults.const_1273);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_763 ? new PropertyStruct(PropertyDefaults.const_255,this.var_42.left,PropertyStruct.const_39,true) : PropertyDefaults.const_771);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_995 ? new PropertyStruct(PropertyDefaults.const_305,this.var_42.top,PropertyStruct.const_39,true) : PropertyDefaults.const_839);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_823 ? new PropertyStruct(PropertyDefaults.const_309,this.var_42.right,PropertyStruct.const_39,true) : PropertyDefaults.const_910);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_974 ? new PropertyStruct(PropertyDefaults.const_271,this.var_42.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_926);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1306 ? new PropertyStruct(PropertyDefaults.const_753,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1836);
