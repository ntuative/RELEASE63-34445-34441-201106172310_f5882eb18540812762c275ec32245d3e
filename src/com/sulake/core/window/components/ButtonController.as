package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_459:String = "_BTN_TEXT";
      
      protected static const const_1402:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_459);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_302:
                  try
                  {
                     getChildByName(const_459).blend = getChildByName(const_459).blend + const_1402;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1383:
                  type = "null";
                  break;
               case WindowTouchEvent.const_1006:
                  type = "null";
            }
