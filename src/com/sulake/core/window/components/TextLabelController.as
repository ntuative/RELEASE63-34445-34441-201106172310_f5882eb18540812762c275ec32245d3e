package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_400:Object = null;
      ...
      {
         return this.var_400 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_480);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_400 != null)
            {
               _loc1_.textColor = uint(this.var_400);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_480 != param1.name)
         {
            this.var_480 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2827 = _loc2_.textWidth;
         this.var_2828 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_400 != _loc2_.color : this.var_400 != null && this.var_400 != PropertyDefaults.const_934) ? new PropertyStruct(PropertyDefaults.const_391,this.var_400,PropertyStruct.const_150,true) : PropertyDefaults.const_1180);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_763)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,this.var_42.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_771);
            }
            if(this.var_42.top != PropertyDefaults.const_995)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_305,this.var_42.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_839);
            }
            if(this.var_42.right != PropertyDefaults.const_823)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_309,this.var_42.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_910);
            }
            if(this.var_42.bottom != PropertyDefaults.const_974)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_271,this.var_42.bottom,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_926);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_418:
                  ...
                  break;
               case PropertyDefaults.const_391:
                  this.var_400 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_255:
                  ...
                  break;
               case PropertyDefaults.const_305:
                  if(this.var_42 || _loc2_.valid)
                  {
