package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1461:String = "_SELECTOR";
      
      private static const const_1460:String = "_CONTENT";
       
      
      protected var var_1121:ITabSelectorWindow;
      
      protected var var_2214:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1121 = findChildByTag(const_1461) as ITabSelectorWindow;
            if(this.var_1121 != null)
            {
               this.var_1121.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2214 == null)
         {
            this.var_2214 = findChildByTag(const_1460) as IWindowContainer;
         }
      ...
      {
         return !!this.var_897 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1121.numSelectables;
      }
      ...
      {
         return this.selector.method_1(param1) as ITabButtonWindow;
      }
