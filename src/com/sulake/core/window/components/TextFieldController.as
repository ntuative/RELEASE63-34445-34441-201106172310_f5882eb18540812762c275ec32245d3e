package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1684:uint = 500;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1199,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_897 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_326,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_825,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1908);
         _loc1_.push(this.var_1386 != PropertyDefaults.const_1346 ? new PropertyStruct(PropertyDefaults.const_836,this.var_1386,PropertyStruct.const_37,true) : PropertyDefaults.const_1848);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1334 ? new PropertyStruct(PropertyDefaults.const_731,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1821);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1262 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1814);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_825:
                  ...
                  break;
               case PropertyDefaults.const_1371:
