package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_632)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_632)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_850,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1886);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1318)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_861,param1.toolTipDelay,PropertyStruct.const_243,true));
         }
         else
         {
