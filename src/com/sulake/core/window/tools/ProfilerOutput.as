package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1444:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1443:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3022 = new Array();
         this.var_171 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1444() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1443() as ByteArray;
