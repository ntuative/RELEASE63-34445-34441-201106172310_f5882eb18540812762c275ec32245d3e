package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3038 = param3 == const_250 || param3 == const_137 || param3 == const_252 || param3 == const_294;
         this.var_2775 = param5;
      }
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_37:
               return Boolean(this.var_201) == true ? "TeleportErrorHandler" : "false";
            case const_252:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_250:
               ...
               _loc1_ = "<var key=\"" + this.var_681 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_294:
               ...
               break;
            case const_150:
               _loc1_ = "<var key=\"" + this.var_681 + "\" value=\"" + "0x" + uint(this.var_201).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_681 + "\" value=\"" + this.var_201 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
