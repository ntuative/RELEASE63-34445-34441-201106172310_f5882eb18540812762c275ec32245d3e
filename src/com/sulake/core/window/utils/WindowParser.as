package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1343:String = "_EXCLUDE";
      
      public static const const_2110:String = "_INCLUDE";
      
      public static const const_2221:String = "_TEMP";
      
      private static const const_1501:String = "layout";
      
      private static const const_1054:String = "window";
      
      private static const const_1053:String = "variables";
      
      private static const const_1052:String = "filters";
      
      private static const const_675:String = "name";
      
      private static const const_1495:String = "style";
      
      private static const const_684:String = "params";
      
      private static const const_1493:String = "tags";
      ...
      private static const const_1502:String = "visible";
      
      private static const const_1496:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1335:String = "blend";
      
      private static const const_1494:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1503:String = "treshold";
      
      private static const const_1497:String = "children";
      
      private static const const_1490:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1500:String = "height_min";
      
      private static const const_1492:String = "height_max";
      
      private static const const_685:String = "TeleportErrorHandler";
      
      private static const const_186:String = "0";
      
      private static const const_1491:String = "$";
      
      private static const const_1459:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1499:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1498:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1676:Dictionary;
      
      protected var var_2216:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1122,this.var_1676);
         this.var_2216 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1498,const_50);
         return param1.replace(const_1499,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1676)
            {
               delete this.var_1676[_loc1_];
            }
            this.var_2216.dispose();
            this.var_2216 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1501)
         {
            _loc8_ = param1.child(const_1053);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1052).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1054);
         ...
         if(param1.localName() == const_1054)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_675,variables,"")));
         style = uint(this.parseAttribute(xml,const_1495,variables,style));
         params = uint(this.parseAttribute(xml,const_684,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1493,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1502,variables,visible.toString()) == const_685;
         ...
         if(xml.child(const_684).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_675,variables,"") as String;
               if(this.var_1122[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_675)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1496,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1459);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1053)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1490,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1500,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1492,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_685;
         blend = Number(this.parseAttribute(xml,const_1335,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1494,variables,window.clipping.toString()) == const_685;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1503,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1052).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1343) == -1)
                  {
