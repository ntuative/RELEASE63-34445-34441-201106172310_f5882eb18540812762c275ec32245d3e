package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_356:Array;
      ...
      protected var var_189:WindowController;
      
      protected var var_70:WindowController;
      
      protected var var_174:IWindowRenderer;
      
      protected var var_95:IDesktopWindow;
      
      protected var var_917:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_356 = new Array();
            var_356[0] = MouseCursorType.const_331;
            var_356[1] = MouseCursorType.const_30;
            var_356[2] = MouseCursorType.const_331;
            var_356[3] = MouseCursorType.const_331;
            var_356[4] = MouseCursorType.const_331;
            var_356[5] = MouseCursorType.const_30;
            var_356[6] = MouseCursorType.const_331;
         }
         if(var_309 == null)
         {
            var_309 = new Array();
            var_309[0] = WindowState.const_93;
            var_309[1] = WindowState.const_88;
            var_309[2] = WindowState.const_92;
            var_309[3] = WindowState.const_74;
            var_309[4] = WindowState.const_55;
            var_309[5] = WindowState.const_97;
            var_309[6] = WindowState.const_89;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_298;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_70 = state.var_1382 as WindowController;
         this.var_189 = state.var_1383 as WindowController;
         this.var_174 = state.renderer;
         this.var_917 = state.var_1381;
         eventQueue.begin();
         this.var_738.x = -1;
         this.var_738.y = -1;
         ...
         while(true)
         {
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_70.getGlobalPosition(var_426);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_70 && !this.var_70.disposed)
                     {
                        ...
                        {
                           this.var_917.mouseEventReceived(event.type,this.var_70);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1382 = this.var_70;
         state.var_1383 = this.var_189;
         state.renderer = this.var_174;
         state.var_1381 = this.var_917;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_189 && !this.var_189.disposed)
               {
                  this.var_189.update(this.var_189,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_189,param1));
                  this.var_189 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         var _loc5_:BitmapData = this.var_174.getDrawBufferForRenderable(param1);
