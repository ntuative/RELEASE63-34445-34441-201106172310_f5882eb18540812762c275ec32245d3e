package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_936:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_936[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_215);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_870 ? true : null;
