package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_1045[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2780);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_187));
         }
      }
      ...
      {
         var _loc3_:Localization = this.var_72[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_72[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_72[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1999);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_72)
         {
      ...
      {
         var _loc5_:Localization = this.var_72[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_72[param1] = _loc5_;
         }
      ...
      {
         return this.var_72[param1] as ILocalization;
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1285)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_72)
         {
            if(_loc2_.raw.indexOf("%predefined%") >= 0)
            {
               _loc2_.registerParameter("predefined",this.var_1999);
            }
         }
      }
   }
