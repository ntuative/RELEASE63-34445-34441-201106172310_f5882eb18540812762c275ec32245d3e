package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1120 = param2 == null ? "" : param2.url;
         this._type = param1;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_351 < var_3000)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1120 + (this.var_1120.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_351),this.var_1133);
               return true;
            }
         }
         return false;
