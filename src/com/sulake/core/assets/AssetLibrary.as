package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1358:String = "AssetLibraryReady";
      
      public static const const_967:String = "AssetLibraryLoaded";
      
      public static const const_1912:String = "AssetLibraryUnloaded";
      
      public static const const_1789:String = "AssetLibraryLoadError";
      
      private static const const_675:String = "name";
      
      private static const const_1034:String = "asset";
      
      private static const const_1033:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1035:String = "library";
      
      private static var var_312:Dictionary;
      
      private static var var_1719:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_521 = new Dictionary(false);
         this.var_931 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_618 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1034);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_675);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1033);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_618 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_618 == param1.url && this.var_930)
         {
            ...
            this.var_932 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1358));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_931)
         {
            delete this.var_931[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_930 = false;
         this.var_618 = null;
         dispatchEvent(new Event(AssetLibrary.const_1912));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_931[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_521[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1342,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1207,this.assetLoadEventHandler);
         ...
         this.var_521[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_521[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_434;
                     this.var_436.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_521[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_436.length ? this.getAssetByName(this.var_436[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_168)
         {
            ...
            {
               return this.var_436.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_168[param1] != null || (this.var_617 != null ? this.var_617[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1719.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_168)
            {
               if(this.var_168[_loc2_] == param1)
               {
                  this.var_436.splice(this.var_436.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_312.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_312[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_435.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_435[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_312[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_435[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_312)
            {
               _loc3_ = AssetTypeDeclaration(var_312[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_435)
         {
            _loc3_ = AssetTypeDeclaration(this.var_435[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_312)
            {
               _loc4_ = AssetTypeDeclaration(var_312[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_435)
         {
            _loc4_ = AssetTypeDeclaration(this.var_435[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1034);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_675) && _loc3_.attribute(const_675).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_618 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_617[param1]);
                     _loc6_ = _loc3_.child(const_1033);
