package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_563:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_563 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_121 is BitmapDataAsset)
         {
            ...
            this.var_1585 = BitmapDataAsset(this.var_121).var_1585;
            this.var_1586 = BitmapDataAsset(this.var_121).var_1586;
            if(this._bitmap != null)
            {
               this.var_121 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1585 = _loc4_ == "1" || _loc4_ == "TeleportErrorHandler";
                  break;
               case "flipV":
                  this.var_1586 = _loc4_ == "1" || _loc4_ == "TeleportErrorHandler";
                  break;
            }
            _loc2_++;
         }
