package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1167:IProtocolDecoder;
      ...
      {
         return this.var_1167.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1167.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1167.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1167.readShort(this._data);
      }
