package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2342:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_70,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_573,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_67.getValue(InventoryCategory.const_69));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_67.getValue(InventorySubCategory.const_349));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_67.getValue(InventoryCategory.const_161));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_67.getValue(InventoryCategory.const_308));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_67.getValue(InventorySubCategory.const_1155));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_67.getValue(InventoryCategory.const_129));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_67.getValue(InventoryCategory.const_399) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_70,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_573,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               this.var_1175 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_573:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_370 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_67.add(InventoryCategory.const_399,_loc1_);
         ...
         this.var_67.add(InventoryCategory.const_161,_loc4_);
         ...
         this.var_67.add(InventorySubCategory.const_349,_loc5_);
         ...
         this.var_67.add(InventorySubCategory.const_1155,_loc6_);
         ...
         this.var_67.add(InventoryCategory.const_129,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1088.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2342);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_277));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2890)
         {
            this.var_2890 = _loc1_;
