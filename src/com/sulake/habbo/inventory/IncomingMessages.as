package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_161);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_308);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_349);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_399);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_399))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_416));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_419));
         this.var_13.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_56));
         this.var_13.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1198));
