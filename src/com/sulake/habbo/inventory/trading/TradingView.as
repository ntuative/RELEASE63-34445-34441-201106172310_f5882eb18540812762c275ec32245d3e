package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1103:uint = 4284532064;
      
      private static const const_1102:uint = 2577770;
      ...
      private var var_675:ItemPopupCtrl;
      ...
      private var var_1965:IWindowContainer;
      
      private var var_224:Timer;
      
      private var var_1032:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_675 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_224)
            {
               this.var_224.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_224.stop();
               this.var_224 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1965 = this.createMinimizedWindow();
         }
         if(!this.var_2726)
         {
            return this.var_78;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_78)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1103) : uint(const_1102);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1103) : uint(const_1102);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_224 = new Timer(1000,3);
            this.var_224.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_224.reset();
         this.var_224.repeatCount = 3;
         this.var_224.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_224.currentCount));
         if(this.var_224.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1032)
         {
            this.var_1032.isSelected = false;
            this.var_1032 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1979)
            {
            ...
            this.var_675.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_606);
            this.var_675.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_675.hideDelayed();
         }
      }
         ...
         if(this.var_200.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_675.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_606);
               }
            }
            else
            {
