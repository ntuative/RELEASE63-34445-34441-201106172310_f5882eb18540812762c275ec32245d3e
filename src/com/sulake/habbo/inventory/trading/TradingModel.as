package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1899:uint = 9;
      
      public static const const_214:uint = 0;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_58.updateItemList(this.var_750);
         this.var_58.updateItemList(this.var_1437);
      ...
      public function close() : void
      {
         if(this.var_867)
         {
            if(this._state != const_214 && this._state != const_300)
            {
      ...
      {
         this.var_58.setMinimized(param1 != InventoryCategory.const_69);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_749 + " OTHER: " + this.var_1148);
         ...
         {
            case const_214:
               if(param1 == const_229 || param1 == const_300)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1232);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1148 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_58.alertPopup(TradingView.const_1178);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_269.length < const_1899)
         {
