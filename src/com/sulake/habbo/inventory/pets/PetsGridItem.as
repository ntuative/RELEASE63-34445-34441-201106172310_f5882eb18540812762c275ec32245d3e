package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1414.setSelectedGridItem(this);
               this.var_1416 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1416 = false;
                  this.var_1414.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1415)
         {
            return;
         }
         this.var_1415.color = !!this.var_1423 ? uint(const_1409) : uint(const_1408);
         this.var_2278.visible = param1;
      }
