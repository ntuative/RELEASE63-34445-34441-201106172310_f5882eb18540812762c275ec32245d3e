package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1133:int = 1;
      
      private const const_1138:int = 2;
      ...
      private var var_226:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_226 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_531.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_226.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_531 == null || this.var_531.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_531.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_531.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_226.addGridItem(_loc2_.window);
            this.var_531.add(param1.id,_loc2_);
         ...
         if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_77.switchToFurnitureCategory(FurniModelCategory.const_43);
            }
            this.selectPetsTab();
         }
      }
      ...
      private function selectPetsTab() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.setSelected(_loc1_.method_1("tab_pets"));
         }
      }
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            if(_loc8_ != null)
            {
               _loc8_.setDirection(AvatarSetType.const_40,param4);
               if(param5)
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_40);
               }
               else
               {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_416) > 0;
