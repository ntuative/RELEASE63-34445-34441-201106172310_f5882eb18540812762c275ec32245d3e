package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_129 && this.var_28.isVisible)
         {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_28.toggleInventoryPage(InventoryCategory.const_69,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1961 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_200,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1961 && param1.type == RoomEngineObjectEvent.const_163)
         {
