package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1137:int = 42;
      
      private static const const_1139:int = 120;
      
      private static const const_1045:int = 4;
      ...
      private var var_813:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_407.add(FurniModelCategory.const_36,new FurniGridView(this.var_77,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_407.add(FurniModelCategory.const_43,new FurniGridView(this.var_77,FurniModelCategory.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1045;
            _loc3_.y = _loc4_.y + const_1045;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModelCategory.const_43:
               _loc2_.setSelected(_loc2_.method_1("tab_wall"));
               this.var_490 = FurniModelCategory.const_43;
               break;
            case FurniModelCategory.const_36:
               _loc2_.setSelected(_loc2_.method_1("tab_floor"));
               this.var_490 = FurniModelCategory.const_36;
               break;
            case FurniModelCategory.const_278:
               _loc2_.setSelected(_loc2_.method_1("tab_pets"));
               this.var_490 = FurniModelCategory.const_278;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_77.furniCategorySwitch();
         this.showCategoryGrid(this.var_490);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_407.getValue(this.var_490);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_77.getCategoryContent(this.var_490);
         ...
         if(this.var_2359 == _loc2_)
         {
            return;
         }
         this.var_2359 = _loc2_;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_416) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_77.getGroupItemInIndex(_loc3_,this.var_490);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
            ...
            if(_loc5_.category == FurniCategory.const_332)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_813 && this.var_813.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1170)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1139)
         {
            _loc3_ = const_1139;
         }
         else if(_loc3_ < const_1137)
         {
            _loc3_ = const_1137;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_278);
            }
         }
      }
