package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_226 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_226.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_226.autoArrangeItems = false;
            this.var_226.lock();
         }
         else
         {
            this.var_226.autoArrangeItems = true;
            this.var_226.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_77.toggleItemSelection(this._category,this.var_226.getGridItemIndex(param1.window));
            this.var_570 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_570 != null && this.var_570 == param2 && !this.var_77.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_155)
         {
