package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1412:int = 100;
      
      private static const const_1411:int = 1000;
      ...
      private var var_1418:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_429 = [];
         this.var_430 = [];
         this.var_607 = new Timer(const_1412,1);
         this.var_607.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2283 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_607.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_607.stop();
               this.var_607 = null;
            }
            if(this.var_209 != null)
            {
               this.var_209.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_209.stop();
               this.var_209 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1418 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1418;
            }
            else
            {
         ...
         this.var_28.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_332)
         {
         ...
         if(this.var_740 == null)
         {
            this.var_740 = this._windowManager.buildFromXML(this.var_2283) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_740.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_740.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_209 = new Timer(param1,1);
            this.var_209.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_209.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_69 && this.var_28.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_278:
                  this.var_28.toggleInventoryPage(InventoryCategory.const_129);
            }
         }
      }
      ...
      {
         this.var_2282 = getTimer();
         this.switchCategory(const_278);
      }
      ...
      {
         this.var_28.checkCategoryInitilization(InventoryCategory.const_399);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_608.add(const_36,new Array());
         this.var_608.add(const_43,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_36;
            _loc5_ = this.var_429.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_43;
            _loc5_ = this.var_430.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_278)
            {
      ...
      {
         return getTimer() < this.var_2282 + const_1411;
      }
      ...
      {
         return this.var_28.getSubCategoryViewId() == InventorySubCategory.const_349;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_346 || _loc3_.category == FurniCategory.const_332 || _loc3_.category == FurniCategory.const_323)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_608.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_349:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_608.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_824)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_429.indexOf(_loc2_) == -1)
            {
               this.var_429.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_430.indexOf(_loc2_) == -1)
            {
               this.var_430.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_416:
               return this.var_429.length;
            case UnseenItemCategoryEnum.const_419:
               return this.var_430.length;
            default:
               return this.var_429.length + this.var_430.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_43:
               if(this.var_430 && this.var_430.length > 0)
               {
               ...
               break;
            case const_36:
               if(this.var_429 && this.var_429.length > 0)
               {
