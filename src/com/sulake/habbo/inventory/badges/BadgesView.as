package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private function updateListViews() : void
      {
         ...
         var _loc2_:Array = this.var_77.getBadges(BadgesModel.const_625);
         var _loc4_:int = 0;
         ...
         var _loc5_:Array = this.var_77.getBadges(BadgesModel.const_359);
         _loc4_ = 0;
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_77.getBadges(BadgesModel.const_359);
