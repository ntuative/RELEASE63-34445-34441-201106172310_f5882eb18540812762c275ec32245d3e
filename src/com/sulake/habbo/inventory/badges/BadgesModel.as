package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1887:int = -1;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_370 = param5;
         this.var_370.events.addEventListener(BadgeImageReadyEvent.const_226,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_370.events.removeEventListener(BadgeImageReadyEvent.const_226,this.onBadgeImageReady);
            this.var_370 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_743.length)
         {
            if(this.var_743[_loc2_] == param1)
            {
               this.var_743.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1142.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_615.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_370.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_237.unshift(_loc11_);
            }
            else
            {
               this.var_237.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_237.length)
         {
            _loc3_ = this.var_237[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_625);
      ...
      {
         return this.getItemInIndex(param1,const_625);
      }
      ...
      {
         if(param1 == InventoryCategory.const_308 && this.var_28.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_615.indexOf(_loc2_) == -1)
            {
               this.var_615.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_615 && this.var_615.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1198));
            this.var_615 = [];
