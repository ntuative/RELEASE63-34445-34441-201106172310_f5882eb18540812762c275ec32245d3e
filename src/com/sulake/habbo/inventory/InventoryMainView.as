package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2825:IWindowContainer;
      ...
      private const const_2052:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_28.inventoryViewOpened(this.var_872);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_399 != null && this.var_399 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_399 || !this.var_28.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_129:
               ...
               break;
            case InventoryCategory.const_308:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_399);
         }
         ...
         _loc2_.container.removeChild(this.var_2054);
         _loc2_.invalidate();
         ...
         this.var_2054 = _loc3_;
         this.var_399 = param1;
         _loc2_.selector.setSelected(_loc2_.selector.method_1(param1));
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_399 == InventoryCategory.const_129)
            {
               this.toggleCategoryView(InventoryCategory.const_129);
            }
            else if(this.var_399 == InventoryCategory.const_69)
            {
               this.toggleCategoryView(InventoryCategory.const_69);
            }
            else if(this.var_28 != null)
            {
               this.var_28.toggleInventoryPage(InventoryCategory.const_69);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2053)
         {
            this.var_2053 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_28.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2053,_loc1_);
