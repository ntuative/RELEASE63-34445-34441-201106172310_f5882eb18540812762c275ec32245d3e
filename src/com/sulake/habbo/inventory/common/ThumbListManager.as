package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1432:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_103 = this.var_622.height;
         this.var_1147 = param5;
         this.var_937 = param6;
         this.var_239 = Math.floor(this.var_1147 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1147,this.var_937);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_29 = new BitmapData(Math.max(this.var_239 * this._thumbWidth,this.var_1147),Math.max(this.var_621 * this.var_103,this.var_937),true,16777215);
            ...
            while(_loc4_ < this.var_239)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_29.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_103),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_239 && this.var_29.height < _loc3_.y * this.var_103)
         {
            _loc2_ = new BitmapData(this.var_29.width,this.var_29.height + this.var_103);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_239 - 1),this.var_103);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_239 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_103),null,null,true);
         _loc4_ = new Rectangle(0,this.var_103,this._thumbWidth * (this.var_239 - 1),this.var_29.height - this.var_103);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,this.var_103),null,null,true);
         this.var_29 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1432.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_239));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_239 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_239);
         var _loc3_:int = param1 % this.var_239;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = this.var_239 - param1.x - 1;
         ...
         if(param1.y < this.var_621 - 1)
         {
            ...
            _loc8_ = this.var_29.height - (param1.y + 1) * this.var_103;
            ...
            this.var_29.fillRect(new Rectangle(0,this.var_29.height - this.var_103,this.var_29.width,this.var_103),4294967295);
            _loc3_ = new Point(this.var_29.width - this._thumbWidth,_loc2_.y - this.var_103);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_239 - 1)
            {
               _loc11_ = new BitmapData(this.var_29.width,this.var_29.height - this.var_103);
               _loc2_ = new Rectangle(0,0,this.var_29.width,this.var_29.height - this.var_103);
               _loc11_.copyPixels(this.var_29,_loc2_,new Point(0,0),null,null,true);
               this.var_29 = _loc11_;
               --this.var_621;
            }
         }
         if(this.var_29.height < this.var_937)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_937);
