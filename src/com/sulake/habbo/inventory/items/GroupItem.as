package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1408:int = 13421772;
      
      private static const const_1409:int = 10275685;
      ...
      protected var var_909:int = 0;
      
      protected var var_728:BitmapData;
      
      protected var var_2812:int;
      
      protected var var_1671:Boolean;
      
      protected var var_2212:Boolean;
      
      protected var var_2994:BitmapData;
      
      private var var_1424:Boolean;
      
      private const const_2047:Number = 1;
      
      private const const_2046:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2278 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2994 = param6;
         this.var_2212 = param7;
         this._items = new Map();
         this.var_2210 = param2;
         this._category = param3;
         this.var_2211 = param8;
         this.var_1655 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2210 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1655));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2211);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_824)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_2047;
               _loc1_.blend = this.const_2047;
            }
         }
         this.var_1415.color = !!this.var_1424 ? uint(const_1409) : uint(const_1408);
         this.var_2278.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2212 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2994;
               _loc5_.visible = true;
            }
            else
            {
