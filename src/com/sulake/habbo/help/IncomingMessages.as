   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_123)
            {
               this.var_23.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2524 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_23.tellUI(HabboHelpViewEnum.const_808);
      }
      ...
      {
         this.var_23.showUI(HabboHelpViewEnum.const_390);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_222);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_522);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_352,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_23.tellUI(HabboHelpViewEnum.const_263,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_1230);
         this.var_23.tellUI(HabboHelpViewEnum.const_1230,_loc5_);
      }
