package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1526:uint = 13232628;
      
      private static var var_1903:uint = 11129827;
      ...
      private var var_1246:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1904 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_815)
         {
            this.var_815 = this.var_28.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_815)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_814)
         {
            this.var_814 = this.var_28.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_814)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_28.localization.registerParameter("help.tutorial.name.available","name",this.var_546);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1119:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1118:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1118 || param1 == ChangeUserNameResultMessageEvent.var_1119)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1246 = new NameSuggestionListRenderer(this.var_28);
         var _loc6_:int = this.var_1246.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1526;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_546 = this.var_28.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_28.changeName(this.var_546);
               break;
            ...
            case "header_button_close":
               this.var_28.showView(TutorialUI.const_94);
         }
      }
