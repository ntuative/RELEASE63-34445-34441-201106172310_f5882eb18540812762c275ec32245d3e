package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_815)
         {
            this.var_815 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_815)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_814)
         {
            this.var_814 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_814)
            {
               return;
            }
