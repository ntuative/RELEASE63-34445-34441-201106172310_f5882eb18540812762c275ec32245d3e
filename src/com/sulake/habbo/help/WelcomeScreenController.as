package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_191)
         {
            this.var_191.removeUpdateReceiver(this);
            this.var_191.toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this.var_191 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_69 = param1;
         this.var_191.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_191.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_218.y = this.var_191.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_218.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_191.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_191.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_348,false);
         _loc4_.height -= 20;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_218);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_218,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_218.x;
            this._window.y = this.var_218.y;
            this.var_191.removeUpdateReceiver(this);
         }
      }
      ...
      {
         this.var_191.removeUpdateReceiver(this);
         this.var_191.registerUpdateReceiver(this,10);
      }
   }
}
