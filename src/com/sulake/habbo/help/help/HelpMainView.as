package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1448:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1448)
         {
      ...
      {
         main.showUI(HabboHelpViewEnum.const_522);
      }
      ...
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_808);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            main.tellUI(HabboHelpViewEnum.const_263,_loc6_);
         }
      }
   }
}
