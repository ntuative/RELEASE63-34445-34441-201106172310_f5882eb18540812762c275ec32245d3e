package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1786:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106172303));
         this.var_123 = new Map();
         this.var_123.add(HabboHelpViewEnum.const_1989,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_222,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_522,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_352,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_263,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_390,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_838,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_296,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_123.add(HabboHelpViewEnum.const_1377,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_123.add(HabboHelpViewEnum.const_1181,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_808,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_532.length == 0 || param1 != this.var_368)
            {
               this.var_532.push(this.var_368);
            }
         }
         this.var_368 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_368);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_296:
               ...
               break;
            case CallForHelpResultEnum.const_1372:
               this.showUI(HabboHelpViewEnum.const_1181);
               break;
            case CallForHelpResultEnum.const_1147:
               this.showUI(HabboHelpViewEnum.const_1377);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_123.getValue(HabboHelpViewEnum.const_222) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_630));
      }
      ...
      {
         return this.var_123.getValue(this.var_368);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2407 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2408;
         this._window.width = _loc1_.width + this.var_2407;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_368 == HabboHelpViewEnum.const_222)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_369.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_368 == HabboHelpViewEnum.const_222 || this.var_532.length == 0)
         {
            return;
         }
         if(this.var_369 == null)
         {
            ...
            this.var_369 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_369.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_369.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_369 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_369 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_369 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
