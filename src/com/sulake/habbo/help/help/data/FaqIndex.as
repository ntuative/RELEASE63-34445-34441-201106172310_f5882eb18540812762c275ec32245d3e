package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_776 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_775 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_774 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
