package com.sulake.habbo.help.enum
{
   ...
   public class HabboHelpTutorialEvent extends Event
   {
      ...
      public static const const_866:String = "HHTPNUFWE_LIGHT_CLOTHES_ICON";
      
      public static const const_630:String = "HHTPNUFWE_DONE_GUIDEBOT";
      
      public static const const_594:String = "HHTE_DONE_AVATAR_EDITOR_OPENING";
      
      public static const const_490:String = "HHTE_DONE_AVATAR_EDITOR_CLOSING";
