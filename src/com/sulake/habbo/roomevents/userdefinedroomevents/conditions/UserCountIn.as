package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1283:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2183;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1283.getValue());
      ...
      {
         this.var_92 = param2;
         this.var_1283 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1283.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1283.setValue(1);
         this.var_1282 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1282.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1282.setValue(50);
      }
