package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1442:int = 2;
      ...
      private var var_1742:TriggerConfs;
      
      private var var_1740:ActionTypes;
      
      private var var_1741:ConditionTypes;
      
      private var var_271:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_753:RoomObjectHightLighter;
      
      private var var_191:UserDefinedRoomEventsHelp;
      
      private var var_1154:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1742 = new TriggerConfs();
         this.var_1740 = new ActionTypes();
         this.var_1741 = new ConditionTypes();
         this.var_271 = new Dictionary();
         super();
         this.var_92 = param1;
         this.var_753 = new RoomObjectHightLighter(param1);
         this.var_191 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1154 = new SliderWindowController(this.var_92,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_92.assets,0,20,1);
         this.var_1154.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1154.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_753.hideAll(this.var_271);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_753.showAll(this.var_271);
         if(this.var_38 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_38);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1154.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1154.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_191.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1442) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1442 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1742);
