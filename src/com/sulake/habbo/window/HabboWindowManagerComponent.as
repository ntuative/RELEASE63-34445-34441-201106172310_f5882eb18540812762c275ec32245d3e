package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1617:uint = 1;
      ...
      private var var_1605:IEventDispatcher;
      
      private var var_1309:Boolean = false;
      
      private var var_2042:ProfilerOutput;
      
      private var var_1604:ProfilerAgentTask;
      
      private var var_1606:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_225 = new Array(const_471);
         ...
         this.var_726 = this.var_225[const_1617];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2042)
            {
               this.var_2042 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2042.profiler = _loc3_;
            this.var_1604 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1604);
            this.var_1606 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1606);
            this.var_1309 = true;
         }
      }
      ...
      {
         return this.var_726.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_726.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_225[param1].getDesktopWindow().getChildAt(this.var_726.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1605.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_471 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1605.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1605.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1809,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1965,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1996,param2.name + ": " + param2.toString());
            }
         }
      }
