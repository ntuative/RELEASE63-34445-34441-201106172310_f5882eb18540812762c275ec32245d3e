package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2814:ITextWindow;
      ...
      private var var_2813:IButtonWindow;
      
      private var var_1601:IButtonWindow;
      
      private var var_1060:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2031.visible = true;
         this.var_2814.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_869.setText(param1.eventDescription);
         this.var_1062.setText(this.getTagFromEvent(param1,1));
         this.var_1061.setText(this.getTagFromEvent(param1,2));
         this.var_1600.visible = false;
         this.var_1599.visible = true;
         this.var_1601.visible = true;
         this.var_2030.visible = false;
      ...
      private function createEvent() : void
      {
         ...
         this.var_2031.visible = false;
         this.var_1600.visible = true;
         ...
         this.var_1061.goBackToInitialState();
         this.var_1060.selection = 0;
         this.var_2030.visible = true;
      ...
      {
         var _loc1_:int = this.var_1060.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_869.getText();
         var _loc5_:Array = new Array();
         this.addTag(_loc5_,this.var_1062.getText());
         this.addTag(_loc5_,this.var_1061.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2031 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2814 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2030 = ITextWindow(this.find("create_caption"));
            this.var_2029 = ITextWindow(this.find("edit_caption"));
            this.var_1600 = IButtonWindow(this.find("create_button"));
            this.var_1599 = IButtonWindow(this.find("edit_button"));
            this.var_2813 = IButtonWindow(this.find("cancel_button"));
            this.var_1601 = IButtonWindow(this.find("end_button"));
            this.var_1060 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            this.addMouseClickListener(this.var_1600,this.onCreateButtonClick);
            this.addMouseClickListener(this.var_1599,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1601,this.onEndButtonClick);
            this.addMouseClickListener(this.var_2813,this.onCancelButtonClick);
            ...
            this.var_1062 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_1061 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
