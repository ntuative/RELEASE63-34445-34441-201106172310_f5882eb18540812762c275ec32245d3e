package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1349)
         {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_209 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "TeleportErrorHandler" && false)
         {
