package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1537:CutToWidth = new CutToWidth();
      
      private static var var_2655:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1537.beforeSearch(param2,param1,param3);
         binarySearch(var_1537,param2.length - 1);
      }
