package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1963 = IButtonWindow(this.find("bg_tab"));
         this.var_1962 = IButtonWindow(this.find("top_tab"));
         this.var_1964 = IButtonWindow(this.find("obj_tab"));
         this.var_2725 = IWindowContainer(this.find("tile_grid"));
         this.var_2724 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1963,this.onBgTabButton);
         Util.setProcDirectly(this.var_1962,this.onTopTabButton);
         Util.setProcDirectly(this.var_1964,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_77.mode = ThumbnailEditorModel.const_63;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1963,this.var_77.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1962,this.var_77.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1964,this.var_77.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2724;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_77.mode == ThumbnailEditorModel.const_35);
         this.refreshEditImg(_loc1_,"edit_top",this.var_77.mode == ThumbnailEditorModel.const_63);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2725;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_561)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
            ...
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_366,HabboWindowStyle.const_47,HabboWindowParam.const_65,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
