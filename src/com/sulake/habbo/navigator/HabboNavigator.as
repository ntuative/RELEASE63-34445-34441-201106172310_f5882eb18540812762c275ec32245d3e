package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_724:RoomInfoViewCtrl;
      
      private var var_1376:RoomCreateViewCtrl;
      ...
      private var var_1375:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_724 = new RoomInfoViewCtrl(this);
         this.var_1376 = new RoomCreateViewCtrl(this);
         this.var_2683 = new RoomThumbnailRenderer(this);
         this.var_1106 = new GuestRoomPasswordInput(this);
         this.var_335 = new GuestRoomDoorbell(this);
         this.var_460 = new Tabs(this);
         this.var_1375 = new OfficialRoomEntryManager(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_345.startSearch(Tabs.const_223,Tabs.const_400,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_345.startSearch(Tabs.const_307,Tabs.const_256);
         this.var_460.getTab(Tabs.const_307).tabPageDecorator.tabSelected();
      }
