package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_3074:IButtonWindow;
      
      private var var_3048:Boolean;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         this.var_842 = new TextFieldManager(this._navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,this.searchRooms,this._navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = this.var_842.getText();
         if(_loc1_ == "")
         {
            return;
         }
         this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_303,_loc1_);
