package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1360:TextFieldManager;
      
      private var var_1062:TextFieldManager;
      
      private var var_1061:TextFieldManager;
      ...
      private var var_1358:ICheckBoxWindow;
      ...
      private var var_1107:IDropMenuWindow;
      
      private var var_2939:IWindowContainer;
      
      private var var_1361:IWindowContainer;
      ...
      {
         if(param1 != this.var_414 || this.var_1362 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1362 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1889)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1787)
         {
            this.var_1360.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1879)
         {
            this.setTagError(this.var_1062,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1061,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1981)
         {
            this.setTagError(this.var_1062,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1061,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1360.clearErrors();
         this.var_1062.clearErrors();
         this.var_1061.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_503,this.onDoorModePasswordUnselect);
         ...
         this.var_1360 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1062 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1061 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1106 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1356 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1355 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1358 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1354 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_894 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2123 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1105 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1107 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2939 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1361 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1357 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2124 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1648 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_256 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1359 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1649 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1649.mouseThreshold = 0;
         this.var_1649.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1359.visible = false;
         if(!this.var_1650)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2124.visible = this.var_1650;
         this.populateForm();
         if(this.var_893)
         {
            this.var_1357.visible = true;
            this.var_1648.visible = true;
            this.refreshFlatControllers();
            this.var_1357.height = Util.getLowestPoint(this.var_1357) + 4;
         }
         else
         {
            this.var_1361.visible = true;
            this.var_1648.visible = true;
            this.var_2939.visible = this.var_1650;
            this.var_1361.height = Util.getLowestPoint(this.var_1361) + 4;
         }
         this.var_1649.text = !!this.var_893 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1361.name,this.var_1357.name,this.var_1648.name,this.var_2124.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1360.setText(_loc1_.description);
         this.var_1106.setText("");
         this.var_1356.setText("");
         ...
         {
            case RoomSettingsData.const_209:
         ...
         this.setTag(this.var_1062,_loc1_.tags[0]);
         this.setTag(this.var_1061,_loc1_.tags[1]);
         if(this.var_1355)
         {
            if(_loc1_.allowPets)
            {
               this.var_1355.select();
            }
            else
            {
               this.var_1355.unselect();
            }
         }
         if(this.var_1358)
         {
            ...
            {
               this.var_1358.select();
            }
            else
            {
               this.var_1358.unselect();
            }
         }
         if(this.var_1354)
         {
         ...
         {
            this.disableWindow(this.var_894);
            this.disableWindow(this.var_1105);
            this.disableWindow(this.var_1107);
            this.disableWindow(this.var_2123);
         }
         else
         {
            this.enableWindow(this.var_894);
            this.enableWindow(this.var_1105);
            this.enableWindow(this.var_1107);
            this.enableWindow(this.var_2123);
         }
         if(this.var_894)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_894.unselect();
            }
         }
         if(this.var_1105)
         {
            this.var_1105.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1107)
         {
            this.var_1107.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1360.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_209;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_130;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_620;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_130)
         {
            _loc8_ = this.var_1106.getText();
            _loc9_ = this.var_1356.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1106.clearErrors();
               this.var_1356.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1355.isSelected;
         _loc2_.allowFoodConsume = this.var_1358.isSelected;
         _loc2_.allowWalkThrough = this.var_1354.isSelected;
         _loc2_.hideWalls = this.var_894.isSelected;
         _loc2_.wallThickness = this.var_1105.selection - 2;
         _loc2_.floorThickness = this.var_1107.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1062,_loc2_.tags);
         this.addTag(this.var_1061,_loc2_.tags);
         this.clearErrors();
         this.var_1362 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
