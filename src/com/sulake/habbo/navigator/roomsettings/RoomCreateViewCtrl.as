package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1152:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,104,"a"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,94,"b"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,36,"c"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,84,"d"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,80,"e"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,80,"f"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,416,"i"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,320,"j"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,448,"k"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,352,"l"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,384,"m"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_57,372,"n"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1152.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1739 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1739 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_65 = IItemListWindow(this.var_194.findChildByName("item_list"));
         ...
         this.var_1153 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_194.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1153.goBackToInitialState();
         this.var_1153.input.textBackgroundColor = 4294967295;
         this.var_1152 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1153.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1153.getText();
         var _loc3_:String = "model_" + this.var_1152.name;
