   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_148 == null)
         {
            ...
            this.var_148.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_148 != null)
         {
            this.var_148.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_218,Tabs.const_431);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_218,Tabs.const_952);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_218,Tabs.const_431,"" + _loc3_);
         }
         if(this.var_148)
         {
