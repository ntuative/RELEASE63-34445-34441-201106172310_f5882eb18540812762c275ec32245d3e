package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_597:IScrollbarWindow;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_597 = IScrollbarWindow(this.var_194.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_180,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1753,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_209,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_545.visible && this.var_2624)
         {
            return;
         }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_130:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_209:
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1522.tags[0];
            this.var_1522.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2625 - _loc2_.stageX);
         this.var_2625 = _loc2_.stageX;
         this.var_2624 = _loc3_ > 2;
      }
   }
}
