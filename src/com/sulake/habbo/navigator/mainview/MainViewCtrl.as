package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_2248:int = 3;
      ...
      private static const const_1644:int = 4;
      ...
      private var var_1078:PopularTagsListCtrl;
      
      private var var_1077:GuestRoomListCtrl;
      ...
      private var var_1631:IWindow;
      
      private var var_877:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1078 = new PopularTagsListCtrl(this._navigator);
         this.var_1077 = new GuestRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         {
            this.var_876 = new WindowToggle(this.var_17,this.var_17.desktop,this.reloadData,this.close);
         }
      ...
      private function prepare() : void
      {
         ...
         this.var_280 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         this.var_194 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         this.var_251 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_228 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_296 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1631 = this.var_17.findChildByName("loading_text");
         ...
         this.var_877 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(this.var_877 != null)
         {
            this.var_877.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_877.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_877.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1718,true);
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_228.y;
         Util.moveChildrenToColumn(this.var_194,["custom_content","list_content"],this.var_251.y,8);
         this.var_228.height = this.var_228.height + _loc1_ - this.var_228.y - this.var_296.height + this.var_2877;
         Util.moveChildrenToColumn(this.var_194,["list_content","custom_footer"],this.var_228.y,0);
         this.var_2877 = this.var_296.height;
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_251);
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_296);
         if(Util.hasVisibleChildren(this.var_296))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_1077,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1078,"popular_tags");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_ = this.var_228.getChildByName(param4);
      ...
      public function startSearch(param1:int, param2:int, param3:String = "-1", param4:int = 1) : void
      {
         ...
         {
            this.open();
            this.var_707 = const_709;
            this.var_228.blend = 0;
            if(this.var_251.visible)
            {
               this.var_251.blend = 0;
               this.var_296.blend = 0;
            }
         }
         else
         {
            this.var_707 = const_1131;
         }
         this.var_1630 = 0;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_707 == const_1131)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_228.blend - _loc2_));
            this.var_228.blend = _loc3_;
            this.var_251.blend = !!this.var_1334 ? Number(_loc3_) : Number(1);
            this.var_296.blend = !!this.var_1334 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_707 = const_709;
            }
         }
         else if(this.var_707 == const_709)
         {
            if(this.var_1630 % 10 == 1)
            {
               this.var_1631.visible = !this.var_1631.visible;
            }
            ++this.var_1630;
            if(!this._navigator.data.isLoading())
            {
               this.var_707 = const_1130;
            }
         }
         else if(this.var_707 == const_1130)
         {
            this.refresh();
            this.var_707 = const_1644;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_1078);
         this.refreshScrollbar(this.var_1077);
      }
      ...
      {
         this._navigator.refreshButton(this.var_877,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_877,"icon_hotelview_reactive",param1,null,0);
      }
