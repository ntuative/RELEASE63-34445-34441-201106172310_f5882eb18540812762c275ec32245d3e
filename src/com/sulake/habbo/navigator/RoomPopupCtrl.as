package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2683:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2683 = new RoomThumbnailRenderer(param1);
         this.var_964 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_199,this.var_130);
         if(this.var_130.ownerName != "" && this.var_130.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_199,!!this.var_130.event ? this.getEventCtg(this.var_130.categoryId) : this.getRoomCtg(this.var_130.categoryId));
         this.refreshRoomDesc(this.var_199,this.var_130);
         this.refreshExtraCont();
         this.refreshInfo(this.var_199,"trading_allowed",this.var_130.allowTrading);
         this.refreshInfo(this.var_199,"doormode_doorbell",this.var_130.doorMode == 1);
         this.refreshInfo(this.var_199,"doormode_password",this.var_130.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_199,this.var_130.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_964.refreshTags(_loc1_,this.var_130.tags);
         ...
         this.var_2683.refreshThumbnail(_loc1_,this.var_130.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_303,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
