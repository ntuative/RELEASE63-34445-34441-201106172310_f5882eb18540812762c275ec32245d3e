package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2371:FriendListLookAndFeel;
      
      private var var_460:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1758:OpenedToWebPopup;
      ...
      private var var_1757:AvatarSearchResults;
      ...
      {
         this.var_2371 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_115 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1757 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_632.stop();
            this.var_632.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_632 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1758 = new OpenedToWebPopup(this);
         }
         this.var_1758.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_450);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_744.createAvatarImage(param1,AvatarScaleType.const_115,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "TeleportErrorHandler";
      }
      ...
      {
         this.var_1089 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_1154,this.getText("friendlist.friends")));
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_443,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_115.addFriend(new Friend(_loc4_));
         }
         this.var_460 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_632)
         {
            this.var_632 = new Timer(120000);
            this.var_632.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_632.start();
         }
         ...
         {
            _loc5_ = this.var_115.findCategory(FriendCategory.const_443);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_460.findTab(FriendListTab.const_91).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_460.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1757.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_460.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_460.findTab(FriendListTab.const_91);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_760 || !this.var_118)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_760.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_118.vipLimit;
         }
         else if(this.var_760.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
