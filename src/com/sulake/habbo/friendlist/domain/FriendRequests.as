package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_491:IFriendRequestsDeps;
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            if(!param1 || _loc3_.state != FriendRequest.const_189)
            {
               _loc2_.push(_loc3_);
            }
         }
         for each(_loc4_ in _loc2_)
         {
            ...
            if(this.var_491.view != null)
            {
               this.var_491.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         this.refreshShading();
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         this.var_491.view.refreshRequestEntry(_loc2_);
      }
      ...
      {
         this._requests.push(param1);
         this.var_491.view.addRequest(param1);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            this.var_491.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_189)
            {
               _loc1_++;
            }
         }
