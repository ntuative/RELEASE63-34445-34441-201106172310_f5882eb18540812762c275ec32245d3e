package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2285:int = "F".charCodeAt(0);
      
      public static const const_2290:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1043 = param1.gender;
         this.var_759 = param1.online;
         this.var_1812 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1913 = param1.motto;
         this.var_1755 = param1.lastAccess;
         this.var_1448 = param1.categoryId;
