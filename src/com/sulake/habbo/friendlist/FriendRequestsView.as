package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2055:String = "no_reqs_info";
      ...
      private var var_1801:IContainerButtonWindow;
      
      private var var_1800:IContainerButtonWindow;
      ...
      {
         this.var_1801 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1800 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1800.procedure = this.onDismissAllButtonClick;
         this.var_1801.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_189)
         {
         ...
         else if(param1.state == FriendRequest.const_451)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.accepted}");
         }
         else if(param1.state == FriendRequest.const_453)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_451;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_451 && _loc2_.state != FriendRequest.const_453)
            {
               ...
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_61,_loc2_.requestId));
               }
            }
         }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_453;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1801,_loc1_);
         this.setEnabled(this.var_1800,_loc1_);
      }
