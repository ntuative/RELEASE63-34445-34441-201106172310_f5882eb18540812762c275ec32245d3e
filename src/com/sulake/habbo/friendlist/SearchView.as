package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_842:ITextFieldWindow;
      ...
      {
         this.var_842 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_842.procedure = this.onSearchInput;
         this.var_842.addEventListener(WindowKeyboardEvent.const_179,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_65.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_450,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_675.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_675.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_842.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_842.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_842.text;
