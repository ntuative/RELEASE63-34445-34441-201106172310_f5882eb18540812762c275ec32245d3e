package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1629:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2144:FriendListTabsView;
      ...
      private var var_1662:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2144 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1629;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_296 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2144.prepare(this.var_987);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1183,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1336,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_919,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_897,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_919,false);
         ...
         this.var_1662 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1662.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2145 == -1 ? 0 : int(this.var_17.height - this.var_2145);
         var _loc4_:int = this.var_2143 == -1 ? 0 : int(this.var_17.width - this.var_2143);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_296.y = Util.getLowestPoint(this.var_17.content);
         this.var_296.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1204,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_919,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1183,false);
         ...
         this.var_2145 = this.var_17.height;
         this.var_2143 = this.var_17.width;
