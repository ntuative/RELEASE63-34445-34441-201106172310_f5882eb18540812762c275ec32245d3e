package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3061:String = "magic.credits";
      
      private var var_3031:String = "magic.pixels";
      
      private var var_3032:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3031);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3032,true);
      }
