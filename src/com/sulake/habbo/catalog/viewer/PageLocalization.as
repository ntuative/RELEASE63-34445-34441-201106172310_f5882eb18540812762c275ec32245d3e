package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1545:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1544:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_1080:Object = {"frontpage3":[7,8]};
      
      private static const const_1081:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         ...
         const_172["club_buy"] = ["club_link"];
         const_172["mad_money"] = ["ctlg_madmoney_button"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_812.length)
         {
            _loc2_ = String(this.var_812[param1]).replace("#","0x");
