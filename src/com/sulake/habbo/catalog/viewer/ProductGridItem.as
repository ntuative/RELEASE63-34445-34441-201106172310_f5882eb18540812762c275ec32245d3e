package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1113:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_226:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_570:Object;
      ...
      {
         this._view.getChildByName(const_1113).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1113).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_92,MouseCursorType.const_979);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_979);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_226.select(this);
            this.var_570 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_570 != null && this.var_570 == param2)
         {
            _loc3_ = this.var_226.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_570 = null;
            }
