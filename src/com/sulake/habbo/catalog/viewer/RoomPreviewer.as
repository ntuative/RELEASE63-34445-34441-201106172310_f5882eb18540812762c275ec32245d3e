package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_1618:int = 64;
      
      private static const const_1619:int = 32;
      
      private static const const_1620:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_177,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_954,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_193,this.onRoomInitialized);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_177,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_954,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineEvent.const_193,this.onRoomInitialized);
         }
      }
      ...
      public function reset() : void
      {
         ...
         this.var_336 = RoomObjectCategoryEnum.const_149;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_336 == RoomObjectCategoryEnum.const_27 && this.var_1314 == param1)
            {
               return const_66;
            }
            this.reset();
            ...
            this.var_1609 = "";
            if(this._roomEngine.addObjectFurniture(const_53,const_54,const_66,param1,new Vector3d(const_701,const_702,0),param2,0,""))
            {
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_336 == RoomObjectCategoryEnum.const_26 && this.var_1314 == param1 && this.var_1609 == param3)
            {
               return const_66;
            }
            this.reset();
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            ...
            if(this._roomEngine.addObjectUser(const_53,const_54,const_66,new Vector3d(const_701,const_702,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1315 = getTimer();
               this.var_1316 = true;
      ...
      public function changeRoomObjectState() : void
      {
         if(this._roomEngine != null)
         {
            ...
            {
               this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_336);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1315 + const_1620)
            {
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_53,const_54,const_237,param1,param2,this.var_1312);
            this._roomEngine.setRoomCanvasMask(const_53,const_54,const_237,true);
            _loc4_ = this._roomEngine.getRoomCanvasGeometry(const_53,const_54,const_237);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_53,const_54,const_66,this.var_336,const_237);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1313 >> 1),-(this.var_1064 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_49.width > this.var_1313 - this.var_49.width >> 1 || _loc3_.height - this.var_49.height > this.var_1064 - this.var_49.height >> 1 || this.var_49.width < 1 || this.var_49.height < 1)
               {
                  this.var_49 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         var _loc2_:IRoomGeometry = this._roomEngine.getRoomCanvasGeometry(const_53,const_54,const_237);
         if(this.var_49.width > this.var_1313 * (1 + const_472) || this.var_49.height > this.var_1064 * (1 + const_472))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1312 = const_1619;
               this.var_2044 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_49.left >>= 2;
         ...
         else if(this.var_49.width << 1 < this.var_1313 * (1 + const_472) - 5 && this.var_49.height << 1 < this.var_1064 * (1 + const_472) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2044)
            {
               _loc2_.performZoomIn();
               this.var_1312 = const_1618;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1064 - this.var_49.height >> 1;
         if(_loc4_ > 10)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.getRoomCanvasScreenOffset(const_53,const_54,const_237);
            if(_loc1_ != null)
            {
               this.updatePreviewObjectBoundingRectangle(_loc1_);
               if(this.var_49 != null)
               {
                  _loc2_ = this.var_1312;
                  _loc1_ = this.validatePreviewSize(_loc1_);
                  _loc3_ = this.getCanvasOffset(_loc1_);
                  if(_loc3_ != null)
                  {
                     this._roomEngine.setRoomCanvasScreenOffset(const_53,const_54,const_237,_loc3_);
                  }
                  if(this.var_1312 != _loc2_)
                  {
                     this.var_49 = null;
                  }
               }
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_53 && param1.roomCategory == const_54 && param1.objectId == const_66 && param1.category == this.var_336)
         {
            this.var_49 = null;
            this.var_2044 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_612);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_724);
