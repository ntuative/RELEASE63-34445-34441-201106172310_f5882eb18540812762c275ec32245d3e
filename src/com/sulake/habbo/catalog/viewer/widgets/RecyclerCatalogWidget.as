package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization
   {
      ...
      private var var_289:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_202)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_202)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.const_25:
               if(this.var_289 != null)
               {
                  this.var_289.resetIcon();
               }
               break;
            case WindowMouseEvent.const_180:
               if(this.var_289 != null)
               {
                  this.var_289.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_289 == null)
               {
                  this.var_289 = new CatalogObjectMover();
                  this.var_289.mainContainer = window;
                  this.var_289.roomEngine = _loc3_;
               }
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_180)
         {
