package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2382 = _loc3_.localizationId;
         this.var_366 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_48)
         {
            ...
            if(this.var_214 == null || _loc3_ >= this.var_214.length)
            {
               return;
            }
            this.var_767 = _loc3_;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_530 < 0 || this.var_530 > this.var_366.length)
         {
            this.var_530 = 0;
         }
         this.updateImage();
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_214[_loc3_] as int;
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_214 == null || this.var_767 >= this.var_214.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_530 >= 0 && this.var_530 < this.var_366.length)
         {
            _loc7_ = this.var_366[this.var_530] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_214[this.var_767] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_555,_loc3_,_loc2_,AvatarScaleType.const_59,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_345,AvatarAction.const_1007);
         _loc4_.endActionAppends();
         _loc4_.setDirection(AvatarSetType.const_40,2);
         this.setPreviewImage(_loc4_.getCroppedImage(AvatarSetType.const_40),true);
         _loc4_.dispose();
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_530 >= this.var_366.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_366[this.var_530] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_214[this.var_767] as int;
