package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_209:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_732,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_302,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_746,this.deActivateScrollbar);
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_899 >= 0 && this.var_899 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_899];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_899;
               if(this.var_899 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1855) as IWindowContainer;
         ...
         if(param1.pricingModel == Offer.const_559)
         {
            ++this.var_2141;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2141);
         }
      }
