package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ActivityPointDisplayCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         _loc1_.events.removeEventListener(PurseUpdateEvent.const_895,this.onPurseUpdate);
         super.dispose();
      }
      ...
      override public function init() : Boolean
      {
         ...
         var _loc1_:HabboCatalog = HabboCatalog(page.viewer.catalog);
         _loc1_.events.addEventListener(PurseUpdateEvent.const_895,this.onPurseUpdate);
