package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1854) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1855) as IWindowContainer;
