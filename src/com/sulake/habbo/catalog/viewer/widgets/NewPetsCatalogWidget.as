package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1578:int = 18;
      ...
      private var var_214:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2382 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_214 != null && this.var_214.length > 0)
         {
            this.var_388 = this.var_214[0];
         }
         else
         {
            this.var_388 = -1;
         ...
         events.addEventListener(WidgetEvent.const_878,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_214 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1578 && _loc2_ < this.var_214.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_555,this.var_214[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_214 != null && this.var_214.length > 0)
         {
            if(param1 < 0 || param1 > this.var_214.length)
            {
               param1 = 0;
            }
            this.var_388 = this.var_214[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_555,this.var_388),this.getRaceLocalizationKey(this.var_555,this.var_388));
            }
         }
         return this.getRaceLocalizationKey(this.var_555,this.var_388);
      }
      ...
      {
         if(param1.productCode == this.var_2382)
         {
            this.var_214 = this.parseSellableBreeds(param1.sellableBreeds);
            this.initializeBreedSelection();
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_388 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_555;
         var _loc3_:int = this.var_388;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_388 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_214 == null)
         {
            ...
            this.var_214 = this.parseSellableBreeds(_loc2_);
         }
      }
