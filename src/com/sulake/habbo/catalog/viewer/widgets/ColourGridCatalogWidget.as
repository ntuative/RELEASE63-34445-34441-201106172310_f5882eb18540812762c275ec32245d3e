package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         if(!this.var_364.disposed)
         {
            this.var_364.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_364 = _window.findChildByName("colourGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("color_chooser_cell") as XmlAsset;
         this.var_1759 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_948 = _loc4_.content as BitmapData;
         ...
         this.select(this.var_364.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         this.var_947 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_364.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_946.length,this.var_364.numGridItems]);
         this.var_364.destroyGridItems();
         this.var_235 = null;
         for each(_loc1_ in this.var_946)
         {
            if(_loc1_.length > 0)
            {
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1759) as IWindowContainer;
               ...
               this.var_364.addGridItem(_loc2_);
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_947.width,this.var_947.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_947,this.var_947.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_364.getGridItemIndex(param1.target as IWindow);
