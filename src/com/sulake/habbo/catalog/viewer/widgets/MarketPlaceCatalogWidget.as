package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2061:int = 1;
      
      private const const_2060:int = 2;
      
      private const const_2326:int = 40;
      
      private const const_2327:int = 10;
      
      private var var_829:Array;
      
      private var var_1559:MarketPlaceOfferData;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         var _loc3_:ISelectableWindow = _loc2_.method_1(param1);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_829 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_829 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_829));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_672)
         {
            ...
            this.var_672 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_672)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2060,_loc3_.length,_loc2_);
         if(!this.var_552)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1269 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1269));
            ++this.var_1269;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_672 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_672.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2061);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_829.length)
         {
            _loc4_ = this.var_829[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_111)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2327;
                  break;
               case "search_input":
                  _loc8_ = this.const_2326;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1559.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_48)
