package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1014.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1014 = null;
         }
         if(this.var_1015 != null)
         {
            this.var_1015.removeEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
            this.var_1015 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1014 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1014 != null)
         {
            this.var_1014.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1015 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1015 != null)
         {
            this.var_1015.addEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
         }
         return true;
      }
