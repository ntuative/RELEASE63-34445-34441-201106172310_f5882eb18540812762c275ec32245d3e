package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_28.purse.pastVipDays >= this.const_238 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_28.purse.pastVipDays % this.const_238;
            _loc4_ = this.var_28.purse.pastVipDays / this.const_238;
            this.var_28.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_28.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_258)
         {
            this.var_258 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_258)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_258.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_258.setGlobalPosition(_loc6_.subtract(new Point(this.var_258.width / 2,this.var_258.height / 2)));
         this.var_258.visible = true;
         this.var_258.activate();
      }
