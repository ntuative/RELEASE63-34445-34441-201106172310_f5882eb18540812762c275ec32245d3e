package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_232[this.var_592][this.var_701];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_592 = var_508.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_592];
         var _loc3_:Array = this.var_232[this.var_592] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_701));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_232[this.var_592] as Array;
         var _loc3_:Offer = _loc2_[this.var_701] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_701 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_701] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_232[this.var_592] as Array;
         var _loc2_:Offer = _loc1_[this.var_701] as Offer;
