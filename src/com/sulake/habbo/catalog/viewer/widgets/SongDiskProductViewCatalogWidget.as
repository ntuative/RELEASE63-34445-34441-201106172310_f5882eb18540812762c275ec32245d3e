package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_474:IButtonWindow;
      ...
      {
         super(param1);
         this.var_474 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1210 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_474 != null)
         {
            this.var_474.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_474.disable();
         }
      ...
      override public function dispose() : void
      {
         if(this.var_474 != null)
         {
            this.var_474.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_976,HabboMusicPrioritiesEnum.const_205,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_976 = parseInt(_loc2_.extraParam);
            if(this.var_1209 != null)
            {
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_976);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_976);
         }
         return -1;
      }
