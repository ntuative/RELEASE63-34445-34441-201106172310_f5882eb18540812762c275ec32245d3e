package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1660:int = 13421772;
      
      private static const const_1659:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_299.getValue(_loc5_) == null)
            {
               this.var_299.add(_loc5_,new Map());
            }
            _loc7_ = this.var_299.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_299.getWithIndex(this.var_343);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_885);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1660);
         _loc2_.push(const_1659);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_299.getWithIndex(this.var_343);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_885);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_343;
         if(this.var_343 >= this.var_299.length)
         {
            this.var_343 = 0;
         }
         var _loc2_:Map = this.var_299.getWithIndex(this.var_343);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_343 < 0)
         {
            this.var_343 = this.var_299.length - 1;
         }
         var _loc2_:Map = this.var_299.getWithIndex(this.var_343);
         if(_loc2_ != null)
         {
