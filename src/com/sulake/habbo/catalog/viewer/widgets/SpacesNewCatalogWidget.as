package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_460:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_460 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_460)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_460.numSelectables)
            {
               _loc4_ = this.var_460.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_115[this.var_592]);
      ...
      {
         var _loc2_:int = this.var_701[this.var_592];
         var _loc3_:Offer = this.var_232[this.var_592][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_508.numGridItems)
         {
            _loc2_ = this.var_232[this.var_592][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_701[this.var_592] = (this.var_232[this.var_592] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_701[0];
         var _loc2_:int = this.var_701[1];
         var _loc3_:int = this.var_701[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_404 || _loc1_.pricingModel == Offer.const_420))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_460.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_460.setSelected(this.var_460.method_1(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_508)
            {
               var_508.destroyGridItems();
            }
            page.replaceOffers(this.var_232[this.var_592],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_701[this.var_592];
