package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_520:IDisplayObjectWrapper;
      
      private var var_1718:Point;
      
      private var var_519:IItemGridWindow;
      
      private var var_1428:IScrollbarWindow;
      
      protected var var_1855:XML;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_193.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_193 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1146 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_96 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_193 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_193 != null)
         {
            this.var_193.visible = false;
            this.var_520 = this.var_193.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_520 != null && _loc3_ != null)
            {
               this.var_193.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_520.width,this.var_520.height);
               if(_loc4_ != null)
               {
                  this.var_520.setDisplayObject(_loc4_);
               }
            }
            else
            {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1146.text = _loc5_;
         this.var_929.height = this.var_929.textHeight + 5;
         this.var_1146.y = this.var_929.y + this.var_929.height;
         this.var_1146.height = Math.max(130,this.var_1146.textHeight + 5);
               ...
               case Offer.const_420:
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_520 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_345,AvatarAction.const_639);
                                 _loc18_.appendAction(AvatarAction.const_344,_loc9_.productClassId);
                                 _loc18_.endActionAppends();
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc16_ = _loc18_.getImage(AvatarSetType.const_40,true);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_96 != null && true)
         {
            ...
            this.var_96.x = this.var_1718.x;
            this.var_96.y = this.var_1718.y;
            if(param3 != null)
            {
