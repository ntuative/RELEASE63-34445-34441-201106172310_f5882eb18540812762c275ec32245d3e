package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_113:String = "floor";
      ...
      private var var_1578:String = "default";
      ...
      private var var_1577:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1048 = this.parseElements(_loc2_.floors.pattern);
         this.var_1288 = this.parseElements(_loc2_.walls.pattern);
         this.var_1289 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1048)
                  {
                     _loc11_ = this.var_1048[_loc10_];
                     if(this.var_682.indexOf(_loc10_) == -1)
                     {
                        this.var_682.push(_loc10_);
                        this.var_1287.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1288[_loc8_] != null)
                  {
                     this.var_844.push(_loc8_);
                  ...
                  break;
               case "landscape":
                  if(this.var_1289[_loc8_] != null)
                  {
                     this.var_845.push(_loc8_);
         ...
         this.changePattern(const_113,0);
         this.changePattern(const_236,0);
         this.changePattern(TYPE_LANDSCAPE,0);
         this.updateConfiguration();
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1578,this.var_1577,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1286[this.var_466];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_113,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_113,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_113,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_113,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1287[this.var_467];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_682[this.var_467];
         var _loc3_:Array = this.var_1048[_loc2_];
         if(_loc3_ != null && this.var_464 >= 0)
         {
            _loc11_ = _loc3_[this.var_464];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1287[this.var_467];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_844[this.var_466];
         var _loc6_:Array = this.var_1288[_loc5_];
         if(_loc6_ != null && this.var_469 >= 0)
         {
            _loc13_ = _loc6_[this.var_469];
            if(_loc13_ != null)
            {
               this.var_1578 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1286[this.var_466];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_845[this.var_468];
         var _loc9_:Array = this.var_1289[_loc8_];
         if(_loc9_ != null && this.var_465 >= 0)
         {
            _loc15_ = _loc9_[this.var_465];
            if(_loc15_ != null)
            {
               this.var_1577 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_113:
               ...
               if(this.var_467 < 0)
               {
                  this.var_467 = this.var_682.length - 1;
               }
               if(this.var_467 >= this.var_682.length)
               {
                  this.var_467 = 0;
               }
               this.var_464 = 0;
               this.var_1046 = 0;
               _loc5_ = this.var_682[this.var_467];
               _loc6_ = this.var_1048[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1046 = _loc6_.length;
               }
            ...
            case const_236:
               ...
               if(this.var_466 < 0)
               {
                  this.var_466 = this.var_844.length - 1;
               }
               if(this.var_466 == this.var_844.length)
               {
                  this.var_466 = 0;
               }
               this.var_469 = 0;
               this.var_1049 = 0;
               _loc7_ = this.var_844[this.var_466];
               _loc8_ = this.var_1288[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1049 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_468 < 0)
               {
                  this.var_468 = this.var_845.length - 1;
               }
               if(this.var_468 >= this.var_845.length)
               {
                  this.var_468 = 0;
               }
               this.var_465 = 0;
               this.var_1047 = 0;
               _loc9_ = this.var_845[this.var_468];
               _loc10_ = this.var_1289[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1047 = _loc10_.length;
               }
