package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1056:int = 0;
      ...
      {
         return this.var_654 != const_1056;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1857 != RecyclerStatusMessageEvent.const_1363;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_654 == const_464;
      }
      ...
      {
         this.var_654 = const_1055;
         this.var_125 = new Array(const_202);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_202)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_654 = const_1056;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_125.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_202)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_125.length < const_202)
         {
            return false;
         }
         var _loc1_:int = 0;
