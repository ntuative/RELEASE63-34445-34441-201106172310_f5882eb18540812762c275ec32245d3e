package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_105.productContainer.initProductIcon(this.var_28.roomEngine);
      }
      ...
      {
         if(!param1 || !param2 || !this.var_28 || !this.var_105)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_28.confirmSelection(this.var_105.localizationId);
               break;
