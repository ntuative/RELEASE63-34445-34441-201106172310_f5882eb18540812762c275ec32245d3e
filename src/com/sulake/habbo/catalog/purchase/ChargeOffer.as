package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeOffer implements IPurchasableOffer
   {
      ...
      {
         return this.var_713 != null ? int(this.var_713.priceInActivityPoints) : 0;
      }
      
      public function get activityPointType() : int
      {
         return this.var_713 != null ? int(this.var_713.activityPointType) : 0;
      }
      
      public function get priceInCredits() : int
      {
         return this.var_713 != null ? int(this.var_713.priceInCredits) : 0;
      }
