package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2130:IProductData;
      
      private var var_608:IFurnitureData;
      ...
      {
         this.var_1302 = param1.offerId;
         this.var_1697 = param1.productContainer.firstProduct.productClassId;
         this.var_2130 = param1.productContainer.firstProduct.productData;
         this.var_608 = param1.productContainer.firstProduct.furnitureData;
         this.var_1587 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_234,this._category,this.var_1696,this._x,this.var_170,this._direction,this.var_1302,this.var_1697].toString();
      }
