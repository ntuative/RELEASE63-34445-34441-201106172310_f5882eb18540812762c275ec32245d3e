package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2044:uint = 4.293848814E9;
      
      private const const_2045:uint = 4.294967295E9;
      
      private const const_1675:uint = 4.291613146E9;
      ...
      public function showOffer(param1:IHabboCatalog, param2:IRoomEngine, param3:IPurchasableOffer, param4:int, param5:String = "", param6:Array = null) : void
      {
         ...
         this.var_1302 = param3.offerId;
         this.var_1588 = param4;
         this.var_1587 = param5;
         this.var_257 = param6;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1302 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_326,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_355,this.onMessageInputFocus);
         }
         this.var_2019 = true;
         this.var_2018 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_643,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1995 = _loc1_.stuffTypes;
            this.var_861 = _loc1_.boxTypes;
            this.var_862 = _loc1_.ribbonTypes;
            this.var_1301 = this.var_1995[0];
            this.var_398 = this.var_861[0];
            this.var_397 = this.var_862[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_397 < 0)
         {
            this.var_397 = this.var_862.length - 1;
         }
         if(this.var_397 > this.var_862.length - 1)
         {
            this.var_397 = 0;
         }
         if(this.var_398 < 0)
         {
            this.var_398 = this.var_861.length - 1;
         }
         if(this.var_398 > this.var_861.length - 1)
         {
            this.var_398 = 0;
         }
         var _loc1_:int = this.var_861[this.var_398] * 1000 + this.var_862[this.var_397];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1301,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1589 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1995)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1301);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_861[this.var_398]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_862[this.var_397]);
         this._catalog.purchaseProductAsGift(this.var_1588,this.var_1302,this.var_1587,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1588,this.var_1302,this.var_1587);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_257)
         {
            ...
            if(_loc4_.length >= this.const_2331)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2808 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_396 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_396 + 1);
               break;
      ...
      {
         if(this.var_292 == null || !this.var_292.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_292.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_396) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_292 == null)
         {
            this.var_292 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_860 == null)
         {
            this.var_860 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_292 == null || this.var_860 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_292.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_860.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_292.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_396) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_396);
         }
         this.var_396 = param1;
         if(this.var_396 < 0)
         {
            this.var_396 = _loc2_.numListItems - 1;
         }
         if(this.var_396 >= _loc2_.numListItems)
         {
            this.var_396 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_396) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1675;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2044) : uint(this.const_2045);
      }
      ...
      {
         this.var_1301 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1301;
               }
            }
            _loc4_++;
         }
