package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1175:IRoomSession;
      ...
      private var var_215:CatalogViewer;
      ...
      private var var_2418:GiftWrappingConfiguration;
      
      private var var_1174:ClubGiftController;
      ...
      private var var_773:IPurchasableOffer;
      
      private var var_1462:IDragAndDropDoneReceiver;
      ...
      private var var_639:RoomPreviewer;
      
      private const const_2052:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_70,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1927);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_439.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         if(this._roomEngine != null && this.var_173 != null && this.var_173.getKey("catalog.furniture.animation","false") == "TeleportErrorHandler")
         {
            if(this.var_639 == null)
            {
               this.var_639 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_173.getKey("toolbar.new_additions.notification.enabled","false") == "TeleportErrorHandler";
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_173.getKey("client.credits.embed.enabled","false") == "TeleportErrorHandler";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_771.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_215.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_215 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_215.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_681) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2052;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_70:
               this.var_1791 = param1.session.isPrivateRoom;
               this.var_1175 = param1.session;
               if(this.var_104 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1174 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_439 == null)
         {
            this.var_439 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_215 != null)
         {
            this.var_215.catalogWindowClosed();
         }
         if(this.var_104 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_104.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1461 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_315.buildCatalogIndex(_loc2_);
         if(this.var_772 && this.var_772 != "")
         {
            this.var_315.openPage(this.var_772);
            this.var_772 = "";
            this.var_960 = -1;
         }
         else if(this.var_960 > -1)
         {
            this.var_315.openPageById(this.var_960,this.var_1792);
            this.var_960 = -1;
            this.var_1792 = -1;
            this.var_772 = "";
         }
         else if(this.var_1461 && this.var_2417)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_315.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1876));
         }
         else
         {
            this.var_315.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_215.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_215 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_215.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2420 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1247);
         }
         this.var_2420 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_116,this.var_116.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2419 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1312);
         }
         this.var_2419 = false;
         if(this.var_216 != null && !this.var_216.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_270,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_883)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_267,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_270,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_267,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1174.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2418 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_771.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_771.add(_loc2_.productCode,_loc3_.slice());
            this.var_215.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "TeleportErrorHandler" == this.var_173.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_173.keyExists("catalog.drag_and_drop") || this.var_173.getKey("catalog.drag_and_drop") != "TeleportErrorHandler")
         {
            return false;
         }
         if(!this.var_1175 || !this.var_1175.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1173 && param1.type == RoomEngineObjectEvent.const_163)
         {
            this.resetPlacedOfferData(true);
            if(this.var_773 == null || this.var_773.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_773.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_63 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_773);
            _loc5_ = this.var_1462;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_334,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_63)
         {
            if(this.var_63.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_63 != null && this.var_63.productClassId == param1.classId)
         {
            if(this.var_63.roomCategory == this._roomEngine.activeRoomCategory && this.var_63.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc3_ = this.var_63.category;
               _loc4_ = this.var_63.wallLocation;
               _loc5_ = this.var_63.x;
               _loc6_ = this.var_63.y;
               _loc7_ = this.var_63.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_346:
                     ...
                     if(this.var_63.extraParameter != _loc8_)
                     {
                  ...
                  case FurniCategory.const_332:
                     ...
                     if(this.var_63.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_323:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
                     if(this.var_63.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_173.getKey("image.library.catalogue.url");
      ...
      public function update(param1:uint) : void
      {
         if(this.var_639 != null)
         {
            this.var_639.updatePreviewRoomView();
         }
      }
   }
}
