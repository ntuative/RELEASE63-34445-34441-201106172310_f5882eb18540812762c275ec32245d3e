package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc3_.draw(_loc6_);
         this.var_1332 = param1 - _loc6_.textWidth - 2;
         this.var_1076 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_1076);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_1076 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_1332 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1332,(param2 - this.var_1076) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1332 + this.var_1332 / -this.var_3043 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1076 - this.var_1076 / this.var_703 * this.var_170[param1];
      }
