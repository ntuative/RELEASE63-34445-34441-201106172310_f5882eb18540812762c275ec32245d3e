package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_813:MarketPlaceLogic;
      ...
      public function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         ...
         this.var_105 = param2;
         if(!this.var_813 || !this._catalog || !this._catalog.localization)
         {
            return;
         }
         if(this._window)
         ...
         if(_loc3_)
         {
            if(param1 == this.var_813.const_2220)
            {
               _loc3_.text = "${catalog.marketplace.confirm_header}";
            }
            if(param1 == this.var_813.const_2097)
            {
         ...
         if(_loc3_)
         {
            _loc3_.text = "${" + this.var_813.getNameLocalizationKey(param2) + "}";
         }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%days%",this.var_813.averagePricePeriod.toString());
