package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2573 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1876 = (param2 & 0) > 0;
         if(!this.var_1876)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1876)
            {
               if("false" == this.var_173.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_173.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_187,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_187,this.onLocalizationLoaded);
         if(this.var_173.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_173.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_187,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_187,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1877[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1877[param1];
      }
      ...
      {
         return this.var_2573[Math.max(0,param1 - 1)];
      }
