package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotificationBonus
   {
      ...
      private const const_2325:String = "achievement_bg_001_png";
      ...
      public function AchievementNotificationBonus(param1:int, param2:String, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager)
      {
         ...
         if(param2 && param2 != "")
         {
            this.var_72.registerParameter("notifications.achievement.bonus_received.name","realname",param2);
            this.setText("bonus_info",this.var_72.getKey("notifications.achievement.bonus_received.name"));
         }
         var _loc7_:BitmapData = (param3.getAssetByName(this.const_2325) as BitmapDataAsset).content as BitmapData;
