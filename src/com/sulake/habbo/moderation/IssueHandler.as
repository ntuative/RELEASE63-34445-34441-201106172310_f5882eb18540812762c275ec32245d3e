package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_187:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_581:UserInfoCtrl;
      
      private var var_1342:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_187.getHighestPriorityIssue();
         this.var_581 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_1342 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_581.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_187.reportedUserId > 0)
         {
            this.var_1342.load(_loc4_,this.var_187.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_187.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_187.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_76 != null && this.var_76.issueManager != null && this.var_187 != null)
         {
            this.var_76.issueManager.removeHandler(this.var_187.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_187.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_187.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_187.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.releaseBundle(this.var_187.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_187.getHighestPriorityIssue().issueId;
         this.var_76.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_76,WindowTracker.const_1276,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_187.getHighestPriorityIssue();
            this.var_581 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
            this.var_581.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
