package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1322:IDropMenuWindow;
      ...
      private var var_1069:OffenceCategoryData;
      
      private var var_1070:OffenceData;
      
      private var var_1320:IButtonWindow;
      
      private var var_1321:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1320 = IButtonWindow(this.var_37.getXmlWindow("modact_offence"));
         this.var_1321 = IButtonWindow(this.var_37.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1793;
         ...
         this.var_1322 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1322);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1069 != null;
         if(this.var_1070 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1070.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1069 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1069.offences,this.var_1320,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_37.initMsg.offenceCategories,this.var_1321,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1801;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModAlertMessageComposer(this.var_1618,this.var_571.text,this.var_1619));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1069 = this.var_37.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1070 = this.var_1069.offences[_loc3_];
         this.var_571.text = this.var_1070.msg;
         this.var_711 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModKickMessageComposer(this.var_1618,this.var_571.text,this.var_1619));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1322.selection < 0)
         {
            this.var_37.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_37.connection.send(new ModBanMessageComposer(this.var_1618,this.var_571.text,this.getBanLength(),this.var_1619));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_711 || this.var_571.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1322.selection;
