package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1954 ? 0 : 1,this._roomId),this.var_37,WindowTracker.const_868,this._roomId),this._frame,false,false,true);
      }
