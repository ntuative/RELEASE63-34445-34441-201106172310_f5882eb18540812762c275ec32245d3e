package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2105:int = 200;
      ...
      {
         this.var_887 = IWindowContainer(this.var_37.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1877;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.method_8(_loc3_,this.var_65);
      }
      
      private function method_8(param1:IWindowContainer, param2:IItemListWindow) : void
      {
         param2.addListItem(param1);
         this.var_1639.push(param1);
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1639)
         {
