package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1178:IDropMenuWindow;
      ...
      private var var_1515:ICheckBoxWindow;
      
      private var var_1516:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1774;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1178 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1178);
         this.var_1178.procedure = this.onSelectTemplate;
         this.var_995 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1515 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1516 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_37,WindowTracker.const_868,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_995.isSelected);
         this.var_37.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1709,_loc2_,this.var_571.text,"",""));
         if(this.var_1515.isSelected || this.var_1516.isSelected || this.var_995.isSelected)
         {
            this.var_37.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1515.isSelected,this.var_1516.isSelected,this.var_995.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1983);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_37.initMsg.roomMessageTemplates[this.var_1178.selection];
         if(_loc3_ != null)
         {
            this.var_711 = false;
