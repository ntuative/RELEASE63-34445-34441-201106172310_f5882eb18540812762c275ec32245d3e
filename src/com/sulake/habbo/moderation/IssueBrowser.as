package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2320:String = "my_issues";
      
      private const const_2318:String = "open_issues";
      
      private const const_2319:String = "picked_issues";
      
      private const const_2345:String = "closed_issues";
      ...
      private var var_1864:IIssueBrowserView;
      
      private var var_1866:IIssueBrowserView;
      
      private var var_1865:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         var _loc1_:ISelectableWindow = this.var_280.selector.method_1("open_issues");
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_378 == _loc2_)
         {
            return;
         }
         if(this.var_378 != null)
         {
            this.var_378.visible = false;
         }
         this.var_378 = _loc2_;
         if(this.var_378 == null)
         {
         ...
         this.var_378.view.width = this.var_280.container.width;
         this.var_378.view.height = this.var_280.container.height;
         this.var_378.visible = true;
         this.var_378.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2320:
               ...
               {
                  this.var_1864 = new MyIssuesView(this.issueManager,this,this.var_280.container);
               }
               return this.var_1864;
            case this.const_2318:
               if(this.var_1866 == null)
               {
                  this.var_1866 = new OpenIssuesView(this.issueManager,this,this.var_280.container);
               }
               return this.var_1866;
            case this.const_2319:
               if(this.var_1865 == null)
               {
                  this.var_1865 = new PickedIssuesView(this.issueManager,this,this.var_280.container);
               }
