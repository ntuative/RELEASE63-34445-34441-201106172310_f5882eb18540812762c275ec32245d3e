package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1793;
      ...
      {
         return WindowTracker.const_1827;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_37.initMsg.messageTemplates[this.var_1178.selection];
         if(_loc3_ != null)
         {
            this.var_711 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.connection.send(new ModMessageMessageComposer(this.var_1618,this.var_571.text,this.var_1619));
         this.dispose();
      }
