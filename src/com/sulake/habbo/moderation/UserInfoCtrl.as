package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1085:int = 86400;
      
      private static const const_1083:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1082) + " mins ago";
         }
         if(param1 < 2 * const_1085)
         {
            return Math.round(param1 / const_1084) + " hours ago";
         }
         if(param1 < 2 * const_1083)
         {
            return Math.round(param1 / const_1085) + " days ago";
         }
         return Math.round(param1 / const_1083) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1235.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_37.getXmlWindow("user_info"));
            this.var_1235.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_37,WindowTracker.const_1241,this._data.userId),this._callerFrame,this.var_1234,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new RoomVisitsCtrl(this.var_37,this._data.userId),this._callerFrame,this.var_1234,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new SendMsgsCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1619),this._callerFrame,this.var_1234,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ModActionCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1619),this._callerFrame,this.var_1234,false,true);
      }
