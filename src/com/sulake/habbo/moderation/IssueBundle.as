package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_900:IssueMessageData = null;
      
      private var var_901:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2272 = param2.pickerUserId;
         this.var_2963 = param2.pickerUserName;
         this.var_1557 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1371 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1372;
         }
         if(this.var_900 == null || param1.timeStamp < this.var_900.timeStamp)
         {
            this.var_900 = param1;
         }
         if(this.var_901 == null || param1.priority > this.var_901.timeStamp)
         {
            this.var_901 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1371 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1372;
            }
            if(this.var_900 == _loc2_)
            {
               this.var_900 = null;
            }
            if(this.var_901 == _loc2_)
            {
               this.var_901 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_901;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_900;
         if(_loc2_ == null)
         {
