package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1601:int = 8;
      
      private static const const_1596:int = 5;
      
      private static const const_1600:int = 6;
      
      private static const const_1602:int = 3;
      
      private static const const_1594:int = 2;
      
      private static const const_1114:int = 6;
      
      private static const const_1599:int = 180;
      
      private static const const_1604:int = 246;
      
      private static const const_1595:int = 45;
      
      private static const const_1598:Point = new Point(115,93);
      
      private static const const_1593:Point = new Point(72,1);
      
      private static const const_1115:int = 40;
      
      private static const const_1105:int = 20;
      
      private static const const_1603:int = 3;
      
      private static const const_1597:int = 10;
      ...
      private var var_471:IWindowContainer;
      ...
      private var var_686:ProgressBar;
      
      private var var_849:ProgressBar;
      
      private var var_1291:Matrix;
      
      private var var_2004:ColorMatrixFilter;
      ...
      private var var_850:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_848 = new Timer(2000,1);
         this.var_848.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_850 = new AchievementLevelUp(this._questEngine);
         this.var_1291 = new Matrix();
         this.var_2004 = this.createGrayscaleFilter();
         this.var_685[16] = 1;
         this.var_685[28] = 6;
         this.var_685[38] = 4;
         this.var_685[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_848)
         {
            this.var_848.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_848.reset();
            this.var_848 = null;
         }
         if(this.var_686)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1595;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_471.height = getLowestPoint(this.var_471);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_1292.visible = true;
         this.var_849.refresh(this.var_115.getProgress(),this.var_115.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_1050.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_1050,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_472.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getBadgeName(_loc1_);
         var _loc2_:String = this._questEngine.localization.getBadgeDesc(_loc1_);
         this.var_472.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this._questEngine.refreshReward(!this.var_75.finalLevel,this.var_472,this.var_75.levelRewardPointType,this.var_75.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_472,this.var_75);
         this.var_686.refresh(this.var_75.currentPoints,this.var_75.scoreLimit,this.var_75.type * 10000 + this.var_75.level);
         this.var_686.visible = !this.var_75.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1105;
         this.var_471 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1050 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_851 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_472 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1580 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1292 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_686 = new ProgressBar(this._questEngine,this.var_472,const_1599,"achievements.details.progress",true,const_1598);
         this.var_849 = new ProgressBar(this._questEngine,this.var_1292,const_1604,"achievements.categories.totalprogress",true,const_1593);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_471.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_698);
         var _loc5_:* = _loc4_ < const_1602;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1601) * (param1 % const_698);
            _loc3_.y = (_loc3_.height + const_1596) * Math.floor(param1 / const_698) + const_1600;
         }
      ...
      private function refreshAchievementEntry(param1:int, param2:AchievementData) : Boolean
      {
         ...
         var _loc4_:int = Math.floor(param1 / const_1114);
         var _loc5_:* = _loc4_ < const_1594;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1114);
            _loc3_.y = _loc3_.height * _loc4_ + const_1603;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_471.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_471.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_847[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_847[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1115 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1597) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_2004);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1115 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1291.identity();
         this.var_1291.scale(2,2);
         this.var_1291.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1291);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_2004);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_75 = this.var_1579;
         this.var_115.update(this.var_1579);
         this.var_1579 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_847[param1.badgeId] = param1.badgeImage;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_686.updateView();
         }
         if(this.var_849 != null)
         {
            this.var_849.updateView();
         }
         if(this.var_850 != null)
         {
            this.var_850.update(param1);
         }
      }
      ...
      {
         return !!this.var_685[param1] ? int(this.var_685[param1]) : 0;
      }
