package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1595:int = 56;
      
      private static const const_707:int = 5;
      
      private static const const_1642:int = 5;
      
      private static const const_1129:Point = new Point(8,8);
      
      private static const const_1643:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_134 == null || this.var_134.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc10_.x = const_1129.x;
            _loc10_.y = const_1129.y;
         ...
         var _loc2_:* = this.var_134.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1642;
         }
         ...
         var _loc7_:Boolean = const_1643.indexOf(param1.type) > -1 && !_loc2_;
         _loc6_.y = _loc3_.y + _loc3_.height + const_707;
         var _loc8_:int = 0;
         if(_loc7_ && !_loc6_.visible)
         {
            _loc8_ = const_707 + _loc6_.height;
         }
         if(!_loc7_ && _loc6_.visible)
         {
            _loc8_ = -const_707 - _loc6_.height;
         ...
         this._window.height = _loc10_.height + const_1595;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1566 = NextQuestTimer.const_1008;
         var _loc2_:Boolean = this._questEngine.questController.questsList.refreshDelay(this._window,this.var_134);
         if(_loc2_)
         {
            this.openDetails(this.var_134);
         }
      }
   }
}
