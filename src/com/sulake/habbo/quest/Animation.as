   ...
   public class Animation implements IDisposable
   {
      ...
      private function draw() : void
      {
         ...
         if(this.var_1250)
         {
            ...
            {
               if(!_loc2_.isFinished(this.var_1009))
               {
                  _loc1_ = true;
                  _loc3_ = _loc2_.getBitmap(this.var_1009);
                  if(_loc3_ != null)
                  {
                     this.var_99.bitmap.copyPixels(_loc3_,_loc3_.rect,_loc2_.getPosition(this.var_1009));
                  }
               }
            }
         }
         this.var_99.invalidate(this.var_99.rectangle);
         this.var_1250 = _loc1_;
      }
   }
}
