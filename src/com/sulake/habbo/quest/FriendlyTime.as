package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1144:int = 3600;
      
      private static const const_1678:int = 3 * const_1145;
      
      private static const const_1677:int = 3 * const_1144;
      ...
      {
         if(param2 > const_1677)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1144));
         }
         if(param2 > const_1678)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1145));
         }
