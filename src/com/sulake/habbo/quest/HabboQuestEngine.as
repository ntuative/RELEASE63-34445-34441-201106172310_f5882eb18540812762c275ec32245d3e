package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1607:int = 5;
      
      private static const const_1608:int = 800;
      
      private static const const_1606:int = 15;
      
      private static const const_1609:int = 300;
      ...
      private var var_1294:QuestController;
      
      private var var_1052:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1294 = new QuestController(this);
         this.var_1052 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1607);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_370.events.removeEventListener(BadgeImageReadyEvent.const_226,this.var_1052.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_370.events.addEventListener(BadgeImageReadyEvent.const_226,this.var_1052.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1294.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1052.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1294.questTracker.isVisible();
      }
      ...
      {
         this.var_1294.update(param1);
         this.var_1052.update(param1);
      }
