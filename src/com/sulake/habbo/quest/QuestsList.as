package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1682:int = 5;
      
      private static const const_1681:int = 10;
      
      private static const const_1680:int = 10;
      
      private static const const_1679:int = 30;
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1659.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1659[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_597 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_65.spacing = const_1681;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1680;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1682;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1679;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2133 && !this.var_2134)
            {
               this.var_2133 = false;
