package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_1008:int = 1000;
      
      private static const const_1580:int = 115;
      
      private static const const_1582:int = 25;
      
      private static const const_1105:int = 72;
      
      private static const const_1581:int = 4;
      ...
      {
         var _loc1_:int = this.var_134.waitPeriodSeconds;
         if(_loc1_ < 1)
         {
            this.close();
            this.var_134.waitPeriodSeconds = 0;
            this._questEngine.questController.onQuest(this.var_134);
         }
         var _loc2_:String = FriendlyTime.getFriendlyTime(this._questEngine.localization,_loc1_);
         var _loc3_:* = this.var_134.getCampaignLocalizationKey() + ".delayedmsg";
         ...
         this._window.findChildByName("quest_header_txt").caption = this._questEngine.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_461 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_461;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_461;
         this._window.findChildByName("more_info_txt").visible = this.var_461 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_461 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_461;
         this._window.findChildByName("desc_txt").visible = this.var_461;
         this._questEngine.notifications.setQuestTrackerHeight(!!this.var_461 ? int(const_1580) : int(const_1582));
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._questEngine.questController.questDetails.showDetails(this.var_134);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1566 = const_1008;
         this.refresh();
      }
      
      private function getDefaultLocationX() : int
      {
         return this._window.desktop.width - this._window.width - const_1581;
      }
