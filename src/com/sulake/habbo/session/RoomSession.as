package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2314:int = 2500;
      ...
      private var var_1211:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1211 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1211.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_304 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_70;
      ...
      public function sendChatMessage(param1:String) : void
      {
         ...
         this.var_1489.add(this.var_1490,getTimer());
         ++this.var_1490;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1489.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2314)
            {
      ...
      {
         return this.var_1211 as IUserDataManager;
      }
