   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_249)
         {
            ...
            {
               _loc1_ = this.var_249.getKey(0) as String;
               _loc2_ = this.var_249.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1982)
         {
            this.gotoRoom(this.var_2756,this.var_2755,this.var_1983);
            this.var_1982 = false;
            this.var_1983 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1568 = true;
         if(this.var_249.getValue(_loc6_) != null)
         {
         ...
         this.var_249.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_304,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_70)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1568 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_70,param1));
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_249.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_249.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_249.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_249.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_249.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
