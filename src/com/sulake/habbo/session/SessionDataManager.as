package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1830:GroupDetailsView;
      ...
      private var var_649:ProductDataParser;
      ...
      private var var_973:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_973 = new IgnoredUsersManager(this);
         this.var_1203 = new FaceBookSession();
         this.var_1326 = new Dictionary();
         this.var_1202 = [];
         this.var_972 = [];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_317)
         {
            this.var_317.removeEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
            this.var_317.dispose();
            this.var_317 = null;
         }
         if(this.var_649)
         {
            this.var_649.removeEventListener(ProductDataParser.const_136,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1200 = new BadgeImageManager(context.root.assets,events,this.var_173,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_973.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_317)
         {
            ...
            this.var_317 = new FurnitureDataParser(this.var_538,this._wallItems,this.var_539,this._localization);
            this.var_317.addEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
      ...
      private function onFurnitureReady(param1:Event = null) : void
      {
         var _loc2_:* = null;
         this.var_317.removeEventListener(FurnitureDataParser.const_136,this.onFurnitureReady);
         for each(_loc2_ in this.var_972)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1832 = _loc2_.clubLevel;
         this.var_1833 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_1204 = _loc3_.respectLeft;
         this.var_787 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1043 = _loc3_.sex;
         this.var_1754 = _loc3_.realName;
         this.var_2468 = _loc3_.identityId;
         this.var_973.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1043 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1043));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2466 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1833 >= SecurityLevelEnum.const_1349;
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1830 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1201.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1830.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1200.getBadgeImage(param1,BadgeImageManager.const_1191);
      }
      ...
      {
         return this.var_973.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_973.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_973.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1204 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1204 = this.var_1204 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_787 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_787 = this.var_787 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_538.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_539.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_649 == null)
         {
            ...
            this.var_649 = new ProductDataParser(_loc2_,this.var_1326);
            this.var_649.addEventListener(ProductDataParser.const_136,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_538.getValues();
