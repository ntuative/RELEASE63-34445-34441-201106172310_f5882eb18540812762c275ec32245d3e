package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1074:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1538:String = "sendAccessTokenToServer";
      
      private static const const_1537:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1538,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1537,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1074);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1074);
         }
      }
