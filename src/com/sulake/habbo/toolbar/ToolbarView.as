package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1629:Point = new Point(3,3);
      
      private static const const_1628:uint = 7433577;
      
      private static const const_1625:uint = 5723213;
      ...
      private static const const_1624:int = 600;
      
      private static const const_1630:int = 80;
      
      private static const const_1623:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1626:int = -2;
      ...
      private var var_1616:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1629;
         this._window.addEventListener(WindowEvent.const_599,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_473);
         }
         ...
         this.var_227 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_227);
         var _loc14_:ITextWindow = this.var_227.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_227.x = _loc13_.width - this.var_227.width - const_474;
         this.var_227.y = const_474;
         this.var_2826 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1624;
         if(!param1 && _loc2_ == this.var_1615)
         {
            return;
         }
         this.var_1615 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1623) : int(const_1630);
         var _loc4_:int = !!_loc2_ ? int(const_1626) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1627 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1631;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_227 != null && this.var_2826)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_779:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_835:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_475 ? this.var_1616 : this.var_1614;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_475)
         {
            param1.color = const_1628;
         }
         else
         {
            param1.color = const_1625;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1615 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1615 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1614 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1616)
         {
            this.var_1616.dispose();
         }
         this.var_1616 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1068.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_474;
            this.var_1068.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","false") == "TeleportErrorHandler";
      }
   }
}
