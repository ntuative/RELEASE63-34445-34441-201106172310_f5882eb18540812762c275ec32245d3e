package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_798:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1493:PurseExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_284.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_284 && this._windowManager && this._config)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "TeleportErrorHandler")
         {
            this.var_798 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
            this.var_1493 = new PurseExtension(this._windowManager,this._assetLibrary,events,this._config,this._catalog);
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_798.showRoomInfo();
         }
         else
         {
            this.var_798.hideRoomInfo();
         }
      }
