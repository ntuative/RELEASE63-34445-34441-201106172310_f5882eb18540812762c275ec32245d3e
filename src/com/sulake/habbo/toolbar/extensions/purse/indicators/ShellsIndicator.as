package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator implements ICurrencyIndicator
   {
      ...
      private const const_2322:uint = 4.283212437E9;
      
      private const const_2321:uint = 4.282748017E9;
      ...
      public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_267,this.onShellBalance);
      }
      ...
      public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(PurseEvent.const_267,this.onShellBalance);
      }
      
      private function onShellBalance(param1:PurseEvent) : void
      {
         this.var_2952 = param1.balance;
         var _loc2_:String = this.var_2952.toString();
         if(_loc2_.length < 2)
         {
            _loc2_ = "  " + _loc2_;
         }
