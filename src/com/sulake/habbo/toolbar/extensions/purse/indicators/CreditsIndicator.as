package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator implements ICurrencyIndicator
   {
      ...
      private const const_2322:uint = 4.291993382E9;
      
      private const const_2321:uint = 4.29080704E9;
      ...
      {
         this.var_2235 = param1.balance;
         var _loc2_:String = this.var_2235.toString();
         if(_loc2_.length < 2)
         {
            _loc2_ = "  " + _loc2_;
         }
