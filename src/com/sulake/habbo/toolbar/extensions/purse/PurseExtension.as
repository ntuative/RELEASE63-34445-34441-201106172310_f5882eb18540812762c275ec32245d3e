package com.sulake.habbo.toolbar.extensions.purse
{
   ...
   public class PurseExtension
   {
      ...
      private var var_1310:Vector.<ICurrencyIndicator>;
      ...
      {
         var _loc7_:* = null;
         this.var_1310 = new Vector.<ICurrencyIndicator>();
         super();
         ...
         if(_loc6_)
         {
            ...
            if(_loc7_)
            {
               ...
               if(this.var_173.getKey("purse.widget.currency.shells.enabled","0") == "1")
               {
      ...
      private function addIndicator(param1:IItemListWindow, param2:ICurrencyIndicator, param3:IEventDispatcher) : void
      {
         ...
         this.var_1310.push(param2);
      }
      
      private function rePosition() : void
      {
         var _loc1_:IWindowContainer = this._view.desktop;
         this._view.x = _loc1_.width - this._view.width - const_1123;
         this._view.y = const_1123;
      }
   }
}
