package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1674:uint = 16777215;
      
      private static const const_1675:uint = 12247545;
      
      private static const const_1673:String = "HELP";
      
      private static const const_1676:String = "ROOMINFO";
      ...
      private const const_839:int = 42;
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_372 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_65.removeListItem(this.var_372);
      }
      
      public function showRoomInfo() : void
      {
         this.var_65.addListItemAt(this.var_372,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_910;
         _loc3_.y = this.const_839;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_715)
         {
            this.var_715 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1673);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1676);
               break;
            case "confirm":
               if(false)
               {
