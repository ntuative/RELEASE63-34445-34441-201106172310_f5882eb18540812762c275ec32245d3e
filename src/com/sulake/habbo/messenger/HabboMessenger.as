package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_431:Conversations;
      
      private var var_192:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_173 && this._localization && this._friendList && this.var_744 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_431 = new Conversations(new ConversationsDeps(this));
         this.var_192 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_431.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_431.setSelected(_loc2_);
            this.var_192.openMessenger();
            this.var_192.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_431 ? this.var_431.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_431.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_431.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_192 && this.var_192.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_192)
         {
            if(this.var_192.isMessengerOpen())
            {
               this.var_192.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_940,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1279,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_431.addMessageAndUpdateView(param1);
         if(!this.var_192.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1225,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_431.addMessageAndUpdateView(_loc3_);
      }
