package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1146:int = 100;
      
      private static const const_1701:int = 20;
       
      
      private var var_154:HabboMessenger;
      
      private var var_2984:IScrollbarWindow;
      
      private var var_2163:IContainerButtonWindow;
      
      private var var_65:IItemListWindow;
      
      private var var_591:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_154 = param1;
         this.var_2163 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_65 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2984 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1146 + const_1701)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1700;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_591 == null || _loc1_.id != this.var_591.id)
         {
            this.var_591 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_591.followingAllowed)
         {
            this.var_2163.enable();
         }
         else
         {
            this.var_2163.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_65.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_591.messages.length - const_1146);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_591.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_591.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_829 || param3.type == Message.const_940 ? param3.time + ": " : "";
         _loc4_.text = _loc5_ + param3.messageText;
         _loc4_.color = this.getChatBgColor(param3.type);
         _loc4_.textColor = this.method_9(param3.type);
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_591.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_154.send(new FollowFriendMessageComposer(this.var_591.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_940)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1225)
         {
            return 4294927974;
         }
         ...
         if(param1 == Message.const_888)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1279)
         {
            return 4288269465;
         }
         return 4291611852;
      ...
      private function method_9(param1:int) : uint
      {
         if(param1 == Message.const_1011)
         {
            return 4285887861;
