package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_28.figureData.getPartSetId(FigureData.const_86);
         var _loc3_:Array = var_28.figureData.getColourIds(FigureData.const_86);
         var _loc4_:CategoryData = var_115[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         for each(_loc5_ in _loc4_.parts)
         {
            ...
            _loc7_ = var_28.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_59,null,this);
