package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_2101:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_4;
         this._assets = param4;
         this.var_886 = String(param1);
         this._revision = String(param2);
         this.var_1341 = param3 + this.var_886 + ".swf";
         this.var_1341 = this.var_1341.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_886 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_886);
            this._state = name_5;
         }
      }
      ...
      {
         this._state = var_2101;
         var _loc1_:URLRequest = new URLRequest(this.var_1341);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_886 + " from URL " + this.var_1341,false,Core.const_1189);
      }
      ...
      {
         var _loc1_:String = this.var_886;
