package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2316:String = "hd-99999-99999";
      ...
      private var var_319:PetDataManager;
      
      private var var_797:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_684 = RenderMode.const_1870;
         ...
         this.var_117.add(AvatarType.const_120,_loc4_);
         ...
         this.var_319 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_797 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_319.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_319.init();
         this.var_797.init();
         _loc2_ = this.var_117.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_117.getValue(AvatarType.const_120) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_930)
         {
            if(this.var_2510 && this.var_2512 && this.var_2511)
            {
               this.var_930 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_117.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1852)
         {
            this.var_1852 = new AvatarFigureContainer(this.const_2316);
         }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_320.getKeys())
         {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_319.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1817)
         {
            _loc6_ = !this.var_319.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_319.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_320.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_319.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_117.getValue(AvatarType.const_56);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_320.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_320.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_117.getValue(AvatarType.const_120) as AvatarStructure;
      ...
      {
         return this.var_319 as IPetDataManager;
      }
