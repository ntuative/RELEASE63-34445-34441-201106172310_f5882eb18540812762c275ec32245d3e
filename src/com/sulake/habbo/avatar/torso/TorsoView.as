   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_219,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_276,_windowManager,_assetLibrary);
         ...
         if(var_77 && var_163 == "")
         {
            var_77.switchCategory(FigureData.const_219);
         }
      }
