package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_599:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1663);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_697);
            if(_loc9_ && _loc9_.image && _loc9_.method_2)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_697);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_697);
            if(_loc10_ != null)
            {
               ...
               _loc12_ = _loc10_.method_2.clone();
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_697);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_575 = this.var_575 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_388:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1984:
                  case AvatarAction.const_1218:
                  case AvatarAction.const_1188:
                  case AvatarAction.const_1874:
                  case AvatarAction.const_1816:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1116);
         this.getCache().resetBodyPartCache(this.var_1116);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1664 = this._structure.sortActions(this.var_353);
         ...
         {
            this.var_807 = this._structure.getCanvasOffsets(this.var_1664,this._scale,this.var_101);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1664)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1141 = _loc4_.id;
                     this.var_1713 = _loc4_.breed;
                     break;
                  }
               }
            }
