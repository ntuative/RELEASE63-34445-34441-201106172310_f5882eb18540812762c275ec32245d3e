package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2560 = parseInt(param1.@precedence);
         this.var_2559 = String(param1.@activepartset);
         this.var_2565 = String(param1.@assetpartdefinition);
         this.var_2564 = String(param1.@lay);
         this.var_891 = String(param1.@geometrytype);
         this.var_2563 = Boolean(parseInt(param1.@main));
         this.var_2561 = Boolean(parseInt(param1.@name_6));
         this.var_2562 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "TeleportErrorHandler"));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_807.add(param1,new Map());
         }
         var _loc4_:Map = this.var_807.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_807.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1871[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2566;
         }
         return _loc2_;
      }
