   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_206,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_283,_windowManager,_assetLibrary);
            ...
            var_41["null"] = new AvatarEditorGridView(var_77,FigureData.const_301,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_77 && var_163 == "")
         {
            var_77.switchCategory(FigureData.const_206);
         }
      }
