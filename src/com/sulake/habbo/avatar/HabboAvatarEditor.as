package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1632:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_2704:uint;
      
      private var var_573:HabboAvatarEditorManager;
      
      private var var_1073:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_573 = param2;
         this.var_1073 = this.var_573.avatarRenderManager.getFigureData(AvatarType.const_120);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_572)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         _loc2_.loadAvatarData(const_1632,FigureData.const_87);
         _loc3_.loadAvatarData(const_1633,FigureData.FEMALE);
         this.var_115 = new Map();
         this.var_572 = new Map();
         this.var_115.add(AvatarEditorFigureCategory.const_902,new BodyModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_306,new TorsoModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_920,new LegsModel(this));
         ...
         this.var_572.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
         this.var_572.add(AvatarEditorSideCategory.const_597,new ClubPromoModel(this));
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1073.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1073.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_902);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_572.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_695[this.var_1043];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_573.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_873 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_704)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1669.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_573.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_573.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_573.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1959)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_873 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1380.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_573.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_873 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_572.getValue(AvatarEditorSideCategory.const_110);
      }
