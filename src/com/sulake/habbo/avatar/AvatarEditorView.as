package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2181:int = 6710886;
      
      private static const const_1695:int = 5000;
      
      private static const const_1629:Point = new Point(100,30);
      ...
      private var var_259:ITabSelectorWindow;
      ...
      private var var_2981:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1378 = [];
         this.var_1542 = [AvatarEditorFigureCategory.const_902,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_306,AvatarEditorFigureCategory.const_920,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         this.var_24 = param1;
         if(var_1380 == null)
         {
            _loc4_ = this.var_24.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1380 = this.var_24.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1669 == null)
         {
            _loc5_ = this.var_24.manager.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1669 = this.var_24.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this._saveTimer = new Timer(const_1695,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1542;
         }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_90.position = const_1629;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_726 == null)
            {
               this.var_726 = this.var_24.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_726.addChild(this.var_61);
            }
            _loc3_ = this.var_726.getChildIndex(this.var_61);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1542);
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_259 = this.var_61.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_259.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_259.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1378.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_259.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_259.numSelectables)
               {
                  this.var_259.getSelectableAt(_loc4_).x = this.var_259.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_259.setSelected(this.var_259.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1542;
      ...
      public function update() : void
      {
         ...
         if(this.var_24.manager.sessionData && this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_38 && (this.var_1667 == AvatarEditorSideCategory.const_110 || this.var_2981))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_368);
      }
      ...
      {
         if(this.var_1667 == AvatarEditorSideCategory.const_110)
         {
            this.var_2981 = false;
            this.setSideContent(AvatarEditorSideCategory.const_602);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_602:
               break;
            case AvatarEditorSideCategory.const_597:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_597);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_368 = param1;
         this.var_259.setSelected(this.var_259.method_1(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_346)
         {
            ...
            this.var_346 = this.var_24.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_346.procedure = this.stripClubDialogEventProc;
            this.var_346.center();
         }
         else
         {
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_24.manager.catalog.openCatalogPage(CatalogPageName.const_184,true);
         }
      }
   }
}
