package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditorManager extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_913:AvatarEditorMessageHandler;
      ...
      public function close(param1:uint) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorInstanceId.const_216:
               _loc2_.hide();
               break;
            case AvatarEditorInstanceId.const_394:
               _loc2_.hide();
               _loc2_.dispose();
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_1037 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_913 = new AvatarEditorMessageHandler(this,this._communication);
      }
