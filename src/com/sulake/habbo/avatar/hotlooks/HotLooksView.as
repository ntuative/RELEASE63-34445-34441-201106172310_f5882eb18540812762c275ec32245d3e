package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_663:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_663 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_663.numGridItems > 0)
         {
            this.var_663.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_77 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_77.hotLooks)
         {
            ...
            this.var_663.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_663.getGridItemIndex(param2.parent);
