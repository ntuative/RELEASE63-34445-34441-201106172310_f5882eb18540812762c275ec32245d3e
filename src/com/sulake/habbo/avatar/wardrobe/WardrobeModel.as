package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      public function dispose() : void
      {
         var _loc1_:* = null;
         this.var_28 = null;
         for each(_loc1_ in this.var_574)
         {
            _loc1_.dispose();
            _loc1_ = null;
         }
      ...
      private function init() : void
      {
         ...
         while(_loc1_ <= 10)
         {
            this.var_574.add(_loc1_,new WardrobeSlot(this.var_28,_loc1_,this.isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      public function updateSlots(param1:int, param2:Array) : void
      {
         ...
         {
            _loc3_ = this.var_574.getValue(_loc4_.slotId) as WardrobeSlot;
            if(_loc3_)
            {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return this.var_28.manager.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_38);
         }
         return this.var_28.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_46);
      }
      
      public function get slots() : Array
      {
         return this.var_574.getValues();
      }
   }
}
