package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1573)
         {
            _loc5_ = this.var_28.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_115,this.var_1043,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_40,parseInt(FigureData.const_841));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1573 && this._figure != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1043 = this.var_28.gender;
               this.var_28.handler.saveWardrobeOutfit(this.var_1993,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_28.loadAvatarInEditor(this._figure,this.var_1043,this.var_28.clubMemberLevel);
               }
         }
      }
