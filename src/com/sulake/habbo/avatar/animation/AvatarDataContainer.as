package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1694:Number = 1.0;
      ...
      {
         super();
         this.var_1851 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2503 = parseInt(_loc2_,16);
         this.var_2501 = parseInt(_loc3_,16);
         ...
         this.var_884 = new ColorTransform(this.var_1691,this.var_1692,this.var_1694,this._alphaMultiplier);
         this.var_1212 = this.generatePaletteMapForGrayscale(this.var_2501,this.var_2503);
      }
      ...
      {
         return this.var_1212.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1212.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1212.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1212.getValue("alphas") as Array;
      }
