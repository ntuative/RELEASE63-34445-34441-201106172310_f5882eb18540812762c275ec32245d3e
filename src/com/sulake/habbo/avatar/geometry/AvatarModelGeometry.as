package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1168:Matrix4x4;
      
      private var var_955:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_955 = new Vector3D(0,0,10);
         super();
         this.var_1168 = new Matrix4x4();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_955.x = _loc11_;
            this.var_955.y = _loc12_;
            this.var_955.z = _loc13_;
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_177[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1168 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1168);
            _loc9_ = _loc7_.getDistance(this.var_955);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1168 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1168,this.var_955,param4);
         }
         return [];
      }
