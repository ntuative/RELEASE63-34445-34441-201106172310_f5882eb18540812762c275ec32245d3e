package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      {
         return this._x * param1.x + this.var_170 * param1.y + this.var_169 * param1.z;
      }
      
      public function cross(param1:Vector3D) : Vector3D
      {
         var _loc2_:Vector3D = new Vector3D();
         _loc2_.x = this.var_170 * param1.z - this.var_169 * param1.y;
      ...
      {
         return Math.sqrt(this._x * this._x + this.var_170 * this.var_170 + this.var_169 * this.var_169);
      }
      
      public function toString() : String
      {
         return "Vector3D: (" + this._x + "," + this.var_170 + "," + this.var_169 + ")";
      }
