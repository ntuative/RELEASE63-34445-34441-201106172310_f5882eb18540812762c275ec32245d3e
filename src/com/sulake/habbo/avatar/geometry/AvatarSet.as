package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2563 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1344 = new Dictionary();
         this.var_2109 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1344[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_2109.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_2109.concat();
         for each(_loc3_ in this.var_1344)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2905 = _loc6_;
      }
