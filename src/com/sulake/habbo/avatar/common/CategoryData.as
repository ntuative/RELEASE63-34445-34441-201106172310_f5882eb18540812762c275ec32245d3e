package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2344:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_270)
         {
            for each(_loc2_ in this.var_270 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_240 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_939 >= 0 && this._parts.length > this.var_939)
         {
            _loc2_ = this._parts[this.var_939];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.method_7(this.var_240[param2],param2);
         this.var_240[param2] = param1;
      ...
      private function method_7(param1:int, param2:int) : void
      {
         var _loc3_:Array = this.getPalette(param2);
         if(!_loc3_)
         {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_270 || this.var_270.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_270[0] as Array;
         ...
         {
            _loc7_ = this.var_270[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_240[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_240[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_240[param1])
         {
            return null;
         }
         return _loc2_[this.var_240[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_270.length <= param1)
         {
            return null;
         }
         return this.var_270[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_939] as AvatarEditorGridPartItem;
      }
