package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_952:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_947 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc5_.colorTransform(_loc5_.rect,this.var_952.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_947.width,this.var_947.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_947,this.var_947.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
