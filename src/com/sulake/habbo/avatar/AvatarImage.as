package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1636:String = "Default";
      
      private static const const_1635:int = 2;
      
      private static const const_1637:String = AvatarSetType.const_40;
      ...
      protected var var_599:IAvatarDataContainer;
      
      protected var var_353:Array;
      
      protected var var_48:BitmapData;
      
      private var var_1116:IActiveActionData;
      ...
      protected var var_1397:Boolean = false;
      ...
      private var var_2844:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1637,const_1635);
         this.var_353 = new Array();
         this.var_1116 = new ActiveActionData(AvatarAction.const_411);
         this.var_1116.definition = this._structure.getActionDefinition(const_1636);
         this.resetActions();
      ...
      {
         param2 += this.var_2067;
         if(param2 < AvatarDirectionAngle.const_1344)
         {
            param2 = AvatarDirectionAngle.const_333 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_333)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_52 || param1 == AvatarSetType.const_40)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_697,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_295.length == 1 && this.var_101 == this.var_2073)
         {
            return this.var_101 + this.var_575 + this.var_697 % 4;
         }
         if(this.var_295.length == 2)
         {
            for each(_loc1_ in this.var_295)
            {
               ...
               {
                  return this.var_101 + this.var_575 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_697 % 11;
                  return this.var_101 + "_" + this.var_2073 + this.var_575 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2842 || param2 != this.var_2843 || param1 != this.var_2844)
         {
            this.var_2842 = param3;
            this.var_2843 = param2;
            this.var_2844 = param1;
            this.var_2066 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1397 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1397)
            {
               this.var_48.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_697);
            if(_loc9_ && _loc9_.image && _loc9_.method_2)
            {
               _loc10_ = _loc9_.image;
               _loc11_ = _loc9_.method_2.clone();
         ...
         {
            if(this.var_599.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_599.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_697);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
            ...
            case AvatarAction.const_388:
               switch(_loc3_)
               {
                  case AvatarAction.const_768:
                     if(this.var_101 == 0)
                     {
                        this.setDirection(AvatarSetType.const_40,4);
                     }
                     else
                     {
                        this.setDirection(AvatarSetType.const_40,2);
                     }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_353.push(new ActiveActionData(param1,param2,this.var_697));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_307 = this.var_1116;
         this.var_307.definition = this.var_1116.definition;
         this.resetBodyPartCache(this.var_1116);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_295)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_575 = "";
         this.var_295 = this._structure.sortActions(this.var_353);
         if(this.var_295 == null)
         {
            this.var_807 = new Array(0,0,0);
            if(this.var_1328 != "")
            {
               _loc1_ = true;
               this.var_1328 = "";
         ...
         {
            this.var_807 = this._structure.getCanvasOffsets(this.var_295,this._scale,this.var_101);
            for each(_loc4_ in this.var_295)
            {
               this.var_575 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_344)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1624 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1624 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1328 != this.var_575)
            {
               _loc1_ = true;
               this.var_1328 = this.var_575;
            }
         }
         this.var_1625 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_295)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1096 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_231 = this.var_231.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_2067 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_599 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_370 || _loc1_.actionType == AvatarAction.const_291 || _loc1_.actionType == AvatarAction.const_410)
               {
                  this.var_1096 = true;
               }
            }
