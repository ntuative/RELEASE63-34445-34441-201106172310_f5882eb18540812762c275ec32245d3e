package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2487 = parseInt(param1.@pattern);
         this.var_1043 = String(param1.@gender);
         this.var_1560 = Boolean(parseInt(param1.@colorable));
         this.var_2386 = String(param1.@localizationKey);
