package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_174:AvatarRenderManager;
      ...
      {
         if(param1 == null || this.var_540 == null)
         {
            return;
         }
         var _loc2_:int = this.var_540.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_540.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_540.length > 0)
         {
            _loc1_ = this.var_540.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1480.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_650.getValue(_loc6_) == null)
               {
                  ...
                  this.var_650.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_540.indexOf(param3) == -1)
                  {
                     this.var_540.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_650.getKeys())
         {
            _loc5_ = this.var_650.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
