package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1225:BitmapData = null;
      
      private var var_1224:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2546 = this._config.getKey("interstitial.enabled","false") == "TeleportErrorHandler";
         this.var_2548 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2547 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1863 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1863 > 0 && this.var_1862 >= this.var_1863)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1223;
         if(_loc1_ > this.var_2548)
         {
            ++this.var_1862;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1502 = _loc2_.imageUrl;
         this.var_2545 = _loc2_.clickUrl;
         this.var_1223 = getTimer();
         if(this.var_1502 != "")
         {
            _loc3_ = this.var_1502;
            ...
            {
               this.var_242 = new Timer(this.var_2547,1);
            ...
            this.var_242.start();
            _loc4_ = new URLRequest(this.var_1502);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_615,param1.bitmapData,this.var_2545));
            this.var_1223 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_580));
         }
      }
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_377 != null)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_629,this.var_377.roomId,this.var_377.roomCategory,_loc4_,_loc2_.assetName,this.var_377.clickURL,this.var_1225,this.var_1224));
            this.var_377 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1225 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1224 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_656.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_656.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_656.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_800,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_656.remove(_loc2_.assetName);
