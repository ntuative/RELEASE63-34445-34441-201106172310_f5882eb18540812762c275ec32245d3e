package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1605:int = HabboMusicPrioritiesEnum.const_122;
      ...
      private var var_565:IPlayListController = null;
      ...
      private var var_2784:int = -1;
      
      private var var_2785:int = -1;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_808.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_808.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_808)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_837,this.onJukeboxInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_281,this.onJukeboxDispose);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_960,this.onSoundMachineInit);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_987,this.onSoundMachineDispose);
         this.var_1293 = new Timer(1000);
         this.var_1293.start();
         this.var_1293.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_284)
         {
            this.var_334[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2005)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_449)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_125,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_837,this.onJukeboxInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_281,this.onJukeboxDispose);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_960,this.onSoundMachineInit);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_987,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_334[param1];
      ...
      {
         var _loc1_:int = this.var_334.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_334[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_284)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_687.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_291.length)
         {
            ...
            if(_loc3_.id != this.var_1581 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_334[_loc2_] != null)
            {
               _loc3_ = this.var_334[_loc2_];
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_854.indexOf(_loc6_.id) != -1)
               {
                  this.var_854.splice(this.var_854.indexOf(_loc6_.id),1);
                  if(this.var_854.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_284)
         {
            return false;
         }
         ...
         this.var_2005 = this.getSongRequestCountAtPriority(param1);
         this.var_1581 = param2;
         if(this._priorityPlaying <= const_1605)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2784 != param1.id || _loc3_ > this.var_2785 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2784 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_687.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_565 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_92,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_565 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
