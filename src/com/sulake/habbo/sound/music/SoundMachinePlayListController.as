package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_243 = param2;
         this.var_808 = [];
         this.var_808.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_808.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_808)
         {
         ...
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_769,this.onSoundMachinePlayEvent);
         this.var_92.addEventListener(RoomEngineSoundMachineEvent.const_983,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_92)
            {
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_769,this.onSoundMachinePlayEvent);
               this.var_92.removeEventListener(RoomEngineSoundMachineEvent.const_983,this.onSoundMachineStopEvent);
               this.var_92 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_428);
      ...
      public function stopPlaying() : void
      {
         this.var_428 = -1;
         this.var_606 = false;
         this.var_243.stop(HabboMusicPrioritiesEnum.const_122);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_243.playSong(param1,HabboMusicPrioritiesEnum.const_122,_loc3_,0,0,0))
         {
