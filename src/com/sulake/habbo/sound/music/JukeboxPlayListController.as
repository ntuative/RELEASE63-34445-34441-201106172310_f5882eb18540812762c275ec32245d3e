package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_808 = [];
         this.var_808.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_808.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_808.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_606 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_243.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_122,_loc3_.syncCount / 1000,0,1,1);
            this.var_428 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_1960 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_103,HabboMusicPrioritiesEnum.const_122,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_831.indexOf(_loc5_) < 0)
               {
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_166));
      }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_553[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_831.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_831.splice(_loc3_,1);
         }
         if(this.var_831.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_105));
