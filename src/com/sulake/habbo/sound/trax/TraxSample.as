package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1825:String = "sample_44khz";
      
      public static const const_1842:String = "sample_22khz";
      
      public static const const_1807:String = "sample_11khz";
      
      public static const const_1719:String = "sample_16bit";
      
      public static const const_1760:String = "sample_8bit";
      ...
      private static const const_196:int = 32767;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_184 * this.var_88;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1125)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1125);
            }
            ...
            {
               this.var_133[int(_loc11_ / this.var_184)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_133.length * this.var_184 * this.var_88;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_184 * this.var_88;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         if(this.var_88 == 1)
         {
            if(this.var_184 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_197) - const_196;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_197) - const_196;
               }
            }
         ...
         else if(this.var_88 >= 2)
         {
            ...
            if(this.var_184 == 2)
            {
               ...
               {
                  _loc8_ = this.var_133[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_197) - const_196);
                  _loc9_ = this.var_88;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_197) - const_196);
                  _loc9_ = this.var_88;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_88 == 1)
         {
            if(this.var_184 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_197) - const_196);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_197) - const_196);
               }
            }
            else if(this.var_184 == 4)
            {
         ...
         else if(this.var_88 >= 2)
         {
            ...
            if(this.var_184 == 2)
            {
               ...
               {
                  _loc7_ = this.var_133[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_197) - const_196);
                  _loc8_ = this.var_88;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_197) - const_196);
                  _loc8_ = this.var_88;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_693.indexOf(param1) == -1)
         {
            this.var_693.push(param1);
         }
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_693.indexOf(param1) != -1;
      }
   }
}
