package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1657:int = 60;
      
      private static const const_1658:int = 25165823;
      
      private static const const_1656:int = 16777215;
      ...
      private var var_1089:IHabboNotifications;
      
      private var var_942:Number = 1.0;
      ...
      private var var_1638:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_869,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1089)
         {
            this.var_1089.release(new IIDHabboNotifications());
            this.var_1089 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1090.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1162:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1777:
               ...
               case HabboSoundTypesEnum.const_1247:
                  ...
                  break;
               case HabboSoundTypesEnum.const_2009:
            ...
            this.var_1090.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_942;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_714.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc3_:TraxSequencer = this.method_4(param1,param2);
         if(!_loc3_.ready)
         {
            this.var_882 = _loc3_;
            this.var_883 = param1;
      ...
      {
         var _loc3_:TraxSequencer = this.method_4(param1,param2,false);
         if(!_loc3_.ready)
         {
            this.var_1340.add(param1,_loc3_);
         }
         return _loc3_;
      }
      
      private function method_4(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         var _loc4_:TraxData = new TraxData(param2);
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_297,events);
         _loc5_.volume = this.var_942;
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1089.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_173.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2897 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1089 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_173 == null || this._connection == null || this._roomEngine == null || this.var_243 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1808,this.var_883));
         this.var_883 = -1;
         this.var_882 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_942 * 100)));
         }
      }
      ...
      {
         this.var_942 = param1;
         this.var_243.updateVolume(this.var_942);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_714.getValue(param1) != null)
         {
            _loc2_ = this.var_714.remove(param1);
            if(this.var_297.getValue(_loc2_) == null)
            {
               this.var_1638.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1638,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1638,_loc2_,TraxSample.const_1825,TraxSample.const_1719);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1339.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1657 && this.var_1339.length > 0)
            {
               _loc3_ = this.var_1339.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_714.length == 0 && this.var_883 != -1)
            {
               this.var_882.ready = true;
               _loc4_ = this.var_883;
               this.var_883 = -1;
               this.var_882 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_869,_loc4_));
               if(this.var_2897)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_882 == null && this.var_1340.length > 0)
         {
            _loc1_ = this.var_1340.getKey(0);
            _loc2_ = this.var_1340.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_869,_loc1_));
               }
               else
               {
                  this.var_882 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1658)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1656 && _loc9_ < _loc2_.length)
            {
