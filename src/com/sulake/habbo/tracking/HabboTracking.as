package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1027:uint = 11;
      ...
      private var var_191:IHabboHelp;
      
      private var var_1425:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_267:PerformanceTracker = null;
      
      private var var_432:FramerateTracker = null;
      
      private var var_268:LatencyTracker = null;
      
      private var var_616:LagWarningLogger = null;
      
      private var var_433:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_267 = new PerformanceTracker();
         this.var_432 = new FramerateTracker();
         this.var_268 = new LatencyTracker();
         this.var_616 = new LagWarningLogger();
         this.var_433 = new ToolbarClickTracker(this);
         this.var_1425 = new Array(const_1027);
         var _loc4_:int = 0;
         while(_loc4_ < const_1027)
         {
            this.var_1425[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1788,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1725,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1797,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_937,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1389,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_363,this.onZoomToggle);
               }
            ...
            if(this.var_210)
            {
               if(!this.var_210.disposed)
               {
                  ...
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.const_619,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_191)
            {
               ...
               {
                  this.var_191.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_191.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_191.release(new IIDHabboHelp());
               this.var_191 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_193,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_341,this.onRoomAction);
               }
            ...
            {
               this.var_311.stop();
               this.var_311.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_311 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_173)
         {
            if(this.var_268 != null)
            {
               this.var_268.configuration = this.var_173;
            }
            if(this.var_267 != null)
            {
               this.var_267.configuration = this.var_173;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1909);
            if(this.var_173)
            {
               if(this.var_616 != null)
               {
                  this.var_616.configure(this.var_173);
               }
               if(this.var_432 != null)
               {
                  this.var_432.configure(this.var_173);
               }
               if(this.var_433 != null)
               {
                  this.var_433.configure(this.var_173);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_737,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_764,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_268 != null)
            {
               this.var_268.communication = this._communication;
               this.var_268.connection = param1;
            }
            if(this.var_616 != null)
            {
               this.var_616.connection = param1;
            }
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1978);
               break;
            case HabboCommunicationEvent.const_737:
               this.trackLoginStep(HabboLoginTrackingStep.const_1921,String(this._communication.port));
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_173)
            {
               if(this.var_173.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1425)
                  {
                  ...
                  if(this.var_267 != null)
                  {
                     _loc4_["null"] = this.var_267.flashVersion;
                     _loc4_["null"] = this.var_267.averageUpdateInterval;
                  }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1259,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_363,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.const_619,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_619:
      ...
      {
         this.var_191 = param2 as IHabboHelp;
         this.var_191.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_191.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1389,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_937,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_193,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_341,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_331 = param2 as IAdManager;
         this.var_331.events.addEventListener(AdEvent.const_629,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_193)
         {
            if(this.var_1716 < 1)
            {
               if(!this.var_311)
               {
                  this.var_311 = new Timer(60000,1);
                  this.var_311.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_311.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_341)
         {
            if(this.var_311)
            {
               this.var_311.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_432)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_432.frameRate),_loc2_);
                  ++this.var_1716;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_433)
         {
            this.var_433.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_433)
         {
            this.var_433.track(param1.type);
         }
      }
      ...
      {
         this.var_616.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_517 > -1 && _loc2_ < this.var_517)
         {
            ++this.var_1717;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1717);
         }
         if(this.var_517 > -1 && _loc2_ - this.var_517 > 15000)
         {
            ++this.var_1715;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1715);
         }
         this.var_517 = _loc2_;
         if(this.var_267 != null)
         {
            this.var_267.update(param1,this.var_517);
         }
         if(this.var_268 != null)
         {
            this.var_268.update(param1,this.var_517);
         }
         if(this.var_432 != null)
         {
            this.var_432.trackUpdate(param1,this,this.var_517);
         }
         if(this.var_616 != null)
         {
            this.var_616.update(this.var_517);
         }
      }
   }
}
