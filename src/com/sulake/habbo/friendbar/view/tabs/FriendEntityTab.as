package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1525:String = "entity_xml";
      
      private static const const_1528:String = "facebook_piece_xml";
      
      private static const const_1527:String = "controls_piece_xml";
      ...
      protected static const const_1392:String = "facebook";
      
      protected static const const_1393:String = "controls";
      
      protected static const const_312:String = "canvas";
      
      protected static const const_675:String = "name";
      
      protected static const const_1093:String = "btn_message";
      
      protected static const const_1019:String = "icon_message";
      
      protected static const const_1394:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1017:String = "label";
      
      protected static const const_502:String = "notification";
      
      private static const const_76:uint = 10338138;
      
      private static const const_1024:uint = 13891476;
      
      private static const const_1072:String = null;
      
      private static const const_691:String = "icon_tag_notify";
      
      private static const const_1526:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_466:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1392) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1393) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_502,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1528).content as XML) as IWindowContainer;
               _loc3_.name = const_1392;
               _loc6_ = _loc3_.getChildByName(const_675) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2176.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1527).content as XML) as IWindowContainer;
               _loc3_.name = const_1393;
               _loc8_ = _loc3_.getChildByName(const_1093);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1394);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_164)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(PIECES)).getListItemByName(const_458) as IWindowContainer;
            _loc1_.findChildByName(const_675).caption = this.var_164.name;
            var_2176.crop(_loc1_.getChildByName(const_675) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_312));
            _loc2_.bitmap = var_498.getAvatarFaceBitmap(this.var_164.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_466.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1525).content as XML) as IWindowContainer;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_466.indexOf(param1) == -1)
            {
               const_466.push(param1);
            }
         }
      }
            ...
            switch(param1.window.name)
            {
               ...
               case const_1019:
                  ...
                  if(var_348 && this.var_164)
                  {
                     ...
                     this.deselect(true);
                     if(param1.window.name == const_1019)
                     {
                        var_498.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1394:
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         {
            case FriendNotification.const_1182:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2195);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_691;
               break;
            case FriendNotification.const_1216:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2195);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_691;
               break;
            case FriendNotification.const_428:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1019;
