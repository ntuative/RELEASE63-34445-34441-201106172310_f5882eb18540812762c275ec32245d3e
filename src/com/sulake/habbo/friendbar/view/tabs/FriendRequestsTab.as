package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2012:String = "friendRequestsTabXML";
      ...
      protected static const const_457:String = "bubble";
      
      protected static const const_667:String = "request_entity_list";
      
      protected static const const_675:String = "name";
      
      protected static const const_2011:String = "badge_counter";
      
      protected static const const_2014:String = "button_accept_all";
      
      protected static const const_2010:String = "click_area_discard_all";
      
      protected static const const_1391:String = "button_close";
      
      protected static const const_2013:String = "button_accept";
      
      protected static const const_1016:String = "click_area_discard";
      
      protected static const const_1390:String = "text_discard";
      
      private static var var_1413:FriendRequestsTab;
      
      private static const const_76:uint = 4294625561;
      
      private static const const_1024:uint = 4294957414;
      
      private static const const_1405:uint = 4289431312;
      
      private static const const_1406:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1407:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1413 ? var_1413 : new FriendRequestsTab();
         _loc2_.var_165 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2011).caption = String(param1.length);
         return _loc2_;
      }
      ...
      override public function recycle() : void
      {
         ...
         if(!disposed)
         {
            if(!var_165)
            {
               if(_window)
               {
                  _loc1_ = _window.findChildByName(const_457) as IBubbleWindow;
                  if(_loc1_)
                  {
                     _loc2_ = _loc1_.content.getChildByName(const_667) as IItemListWindow;
                     if(_loc2_)
                     {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            if(_window)
            {
               _loc2_ = _window.findChildByName(const_457) as IBubbleWindow;
               if(_loc2_)
               {
                  _loc2_.visible = true;
                  if(!this.var_1700)
                  {
                     _loc3_ = _loc2_.content.getChildByName(const_667) as IItemListWindow;
                     if(_loc3_)
                     {
                        _loc7_ = 0;
                        _loc8_ = 0;
                        ...
                        {
                           _loc4_ = this.var_1135.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1405) : uint(const_1406);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_675).caption = _loc5_.name;
                           _loc6_ = _loc4_.getChildByName(const_312) as IBitmapWrapperWindow;
                           _loc9_ = var_498.getAvatarFaceBitmap(_loc5_.figure);
                           if(_loc9_)
                           {
      ...
      override public function deselect(param1:Boolean) : void
      {
         ...
         if(selected)
         {
            if(_window)
            {
               _loc2_ = _window.findChildByName(const_457);
               if(_loc2_)
               {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2012).content as XML) as IWindowContainer;
         var _loc2_:IBitmapWrapperWindow = IBitmapWrapperWindow(_loc1_.findChildByName(const_312));
         var _loc3_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_458));
         var _loc4_:IBubbleWindow = _loc1_.findChildByName(const_457) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         var _loc7_:IItemListWindow = _loc4_.content.getChildByName(const_667) as IItemListWindow;
         this.var_1135 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            param1.color = const_76;
            _loc3_ = IBitmapWrapperWindow(param1.findChildByName(const_312));
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1017)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == const_1016)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1390)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1016)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1390)).textColor = const_1407;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         var _loc3_:IBubbleWindow = _window.findChildByName(const_457) as IBubbleWindow;
         if(_loc3_)
         {
            _loc4_ = _loc3_.content.getChildByName(const_667) as IItemListWindow;
            if(_loc4_)
            {
               _loc6_ = 0;
