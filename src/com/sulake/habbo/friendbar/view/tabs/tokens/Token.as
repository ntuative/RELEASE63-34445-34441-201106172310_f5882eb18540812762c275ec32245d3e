package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2029:String = "title";
      ...
      protected var var_1405:FriendNotification;
      
      protected var var_1132:DropAnimation;
      ...
      {
         return this.var_1405.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1405.viewOnce;
      }
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_2029).caption = param1;
         this._window.findChildByName(const_1093).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1407.create("ICON_" + this.typeCode,WindowType.const_365,WindowStyle.const_100,WindowParam.const_31,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1407.create("BITMAP_" + this.typeCode,WindowType.const_433,WindowStyle.const_100,WindowParam.const_183,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
         ...
         if(param6)
         {
            this.var_1132 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
