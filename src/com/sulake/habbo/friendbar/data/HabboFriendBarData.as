package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_315:Boolean = false;
      
      private static const const_1078:Boolean = false;
      
      private static const const_693:String = "Navigation";
      
      private static const const_692:String = "Friend Bar";
      
      private static const const_1539:String = "go.friendbar";
      
      private static const const_1541:String = "chat_btn_click";
      
      private static const const_1543:String = "find_friends_btn_click";
      
      private static const const_1077:String = "Toolbar";
      
      private static const const_1075:String = "open";
      
      private static const const_1076:String = "close";
      
      private static const const_1540:String = "FRIENDLIST";
      
      private static const const_1542:String = "MESSENGER";
       
      
      private var var_991:IHabboConfigurationManager;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_991)
            {
               this.var_991.release(new IIDHabboConfigurationManager());
               this.var_991 = null;
            }
            if(this.var_93)
            {
            ...
            if(this.var_85)
            {
               ...
               {
                  this.var_85.events.removeEventListener(FriendRequestEvent.const_61,this.onFriendRequestEvent);
                  this.var_85.events.removeEventListener(FriendRequestEvent.const_227,this.onFriendRequestEvent);
               }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_692,const_1539));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_221)
         {
            ...
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_692,const_1541));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_693,const_692,const_1543));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_85)
         {
            if(!this.var_85.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1077,const_1540,!!this.var_85.isOpen() ? const_1075 : const_1076));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_221)
         {
            if(!this.var_221.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1077,const_1542,!!this.var_221.isOpen() ? const_1075 : const_1076));
               }
            }
         }
      }
      ...
      {
         this.var_991 = param2 as IHabboConfigurationManager;
         this.var_2581 = this.var_991.getBoolean("friendbar.notifications.enabled",false);
         this.var_1878 = this.var_991.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_85.events.addEventListener(FriendRequestEvent.const_61,this.onFriendRequestEvent);
         this.var_85.events.addEventListener(FriendRequestEvent.const_227,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_315)
            {
         ...
         {
            this.var_111 = !!const_315 ? this.sortByNameAndOnlineStatus(this.var_111) : this.sortByName(this.var_111);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_811));
            this.makeNotification(String(this.var_811),FriendNotification.const_428,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_811));
            this.makeNotification(String(this.var_811),FriendNotification.const_428,null,true,false);
         }
      }
