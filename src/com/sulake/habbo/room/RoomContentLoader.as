package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_846:String = "RCL_LOADER_READY";
      
      private static const const_386:String = "RCL_PUBLICROOM_";
      
      private static const const_2072:int = 0;
      ...
      private static const const_711:String = "wall_place_holder";
      
      private static const const_712:String = "pet_place_holder";
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2879 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2880 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_580.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_580.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_708.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_709.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_709.remove(_loc7_);
               this.var_709.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2878)
         {
            ...
            {
               this.var_1632.dispatchEvent(new Event(const_846));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_579 != null)
         {
            this.var_579.remove(param2);
            this.var_579.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_579 != null)
         {
            _loc2_ = this.var_579.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_476,const_711,const_712,const_710,TILE_CURSOR,const_1132];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_486.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_708.getValue(param1) as String;
      ...
      {
         var _loc3_:Map = this.var_1079[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_708.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_229 != null && this.var_229.hasWorldType(const_386 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_287 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_709.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_456,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_229 = this.var_1633.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_967,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2879.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1079.add(_loc6_,_loc3_);
         }
      }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_879.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_879.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_580.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_879.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_580.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_580.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_576.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_386 + param1) == RoomObjectCategoryEnum.const_81)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_229.getWorldHeightScale(const_386 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_229 != null)
         {
            return this.var_229.getWorldScale(const_386 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_486.remove(param1);
         this.var_486.add(param1,param2);
      }
   }
}
