package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1582:int = -1.0E9;
      ...
      {
         if(this.var_1053 != 0 || this.var_1054 != 0)
         {
            if(this.var_12 != null)
            {
               this.var_12.disposeRoom(this.var_1053,this.var_1054);
            }
         }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1053 != _loc3_.roomId || this.var_1054 != _loc3_.roomCategory)
         {
      ...
      private function addWallItem(param1:int, param2:int, param3:ItemMessageData) : void
      {
         ...
         {
            _loc5_ = _loc4_.method_10(param3.y,param3.z,param3.dir);
         }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_772);
         var _loc8_:int = 0;
               ...
               for each(_loc18_ in _loc9_.actions)
               {
                  switch(_loc18_.actionType)
                  {
                     case "flatctrl":
                        ...
                        break;
                     case "sign":
                        this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_412,int(_loc18_.actionParameter));
                        break;
                     case "gst":
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_274,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_605,_loc3_.danceStyle);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_241,_loc6_);
      }
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_319,_loc2_.itemType,_loc2_.itemName);
         }
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_293,_loc2_.itemType);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1340:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1322:
                     _loc9_ = "std";
               }
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_190,Math.ceil(_loc2_.text.length / 10));
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_12.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_650,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_397,_loc2_.gainedExperience);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1269,_loc3_.status);
         }
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_12.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_413,_loc2_.value);
         }
      }
   }
}
