package com.sulake.habbo.room.utils
{
   ...
   public class LegacyWallGeometry implements IDisposable
   {
      ...
      private static const const_1143:String = "l";
         ...
         if(param1 == 0 && param2 == 0)
         {
            ...
            if(param5 == DIRECTION_RIGHT)
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  {
                     if(this.getTileHeight(_loc7_,_loc6_) <= this.var_1109)
                     {
                        if(_loc6_ - 1 < param2)
                        {
                           param1 = _loc7_;
      ...
      public function method_10(param1:Number, param2:Number, param3:String) : IVector3d
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:* = 0;
         ...
         while(_loc4_ < this.var_283)
         {
            ...
            {
               if(this.getTileHeight(_loc4_,_loc5_) <= this.var_1109)
               {
                  _loc8_ = _loc4_ - 1;
                  _loc9_ = _loc5_;
               ...
               if(this.getTileHeight(_loc4_,_loc5_ + 1) <= this.var_1109)
               {
                  _loc8_ = _loc4_;
                  _loc9_ = _loc5_;
      ...
      public function method_6(param1:IVector3d, param2:Number) : String
      {
