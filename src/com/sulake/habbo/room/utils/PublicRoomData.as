package com.sulake.habbo.room.utils
{
   ...
   public class PublicRoomData
   {
      ...
      {
         var _loc2_:PublicRoomWorldData = this.var_1087.getValue(param1) as PublicRoomWorldData;
         if(_loc2_ != null)
         {
            return _loc2_.scale;
         }
