package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_686:String = "temporary_room";
      ...
      private static const const_1513:String = "tile_cursor";
      
      private static const const_1058:int = -3;
      
      private static const const_1512:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_382:String = "object_icon_sprite";
      
      private static const const_465:int = 15;
      ...
      private var var_803:IRoomObjectFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_803.release(new IIDRoomObjectFactory());
            this.var_803 = null;
         }
         if(this.var_576 != null)
         {
            this.var_576.release(new IIDRoomObjectVisualizationFactory());
            this.var_576 = null;
         }
         ...
         if(this.var_279 != null)
         {
            ...
            {
               _loc2_ = this.var_279.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_279 != null)
         {
            _loc4_ = this.var_279.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_279.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      {
         return this.getRoomCamera(this.var_84,this.var_83);
      }
      ...
      {
         this.var_1220 = false;
         if(this.var_543 && this.var_543.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_266:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_16.getSession(this.var_84,this.var_83);
         ...
         var _loc5_:int = this.var_543.indexOf(_loc4_);
         if(_loc5_ == -1)
         {
            this.var_543.push(_loc4_);
            this.var_1220 = true;
         }
      }
      ...
      private function removeBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = this.var_543.indexOf(_loc3_);
         if(_loc4_ > -1)
         {
            this.var_543.splice(_loc4_,1);
            this.var_1220 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_985 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc5_ = this.var_279.getWithIndex(_loc3_) as RoomInstanceData;
            _loc6_ = null;
            _loc7_ = 0;
            _loc8_ = 0;
            if(_loc5_ != null)
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_84 || _loc8_ != this.var_83 || !this.var_984)
                  {
         ...
         var _loc4_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_84,this.var_83,1);
         if(_loc4_ != null)
         {
            if(this.var_984)
            {
               _loc4_.screenOffsetX += this.var_1497;
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_914) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_734) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_803 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_576;
         }
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_445 != null)
            {
               this.var_445.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_846,this.onContentLoaderReady);
            this.var_15.initialize(events,this.var_145);
         }
         this.var_2544 = this.var_145.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_846)
         {
            this.var_2543 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_331.events.addEventListener(AdEvent.const_629,this.showRoomAd);
         this.var_331.events.addEventListener(AdEvent.const_800,this.onRoomAdImageLoaded);
         this.var_331.events.addEventListener(AdEvent.const_1227,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_370;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_70,this.onRoomSessionEvent);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_70:
               if(this.var_445)
               {
                  this.var_445.setCurrentRoom(param1.session.roomId,param1.session.roomCategory);
               }
               break;
            case RoomSessionEvent.const_85:
               if(this.var_445)
               {
                  this.var_445.resetCurrentRoom();
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_803 != null)
         {
            this.var_803.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_803 == null || this.var_576 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_145 == null || !this.var_2543)
         {
            return;
         }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1235,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_543,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1235);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_193,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_383,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1294,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_754,1,true);
            _loc12_ = parseInt(this.var_145.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1252,_loc12_,true);
            if(this.var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_383,const_687,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_754,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_772,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_914,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_760,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_734,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1368,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_743,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_230,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_886,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_221,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_514,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_299);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_821,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_862,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_821,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_862,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1329,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1150,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1059,const_1513,RoomObjectCategoryEnum.const_322);
         if(this.var_145.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1058,const_1512,RoomObjectCategoryEnum.const_322);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_383,RoomObjectCategoryEnum.const_81);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param4 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_743,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_221,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_886,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1369,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1316,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1268,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_708,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_279.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_341,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1163;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_772);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_821);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_862);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1329);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1150);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         var _loc9_:int = param3 - this.var_1498;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_984 = true;
               this.var_802 = false;
               this.var_2541 = this.var_1496;
               this.var_2542 = this.var_1498;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_984)
            {
               ...
               if(this.var_802)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_84,this.var_83);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_984)
            {
               if(!this.var_802)
               {
                  _loc8_ = param2 - this.var_2541;
                  _loc9_ = param3 - this.var_2542;
                  if(_loc8_ <= -const_465 || _loc8_ >= const_465 || _loc9_ <= -const_465 || _loc9_ >= const_465)
                  {
                     this.var_802 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_84,this.var_83,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_382);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_592,this.var_84,this.var_83,-1,RoomObjectCategoryEnum.const_149));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_383,const_687);
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_84,this.var_83);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_84,this.var_83,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_84,this.var_83,this.var_1495);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_382);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_382,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1496 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1498 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_84,this.var_83,this.var_1495);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_382);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_84,this.var_83,this.var_1495);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_382);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_84,this.var_83,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_73.modifyRoomObjectData(this.var_84,this.var_83,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_84,this.var_83,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_73.deleteWallItem(this.var_84,this.var_83,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_84,this.var_83);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_754) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_84,this.var_83,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_84,this.var_83);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IRoomObject = this.getRoomObject(this.var_84,this.var_83,param1,param2);
         if(_loc3_ != null)
         {
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1058,RoomObjectCategoryEnum.const_322);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1059,RoomObjectCategoryEnum.const_322);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc9_ != null && _loc9_.getModelController() != null && _loc5_)
         {
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_246,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_417,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_948,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1197,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1331,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_988,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_177,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_993));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_993,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc8_ != null && _loc8_.getModelController() != null)
         {
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_246,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_417,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1163,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_988,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_177,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1308) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1272);
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_177,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectVariableEnum.const_397:
               ...
               break;
            case RoomObjectVariableEnum.const_413:
               _loc8_ = new RoomObjectAvatarPlayerValueUpdateMessage(param5);
               break;
            case RoomObjectVariableEnum.const_412:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_427,this.var_84,this.var_83,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_84,this.var_83);
         }
      }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_221,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_514,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_542 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_686);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_686,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_801.reserveNumber();
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_793,int(param2));
               }
               break;
         ...
         {
            this.var_1221.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1186,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_801.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_84,this.var_83,const_383,RoomObjectCategoryEnum.const_81,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_686);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1186);
               ...
               this.var_801.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1221.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_954,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1264,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1196,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1244,RoomObjectVariableEnum.const_436,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         {
            this.var_331.loadRoomAdImage(param1,param2,param3,param4,param5,param6);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_800:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1386,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1227:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1226,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
