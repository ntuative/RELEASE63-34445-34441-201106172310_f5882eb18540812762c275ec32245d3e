package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_708:Number = 0.25;
      
      private static const const_1268:Number = 0.25;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_283 = param1;
         this._height = param2;
         this.var_482 = this.var_283;
         this.var_483 = -1;
         this.var_485 = this._height;
         this.var_484 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_137[param2] as Array;
            ...
            {
               if(param1 == this.var_482 || param1 == this.var_483)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_485;
                  while(_loc6_ < this.var_484)
                  {
               ...
               if(param2 == this.var_485 || param2 == this.var_484)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_482;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_137[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_704[_loc2_][_loc8_] = this.var_137[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_137);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_1109 = getFloorHeight(this.var_137);
         if(!param1)
         {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_272,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_403,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1268 * this.var_1438;
         var _loc9_:Number = const_708 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_272,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_272,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_272,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_272,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_137 == null || param1 == this.var_137)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_137.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_137[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_254,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_708 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_254,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_254,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_254,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_254,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_283}" height="{this._height}" wallHeight="{this.var_1629}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc5_ = <tileRow/>;
            _loc6_ = this.var_704[_loc2_];
            _loc7_ = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1387;
         }
         var _loc2_:RoomPlaneData = this.var_147[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
