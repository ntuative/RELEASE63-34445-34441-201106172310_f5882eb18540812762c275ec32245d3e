package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1778:String = "cone";
      
      public static const const_1712:String = "plane";
      
      public static const const_1956:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_1000 = 0;
         this.var_1042 = false;
         this.init(0,0,0,this._direction,this.var_2619,this.var_999,this.var_2616,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1245.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1042 = true;
         if(this.var_1000 < this.var_1521)
         {
            if(this.age > 1)
            {
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1245.length);
         return this.var_1245[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1000 < this.var_1521)
         {
            if(this.age % this.var_2617 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1000 < this.var_1521)
         {
            ...
            this.y = (2 - this.var_281) * this.y - (1 - this.var_281) * this.lastY + this.var_1896 * this.var_999 * this.var_999;
         ...
         for each(_loc2_ in this.var_382)
         {
            ...
            _loc2_.y = (2 - this.var_281) * _loc2_.y - (1 - this.var_281) * _loc2_.lastY + this.var_1896 * this.var_999 * this.var_999;
