package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1455:String = "branded_image";
      
      private static const const_1456:int = 0;
      
      private static const const_1457:int = 1;
      
      private static const const_1458:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1674 = _loc4_.getNumber(RoomObjectVariableEnum.const_578);
                  this.var_1675 = _loc4_.getNumber(RoomObjectVariableEnum.const_649);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_583);
               }
            }
         }
         if(!this.var_1387)
         {
            this.var_1387 = this.checkIfImageReady();
            if(this.var_1387)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_342);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_492);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1455)
         {
