package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_761[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_761[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_761.length == 2)
            {
               return this.var_761[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_761.length == 2)
            {
               return this.var_761[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1165[param2];
         var _loc4_:int = this.var_1164[param2];
         var _loc5_:int = this.var_1162[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1165.push(Math.random() * _loc2_ * 1.5);
         this.var_1165.push(Math.random() * _loc2_ * 1.5);
         this.var_1164 = new Array();
         this.var_1164.push(1);
         this.var_1164.push(-1);
         this.var_1162 = new Array();
         this.var_1162.push(const_1450);
         this.var_1162.push(const_1451);
