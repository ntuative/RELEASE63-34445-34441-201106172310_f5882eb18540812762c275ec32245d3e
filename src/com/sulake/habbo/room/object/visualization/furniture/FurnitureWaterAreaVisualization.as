package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1479:String = "shore";
       
      
      private var var_1840:Boolean = true;
      ...
      {
         if(this.var_2485 == param1 && this.var_2486 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1479)
            {
               this.var_1839 = _loc2_;
               this.var_2485 = param1;
               this.var_2486 = direction;
               return this.var_1839;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_541 == 0 || this.var_652 == 0)
         {
            ...
            this.var_541 = _loc2_.getNumber(RoomObjectVariableEnum.const_327);
            this.var_652 = _loc2_.getNumber(RoomObjectVariableEnum.const_432);
         }
         this.var_444 = [];
         this.var_651 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_541 * 2 + this.var_652 * 2)
         {
            this.var_444.push(false);
            this.var_651.push(ShoreMaskCreatorUtility.const_84);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_444,this.var_651,assetCollection);
      }
