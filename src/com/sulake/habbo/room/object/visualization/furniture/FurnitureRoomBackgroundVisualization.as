   ...
   public class FurnitureRoomBackgroundVisualization extends FurnitureRoomBrandingVisualization
   {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_804 != null)
         {
            ...
            _loc5_ = this.var_804[_loc4_];
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetX(param2,0) + var_1674;
            }
         }
         return super.getSpriteXOffset(param1,param2,param3) + var_1674;
      }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_804 != null)
         {
            ...
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetY(param2,0) + var_1675;
            }
         }
         return super.getSpriteYOffset(param1,param2,param3) + var_1675;
      }
