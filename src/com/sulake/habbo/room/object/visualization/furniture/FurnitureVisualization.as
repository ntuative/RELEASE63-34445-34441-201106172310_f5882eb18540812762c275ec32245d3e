package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2016:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2480:Number = NaN;
      ...
      private var var_2479:Number = 0.0;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_678 != spriteCount)
         {
            createSprites(this.var_678);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2404;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_509 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2480)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2483 = _loc3_.getNumber(RoomObjectVariableEnum.const_257);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_334));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_2404 = this.var_1206 != null;
            this.var_2481 = _loc3_.getNumber(RoomObjectVariableEnum.const_728);
      ...
      {
         if(this.var_2482 != param2 || this.var_2479 != param1)
         {
            this.var_975 = [];
            this.var_974 = [];
            this.var_795 = [];
            ...
            this.var_2484 = this.getSize(param1);
      ...
      {
         this.var_678 = param1;
         this.var_1483 = this.var_678 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_975[param2];
         var _loc4_:Boolean = this.var_974[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2484;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1483)
            {
            ...
            this.var_975[param2] = _loc3_;
            this.var_974[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_795[param3] != null)
         {
            return this.var_795[param3];
         }
         if(this._data == null)
         {
            return "";
         ...
         this.var_795[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         if(this.var_788[param3] != null && !this.var_1837)
         {
      ...
      {
         if(this.var_790[param2] != null)
         {
            return this.var_790[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_790[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_792[param3] != null)
         {
            return this.var_792[param3];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2481 * (param1 / 2));
      }
      
      protected function getSpriteMouseCapture(param1:int, param2:int, param3:int) : Boolean
      {
         if(this.var_793[param3] != null)
         {
            return this.var_793[param3];
         }
         if(this._data == null)
         {
            return true;
      ...
      {
         if(this.var_794[param3] != null)
         {
            return this.var_794[param3];
         }
         if(this._data == null)
         {
