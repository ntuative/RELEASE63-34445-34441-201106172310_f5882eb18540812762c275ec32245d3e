package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1639:String = "head";
      
      private static const const_706:int = 1;
      
      private static const const_1128:int = 1000;
      
      private static const const_1641:String = "pet_experience_bubble_png";
      
      private static const const_1640:int = 0;
      
      private static const const_1638:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1641) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2859)
            {
               this.var_2859 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_279);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_142);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_279);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_142);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1819 = _loc3_.getNumber(RoomObjectVariableEnum.const_241) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_211);
            if(!isNaN(_loc8_))
            {
               this.var_2073 = _loc8_;
            }
            else
            {
               this.var_2073 = direction;
            }
            this.var_1465 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2426 = _loc3_.getNumber(RoomObjectVariableEnum.const_397);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_793);
            if(_loc9_ != this.var_2072)
            {
               this.var_2072 = _loc9_;
               this.var_2858 = this.var_2072.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_402 != null)
         {
            ...
            if(this.var_1465 > 0)
            {
               _loc2_ = param1 - this.var_1465;
               if(_loc2_ < const_1128)
               {
                  this.var_402.alpha = int(Math.sin(_loc2_ / const_1128 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_276)
         {
            ...
            this.setAnimationForIndex(const_1640,_loc3_);
         }
         if(param2 != this.var_1464)
         {
            this.var_1464 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_102,param2);
            this.setAnimationForIndex(const_1638,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_706;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2858);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_706)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_706))
            {
               if(param2 >= FurnitureVisualizationData.const_539.length)
               {
                  return null;
               }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2073);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1639)
            {
               this.var_1075[param1] = true;
            }
            else
            {
               this.var_1075[param1] = false;
            }
         }
         return this.var_1075[param1];
      }
   }
}
