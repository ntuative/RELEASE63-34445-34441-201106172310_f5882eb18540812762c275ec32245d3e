package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_765 = param1.@defaultPosture;
         }
         else
         {
            this.var_765 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_636.add(_loc6_,_loc7_);
         ...
         if(this.var_636.getValue(this.var_765) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_766.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_636.getValue(param1) == null)
         {
            param1 = this.var_765;
         }
         return int(this.var_636.getValue(param1));
      }
      
      public function getAnimationForGesture(param1:String) : int
      {
         if(this.var_766.getValue(param1) == null)
         {
            return const_758;
         }
         return int(this.var_766.getValue(param1));
      }
      
      public function getPostureForAnimation(param1:int) : String
      {
         if(param1 >= 0 && param1 < this.var_636.length)
         {
            return this.var_636.getKey(param1);
         }
         return this.var_765;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_766.length)
         {
            return this.var_766.getKey(param1);
         }
         return null;
      }
      ...
      {
         return this.var_636.length;
      }
      
      public function getGestureCount() : int
      {
         return this.var_766.length;
      }
   }
}
