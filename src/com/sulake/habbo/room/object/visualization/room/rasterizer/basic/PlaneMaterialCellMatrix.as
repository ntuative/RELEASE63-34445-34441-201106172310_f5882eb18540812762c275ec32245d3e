package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_751:int = 6;
      
      public static const const_1770:int = const_408;
      ...
      private var var_2257:Number = -1.0;
      
      private var var_2256:Number = 1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_33 != null)
            {
               if(this.var_33.width == param2 && this.var_33.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_604,param6,param7);
                     return param1;
                  }
                  return this.var_33;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_33.width,this.var_604);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_33.height - this.var_604,this.var_33.width,this.var_604);
         }
