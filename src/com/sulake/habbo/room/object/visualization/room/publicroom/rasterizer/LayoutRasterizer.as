package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_902:IGraphicAssetCollection;
      
      private var var_1971:XMLList;
      
      private var _offsetX:int;
      
      private var var_1176:int;
      
      private var var_2447:Vector3d;
      ...
      private var var_969:Boolean = true;
      ...
      private var var_1473:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_970)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1473 = this.var_46.getValue(this.var_970);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2447 = new Vector3d(-0.5,0.5,0);
         this.var_969 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2447);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_970);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1809 = RoomObjectVariableEnum.const_1264;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1809 = RoomObjectVariableEnum.const_1196;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1194 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1194 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_970);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2446 && param3 == this.var_2448)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1194 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1194 + this._adImgIndex);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_489;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1473.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_902.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_442.indexOf(_loc10_) >= 0 && this.var_969)
            {
               param1 = this.var_442.indexOf(_loc10_);
               if(this.var_645[param1] != "")
               {
                  _loc9_ = this.var_902.getAsset(this.var_645[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
