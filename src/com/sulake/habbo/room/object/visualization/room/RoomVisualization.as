package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1714:int = 16777215;
      
      public static const const_1922:int = 13421772;
      
      private static const const_1040:int = 16777215;
      
      private static const const_1037:int = 13421772;
      
      private static const const_1038:int = 10066329;
      
      private static const const_1039:int = 10066329;
      
      public static const const_1810:int = 16777215;
      
      public static const const_1929:int = 13421772;
      
      public static const const_1781:int = 10066329;
      ...
      private var var_751:Rectangle = null;
      
      private var var_525:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1438:Number = NaN;
      
      private var var_1738:String = null;
      ...
      private var var_2335:int = 255;
      
      private var var_1736:Boolean = true;
      
      private var var_1149:int = 0;
      
      private var var_1889:int = -1000;
      
      private const const_2304:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_525 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_751 = super.boundingRectangle;
         }
         return new Rectangle(this.var_751.x,this.var_751.y,this.var_751.width,this.var_751.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               ...
               else if(_loc3_.type == RoomPlane.const_113)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1438;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1177);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1368);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_403)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1810;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1929;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1857)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_403)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1889 + this.const_2304 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_363.length)
            {
               _loc11_ = this.var_624[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_363[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1736)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2335 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2339 / 255);
         ...
         var_166 = _loc7_.getUpdateID();
         this.var_1889 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1737)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1509 || _loc3_.y != this.var_2336 || _loc3_.z != this.var_2337 || param1.scale != this.var_1735))
            {
               this.var_1509 = _loc3_.x;
               this.var_2336 = _loc3_.y;
               this.var_2337 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1246);
            if(_loc3_ != this.var_1738)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1738 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_875));
            if(_loc4_ != this.var_1150)
            {
               this.var_1150 = _loc4_;
               this.var_2335 = this.var_1150 & 255;
               this.var_2339 = this.var_1150 >> 8 & 255;
               this.var_2338 = this.var_1150 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1381));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_221);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_864));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_944));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_774));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_166 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1210);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1370);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1438))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_147.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_113 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_113)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1149;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_525.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_525.maskCount)
         {
            _loc10_ = this.var_525.getMaskType(_loc8_);
            _loc11_ = this.var_525.getMaskLocation(_loc8_);
            _loc12_ = this.var_525.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_299)
                              {
