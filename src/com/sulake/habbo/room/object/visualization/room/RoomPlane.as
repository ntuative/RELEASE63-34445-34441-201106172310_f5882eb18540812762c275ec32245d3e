package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1102:IPlaneRasterizer = null;
      
      private var var_839:PlaneMaskManager = null;
      ...
      private var var_493:PlaneBitmapData = null;
      ...
      private var var_892:Boolean = true;
      ...
      {
         return this._isVisible && this.var_892;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_220 != null)
         {
            ...
            {
               _loc2_ = this.var_220.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_716);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_220.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_220 != null)
         {
            ...
            {
               _loc3_ = this.var_220.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1102.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_493;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_220.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_892 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_412))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1102 != null)
            {
               _loc3_ = this.var_1102.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2120,this.var_2932,this.var_2931,this.var_2934,this.var_2930,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1737 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_892)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1457.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1457[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1231);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_176.z - originZ,this.var_127.z - originZ,this.var_97.z - originZ,this.var_126.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2569 = relativeDepth;
            this._isVisible = true;
            this.var_1737 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2933);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1103)
         {
            ...
            {
               _loc4_ = this.var_302[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1103)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_411.length)
            {
               _loc5_ = this.var_411[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_302.length == this.var_1104.length)
         {
            while(_loc1_ < this.var_302.length)
            {
               _loc4_ = this.var_302[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1104.length)
                  {
                     _loc7_ = this.var_1104[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_411.length > this.var_1647.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1103 || this.var_302.length == 0 && this.var_411.length == 0 && !this.var_412 || this.var_839 == null)
         {
            return;
         }
         ...
         if(this.var_412)
         {
            ...
            while(_loc5_ < this.var_302.length)
            {
               _loc3_ = this.var_302[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc3_.leftSideLoc / this.var_324.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc3_.rightSideLoc / this.var_323.length;
                  _loc12_ = _loc3_.type;
                  this.var_839.updateMask(this.var_80,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1104.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_411.length)
            {
               _loc4_ = this.var_411[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc4_.leftSideLoc / this.var_324.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc4_.rightSideLoc / this.var_323.length;
                  _loc13_ = this.var_80.width * _loc4_.leftSideLength / this.var_324.length;
                  _loc14_ = this.var_80.height * _loc4_.rightSideLength / this.var_323.length;
                  this.var_80.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1647.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_412 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_255 != null && (this.var_255.width != param1.width || this.var_255.height != param1.height))
         {
            this.var_255.dispose();
            this.var_255 = null;
         }
         if(this.var_255 == null)
         {
            this.var_255 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_255.copyChannel(param1,param1.rect,const_716,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_255.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_255,this.var_255.rect,const_716,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
