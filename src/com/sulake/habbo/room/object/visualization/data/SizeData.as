package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1254:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_821 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_285 != null)
         {
            ...
            {
               _loc2_ = this.var_285.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_821,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_285.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_821);
            this.defineDirection(_loc3_,_loc8_);
            this.var_285.add(String(_loc7_),_loc3_);
            this.var_1921 = -1;
            this.var_1254 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1304);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1300);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_285.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_285.length)
         {
            _loc6_ = int(this.var_285.getKey(_loc5_)) * this.var_1536;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_285.getKey(_loc4_));
         }
         return const_1917;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_285.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_821;
         }
