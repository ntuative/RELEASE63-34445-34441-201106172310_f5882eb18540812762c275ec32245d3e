   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_245.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_457 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_1949;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1950)
         {
            _loc6_ = param2 / this.var_457;
            param2 %= this.var_457;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_457 == 1)
            {
               param2 = this.var_457 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc13_ = this.var_1949 * _loc12_;
            if(param5)
            {
               _loc13_ = 0;
            }
            _loc14_ = false;
            if(!this.var_1950 && !param2.isRandom)
            {
