package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_2323:String = "TYPE_INJECTED";
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_146,RoomObjectFurnitureActionEvent.const_635];
         ...
         if(_loc5_ == this.const_2323)
         {
            if(param1.type == MouseEvent.MOUSE_UP)
            {
               if(eventDispatcher != null)
               {
                  ...
                  _loc9_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_146,_loc7_,_loc8_);
