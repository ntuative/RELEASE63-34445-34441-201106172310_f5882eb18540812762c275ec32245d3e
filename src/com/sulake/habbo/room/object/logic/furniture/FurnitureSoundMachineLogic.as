package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_598,RoomObjectFurnitureActionEvent.const_547,RoomObjectFurnitureActionEvent.const_483,RoomObjectFurnitureActionEvent.const_486];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2359)
         {
            this.var_2359 = _loc3_;
            if(_loc3_ == 1)
            {
