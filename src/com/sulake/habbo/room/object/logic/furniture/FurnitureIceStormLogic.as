package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2876:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_2080 = _loc2_;
            this.var_2876 = param1.extra;
            this.var_1333 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1333 > 0 && param1 >= this.var_1333)
         {
            this.var_1333 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2080,String(this.var_2080),this.var_2876);
