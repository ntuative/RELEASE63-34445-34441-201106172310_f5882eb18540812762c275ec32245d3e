package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private var var_652:Number = 0.0;
      ...
      private var var_1879:Number = 0.0;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_367,RoomObjectRoomAdEvent.const_354,RoomObjectRoomAdEvent.const_577,RoomObjectStateChangeEvent.const_67,RoomObjectMouseEvent.const_151,RoomObjectRoomAdEvent.const_220,RoomObjectMouseEvent.const_493];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         this.var_2589 = this.var_541 / 2;
         this.var_2590 = this.var_652 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_1879 = Number(_loc3_);
         }
         else
         {
            this.var_1879 = this.var_1511 / 2;
         }
         ...
         this.var_285.sort(Array.NUMERIC);
         if(object == null || object.getModelController() == null)
         {
            return;
         }
         object.getModelController().setNumber(RoomObjectVariableEnum.const_327,this.var_541,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_432,this.var_652,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_612,this.var_1511,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1790,this.var_2589,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1733,this.var_2590,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_724,this.var_1879,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_945,this.var_285,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_334,1);
      }
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_577,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_956,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1173,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1880 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_380 = 1;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_380 > 0)
         {
            this.var_992.x = 0;
            this.var_992.y = 0;
            if(this.var_380 <= const_467 / 2)
            {
               this.var_992.z = const_1079 * this.var_380;
            }
            else if(this.var_380 <= const_467)
            {
               if(this.var_1232)
               {
               ...
               this.var_992.z = const_1079 * (const_467 - this.var_380);
            }
            return this.var_992;
         }
         return null;
