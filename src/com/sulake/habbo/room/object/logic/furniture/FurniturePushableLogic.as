package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1117:int = 0;
      
      private static const const_2063:int = 1;
      
      private static const const_1116:int = 10;
       
      
      private var var_2011:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_1013;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_1013 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_2011.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_2011).length == 0)
            {
               if(object.getState(0) != const_1117)
               {
                  object.setState(const_1117,0);
               }
            }
         }
      }
