package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1503:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_527,RoomObjectMouseEvent.const_151];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1177,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_875,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_864,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_944,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1227)
         {
            ...
            if(_loc2_ - this.var_1227 >= this.var_1868)
            {
               _loc3_ = this.var_1228;
               _loc4_ = this.var_1869;
               this.var_1227 = 0;
            }
            else
            {
               _loc7_ = this.var_1503 >> 16 & 255;
               _loc8_ = this.var_1503 >> 8 & 255;
               _loc9_ = this.var_1503 & 255;
               _loc10_ = this.var_1228 >> 16 & 255;
               _loc11_ = this.var_1228 >> 8 & 255;
               _loc12_ = this.var_1228 & 255;
               _loc13_ = (_loc2_ - this.var_1227) / this.var_1868;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1867 + (this.var_1869 - this.var_1867) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_875,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_743:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_886:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_514:
               ...
               this.var_525.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_994:
               _loc4_ = this.var_525.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_525.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1246,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1316:
               param2.setNumber(RoomObjectVariableEnum.const_864,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1369:
               param2.setNumber(RoomObjectVariableEnum.const_944,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_708:
               param2.setNumber(RoomObjectVariableEnum.const_1210,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1268:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1381,int(param1.bgOnly));
         this.var_1503 = this._color;
         this.var_1867 = this.var_1853;
         this.var_1228 = _loc3_;
         this.var_1869 = _loc4_;
         this.var_1227 = getTimer();
         this.var_1868 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_565,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1731,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1895,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1945,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_565,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_272 || _loc12_ == RoomPlaneData.const_403)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
