package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1345:Function;
      
      private var var_1347:Function;
      
      private var var_888:IAssetLibrary;
      
      private var var_1346:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_888.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_888.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_888.loadAssetFromFile("hotel_view_banner_" + this.var_1346,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_764));
            }
