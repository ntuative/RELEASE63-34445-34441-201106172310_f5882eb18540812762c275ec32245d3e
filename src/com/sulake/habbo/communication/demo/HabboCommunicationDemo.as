package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_511:IKeyExchange;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_603 = param1;
            this.var_62.initConnection(HabboConnectionType.const_285);
         }
      }
      ...
      {
         if(this.var_62 && this.var_145 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_603 = this.var_145.getKey("sso.ticket",null);
         this.var_1690 = this.var_145.getKey("flash.client.url","");
         this.var_2249 = this.var_145.getKey("external.variables.txt","");
         if(this.var_236 == null)
         {
            this.var_236 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_515,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_2005);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_62.mode = HabboConnectionType.const_1167;
            }
         }
         this.var_62.initConnection(HabboConnectionType.const_285);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_737);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2248 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_62.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_236.loadBannerImage(_loc7_ + "?token=" + this.var_1411,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1167:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1847:
               this.var_920 = this.generateRandomHexString(30);
               this.var_511 = new DiffieHellman(new BigInteger(this.var_145.getKey("connection.development.prime"),16),new BigInteger(this.var_145.getKey("connection.development.generator"),16));
               this.var_511.init(this.var_920);
               _loc8_ = this.var_511.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_511.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_511.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2248);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1690,this.var_2249));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2033,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2250)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1411);
         ...
         this.var_511 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_511.init(_loc14_);
            _loc15_ = this.var_511.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_920 = _loc14_;
            }
