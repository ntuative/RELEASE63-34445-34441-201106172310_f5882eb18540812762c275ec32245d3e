package com.sulake.habbo.communication.messages.outgoing.handshake
{
   ...
   class RSAKey
   {
      ...
      public var var_2197:BigInteger;
      
      public var var_2182:BigInteger;
      ...
      function RSAKey(param1:BigInteger, param2:int, param3:BigInteger = null, param4:BigInteger = null, param5:BigInteger = null, param6:BigInteger = null, param7:BigInteger = null, param8:BigInteger = null)
      {
         ...
         this.q = param5;
         this.dmp1 = param6;
         this.var_2197 = param7;
         this.var_2182 = param8;
         this.var_2999 = this.n != null && this.e != 0;
         this.var_3054 = this.var_2999 && this.d != null;
      }
      ...
      private function doPrivate2(param1:BigInteger) : BigInteger
      {
         ...
         var _loc3_:BigInteger = param1.mod(this.q).modPow(this.var_2197,this.q);
         while(_loc2_.compareTo(_loc3_) < 0)
         {
            _loc2_ = _loc2_.add(this.p);
         }
         return _loc2_.subtract(_loc3_).multiply(this.var_2182).mod(this.p).multiply(this.q).add(_loc3_);
      }
