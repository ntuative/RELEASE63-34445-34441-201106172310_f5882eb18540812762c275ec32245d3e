package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1257:IRoomWidgetFactory;
      ...
      private var var_1016:IHabboModeration;
      ...
      private var var_1256:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1538 = RoomDesktop.const_532;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1016.release(new IIDHabboModeration());
            this.var_1016 = null;
         }
         ...
         if(this.var_1256)
         {
            this.var_1256.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1256 = null;
         }
         this.var_1626 = null;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_331.events.addEventListener(InterstitialEvent.const_580,this.interstitialCompleteEventHandler);
            this.var_331.events.addEventListener(InterstitialEvent.const_615,this.adEventHandler);
            this.var_331.events.addEventListener(AdEvent.const_629,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1016 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1016);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_304,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_210,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_617,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.include,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_61,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_338,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_509,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_585,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_621,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_636,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_747,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1362,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1194,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_239,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_280,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_822,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_933,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_204,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_980,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_992,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_533,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_162,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_168,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_501,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDanceEvent.const_140,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_70:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_835);
               break;
            case RoomSessionEvent.const_85:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_779);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_933:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_980:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_992:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2656);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1256 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_193,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_341,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_638,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_543,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_923,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_592,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_281,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_543 || param1.type == RoomEngineEvent.const_638)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_193:
               _loc5_ = false;
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_587);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_656);
               ...
               if(this.var_1538 != RoomDesktop.const_532)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_378,this.var_1538);
               }
               if(this.var_331 != null)
               {
                  this.var_331.showRoomAd(param1.roomId,param1.roomCategory);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_627);
               _loc3_.createWidget(RoomWidgetEnum.const_590);
               break;
            case RoomEngineEvent.const_341:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.moderation = this.var_1016;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1256;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2656 = param1.roomCategory;
         }
         else
         {
            this.var_1539 = false;
