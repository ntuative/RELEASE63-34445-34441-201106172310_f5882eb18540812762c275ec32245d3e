package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_2490:Boolean = true;
      
      private const const_1051:int = 5;
      
      private const const_2313:int = 3;
      
      private const const_1485:int = 11184810;
      
      private const const_1484:int = 16777215;
      
      private const const_2311:int = 2000;
      
      private const const_2310:int = 50;
      
      private const const_2312:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_964 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2490 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1051;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1485;
            }
            else
            {
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1051,this.const_2310);
         _loc5_.height = Math.max(_loc5_.height,this.const_2312);
         _loc3_.height = _loc5_.height + this.const_2313;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_326,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_326,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_964.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2491 > this.const_2311 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2491 = _loc6_;
               _loc3_.textColor = this.const_1484;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1485;
         }
      }
