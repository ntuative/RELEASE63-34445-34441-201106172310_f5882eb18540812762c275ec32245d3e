package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "GetPublicSpaceCastLibsMessageComposer":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1171 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_614 && param1.isRoomOwner)
         {
         ...
         this.showButton("GetPublicSpaceCastLibsMessageComposer",_loc6_);
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_179,this.adElementKeyEventProc);
                  }
