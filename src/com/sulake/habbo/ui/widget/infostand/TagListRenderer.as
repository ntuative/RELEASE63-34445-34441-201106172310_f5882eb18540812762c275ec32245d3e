package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2307:int = 5;
      
      private const const_2308:int = 5;
      ...
      private var var_1177:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1176 = 0;
         this.var_1177 = param2.rectangle.clone();
         this.var_1177.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1177.width)
         {
            return false;
         }
         if(this.var_1176 + param1.height > this.var_1177.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1177.width)
         {
            this._offsetX = 0;
            this.var_1176 += param1.height + this.const_2308;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1176);
         this._offsetX += param1.width + this.const_2307;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1463 != null && this.var_1463.indexOf(param1) != -1)
         {
