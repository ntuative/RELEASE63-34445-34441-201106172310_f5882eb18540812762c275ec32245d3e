package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1447:int = 152;
      
      private static const const_1441:int = 16;
      
      private static const const_674:int = 4;
      
      private static const const_1445:uint = 14342874;
      
      private static const const_1444:uint = 3815994;
      
      private static const const_1434:uint = 2085362;
      
      private static const const_1435:uint = 39616;
      
      private static const const_1436:uint = 10513106;
      
      private static const const_1438:uint = 8734654;
      
      private static const const_1439:uint = 9094430;
      
      private static const const_1437:uint = 6200576;
      
      private static const const_1446:String = "happiness";
      
      private static const const_1440:String = "experience";
      
      private static const const_1443:String = "energy";
      
      private static const const_1442:int = 250;
      
      private static const const_1031:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1446,param1.nutrition,param1.nutritionMax,const_1435,const_1434);
         this.updateStateElement(const_1440,param1.experience,param1.experienceMax,const_1438,const_1436);
         this.updateStateElement(const_1443,param1.energy,param1.energyMax,const_1437,const_1439);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1447,const_1441,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1445);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1444);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_674,_loc7_.width - 2,_loc7_.height - 2 - const_674);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_674);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_212 && this.var_212.getPetId() == this.var_589)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1840,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1031 + const_1032;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1032;
            }
         }
         this.var_107.height = _loc4_ + const_1031;
         this.updateWindow();
      }
   }
}
