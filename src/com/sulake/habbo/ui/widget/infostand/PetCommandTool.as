package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_2343:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1374 = new Map();
         this.var_419 = new Timer(this.const_2343);
         this.var_419.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1374.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1374.getValue(this.var_589) as CommandConfiguration;
      ...
      {
         this.var_1374.remove(param1);
         this.var_1374.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_848,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_44.context.getDesktopWindow().addEventListener(WindowEvent.const_42,this.onWindowDesktopResized);
         this.var_44.procedure = this.onCommandWindowProcedure;
         this.var_44.position = const_1629;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_496 == null)
         {
            ...
            this.var_496 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_496 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_496.x = 200;
            this.var_496.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_292,this.var_589));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_541,this.var_589,this.var_2146 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_541,this.var_589,this.var_2146 + " " + _loc5_);
