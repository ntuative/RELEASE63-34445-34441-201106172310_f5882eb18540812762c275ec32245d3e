package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3021:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3021 = param1.root.assets;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_72)
         {
            this.var_72.release(new IIDHabboLocalizationManager());
            this.var_72 = null;
         }
         if(this.var_145)
         {
      ...
      {
         this.var_72 = param2 as IHabboLocalizationManager;
      }
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_406:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_72,this.var_145,this.var_2334++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_336:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_72,this.var_145,this);
               break;
            case RoomWidgetEnum.const_613:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_72,this.var_145,this._catalog);
               break;
            case RoomWidgetEnum.const_548:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_72,events,this.var_145);
               break;
            case RoomWidgetEnum.const_785:
               _loc3_ = new PlaceholderWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_633:
               _loc3_ = new CreditFurniWidget(param2,this._windowManager,assets,this.var_72);
               break;
            ...
            case RoomWidgetEnum.const_525:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_72,this.var_145,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_665:
               _loc3_ = new PetPackageFurniWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_132:
               _loc3_ = new DoorbellWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_607:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_72,this.var_145);
               break;
            case RoomWidgetEnum.const_587:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_72,this.var_145);
               break;
            case RoomWidgetEnum.const_128:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_72,this.var_145);
               break;
            case RoomWidgetEnum.const_405:
               _loc3_ = new PollWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_378:
               _loc3_ = new UserChooserWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_571:
               _loc3_ = new FurniChooserWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_556:
               _loc3_ = new DimmerFurniWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_154:
               _loc3_ = new FriendRequestWidget(param2,this._windowManager,assets,this.var_72,this);
               break;
            case RoomWidgetEnum.const_535:
               _loc3_ = new ClothingChangeFurnitureWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_884:
               _loc3_ = new RoomWidgetBase(param2,this._windowManager);
               break;
            case RoomWidgetEnum.const_131:
               _loc3_ = new UserNotificationWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_133:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_145,this.var_72,this);
               break;
            case RoomWidgetEnum.const_656:
               _loc3_ = new WelcomeGiftWidget(param2,this._windowManager,assets,this.var_72);
               break;
            case RoomWidgetEnum.const_627:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_72,this.var_145,this._catalog);
               break;
