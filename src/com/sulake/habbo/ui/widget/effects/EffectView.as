package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2341:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_138:IWidgetAvatarEffect;
      
      private var var_705:IWindow;
      
      private var var_338:Number;
      
      private var var_577:ITextWindow;
      
      private var var_224:Timer;
      
      private var var_706:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_138 = param2;
         this._widget = param1;
         this.var_224 = new Timer(this.const_2341);
         this.var_224.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_224.stop();
            this.var_224.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_224 = null;
         }
         this._widget = null;
         this.var_138 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_138.isActive)
         {
            _loc2_ = this.var_138.secondsLeft / Number(this.var_138.duration);
            this.var_705.width = _loc2_ * this.var_338;
         }
         else
         {
            this.var_705.width = 0;
            this.var_224.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_577 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_577 == null)
            {
               return;
            }
         ...
         if(!this.var_138.isActive)
         {
            this.var_577.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_577.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_577.text;
         var _loc2_:int = this.var_138.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         this.var_577 = null;
         var _loc2_:String = "";
         if(this.var_138.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_138.isActive)
         {
         ...
         else
         {
            ...
            this.var_706 = this._window.findChildByName("effect_hilite");
            this.var_706.visible = false;
         }
         this.setTimeLeft();
         this.var_705 = this._window.findChildByName("loader_bar");
         if(this.var_705 != null)
         {
            this.var_338 = this.var_705.width;
            this.var_224.start();
            this.onUpdate();
         }
         if(this.var_138.icon)
         {
            this.setElementBitmap("effect_icon",this.var_138.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_138.type,this.var_138.isInUse);
         }
      }
