package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1993:String = "POLL_OFFER_STATE_OK";
      
      public static const const_814:String = "POLL_OFFER_STATE_CANCEL";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_1993;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_780,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_814;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_507,this._id));
