package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_688:String = "welcome_gift_email_unverified";
      
      private const const_1060:String = "welcome_gift_email_verified";
      
      private const const_1514:String = "welcome_gift_email_change";
      
      private const const_2317:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1222)
         {
            this.setViewState(this.const_1060);
         }
         else
         {
            this.setViewState(this.const_688);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_688:
               ...
               this._view.findChildByName("edit_text").visible = this.var_986;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_986);
               break;
            case this.const_1060:
            ...
            case this.const_1514:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_986);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1500;
               _loc6_.focus();
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_757,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1222 ? this.const_1060 : this.const_688);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_517,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_916,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_517,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_916,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_517:
               this.var_1500 = param1.email;
               this.var_1222 = param1.isVerified;
               this.var_986 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1500 = this.var_1501;
            this.setViewState(this.const_688);
         }
         else
         {
            if(param1.result == this.const_2317)
            {
               this.var_986 = false;
            }
