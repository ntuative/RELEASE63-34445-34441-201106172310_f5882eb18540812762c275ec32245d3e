package com.sulake.habbo.ui.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1584:Array = new Array("trophy_bg_gold","trophy_bg_silver","trophy_bg_bronze");
      
      private static const const_1585:Array = new Array(4293707079,4291411404,4290279476);
      ...
      private function showInterface() : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.color = const_1585[this._color];
         }
         ...
         _loc8_ = assets.getAssetByName(const_1584[this._color]) as BitmapDataAsset;
