package com.sulake.habbo.ui.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1404,const_1403,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_365 || this.var_234 == -1 || !this.var_28)
         {
            return;
         }
         this.var_365 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_961,this.var_234);
