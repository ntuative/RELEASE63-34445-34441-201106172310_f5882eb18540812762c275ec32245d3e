package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2224 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_657,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_657,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_478 = param1.location;
         var_1396 = param1.objectType;
         _text = "";
         var_352 = "FFFF33";
         var_28 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_234 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_891,var_234,this.var_478,_text,var_352);
