package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1507:int = 500;
      
      private static const const_1404:Number = 100;
      ...
      protected var var_2224:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_990,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_990,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1396 = param1.objectType;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2224,"",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1404,const_1403,2,2),null,0) as IWindowContainer;
         ...
         this.setColorButtons(this.var_28 && this.var_1396 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_495,this.var_234,this._text,this.var_352);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_495,this.var_234,this._text,this.var_352);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_906,this.var_234);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
