package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_560.numGridItems)
         {
            return;
         }
         this.select(this.var_560.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_560 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_560.destroyGridItems();
         this.var_235 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_1984) as IWindowContainer;
            ...
            this.var_560.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1273.width,this.var_1273.height,true,0);
      ...
      {
         var _loc2_:int = this.var_560.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1984 = XML(_loc2_.content);
         ...
         this.var_1273 = BitmapData(_loc3_.content);
