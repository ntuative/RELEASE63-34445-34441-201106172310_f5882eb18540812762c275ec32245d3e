package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_619:DimmerViewColorGrid;
      
      private var var_437:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1404,const_1403,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_619 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_437 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_437 != null)
         {
            this.var_437.setValue(this.var_1430);
         }
         this.var_530 = this.colors.indexOf(_loc2_.color);
         if(this.var_619 != null)
         {
            this.var_619.setSelectedColorIndex(this.var_530);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_437 != null)
         {
            this.var_437.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_619 != null)
         {
            this.var_619.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
