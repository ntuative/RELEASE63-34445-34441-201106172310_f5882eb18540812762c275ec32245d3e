package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private var var_2597:BitmapData;
      ...
      private var var_2596:BitmapData;
      
      private var var_2595:BitmapData;
      
      private var var_2593:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2597 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1882 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2594 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1883 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1881 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2596 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2595 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_86 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_366,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_90),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_86);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_43.height - const_90,param3.width,const_90),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_365,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_90),null,0) as IRegionWindow;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_43.width - this.var_2593;
         }
         if(this.var_86 != null)
         {
            this.var_86.rectangle = this.var_43.rectangle;
            this.var_86.height -= const_90;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2592 == this._window.width)
         {
            return;
         }
         this.var_2592 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2594;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1883;
            barX.disposesBitmap = false;
            this.var_2593 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2597,destBgBitmap);
         ...
         this.var_86.bitmap = this.var_2595;
