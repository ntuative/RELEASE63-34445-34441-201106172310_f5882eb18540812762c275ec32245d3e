package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1021:uint = 1;
      
      protected static const const_1020:uint = 2;
      
      protected static var var_1406:uint = const_1021;
      
      private static const const_1535:uint = 16744755;
      
      private static const const_1536:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1677)
         {
            ...
            {
               this.var_684 = const_1020;
            }
            else
            {
               this.var_684 = var_1406;
            }
         }
         if(this.var_684 == const_1021)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1396;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1397;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1536;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1535;
               }
            }
         }
         if(_loc3_)
