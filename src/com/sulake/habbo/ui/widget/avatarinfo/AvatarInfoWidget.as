package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1036:String = "use_minimized_own_avatar_menu";
      ...
      private var var_747:AvatarInfoView;
      
      private var var_746:OwnAvatarMenuView;
      
      private var var_748:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_2310 = Boolean(this.var_173.getBoolean("menu.avatar.enabled",false));
         this.var_1728 = this.var_173.getBoolean("menu.own_avatar.enabled",false);
         this.var_361 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_177,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_427,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_277,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_913 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_880,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_177,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_427,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_277,this.onEffectsChanged);
         this._view = null;
         this.var_173 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_169,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_350,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_158,this.updateEventHandler);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_321,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_191,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_609,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_985,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_169,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_350,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_158,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_321,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_191,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_609,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_435,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_133:
               ...
               if(this.var_1728 && _loc2_.allowNameChange)
               {
               ...
               {
                  this.updateView(_loc2_.userId,_loc2_.userName,_loc2_.roomIndex,RoomObjectTypeEnum.const_123,_loc2_.allowNameChange,null);
               }
               this._isInitialized = true;
               break;
            case RoomWidgetRoomObjectNameEvent.const_609:
               if(RoomWidgetRoomObjectNameEvent(param1).category == RoomObjectCategoryEnum.const_29)
               {
                  this.updateView(RoomWidgetRoomObjectNameEvent(param1).userId,RoomWidgetRoomObjectNameEvent(param1).userName,RoomWidgetRoomObjectNameEvent(param1).roomIndex,RoomObjectTypeEnum.const_123,false,null);
               }
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_321:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_985:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1725 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_908,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_435:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1725)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_169:
               _loc3_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.storeUserInfo(_loc3_);
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_123,false,!!_loc3_.isSpectatorMode ? null : this.var_238);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_579,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.PET_INFO:
               if(this.var_1727)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_200,false,null);
               }
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_191:
               ...
               for each(_loc7_ in this.var_361)
               {
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_343,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      private function storeUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.var_238.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_112;
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1728) : Boolean(this.var_2310);
         }
            ...
            if(!this.var_1726)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_746)
                     {
                        this.var_746 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_746;
                  ...
                  else
                  {
                     if(!this.var_748)
                     {
                        this.var_748 = new AvatarMenuView(this);
                     }
                     this._view = this.var_748;
               ...
               else
               {
                  if(!this.var_747)
                  {
                     this.var_747 = new AvatarInfoView(this);
                  }
                  this._view = this.var_747;
      ...
      private function showFriendName(param1:IUserData, param2:int) : void
      {
         ...
         if(this.var_361[param1.name] == null)
         {
            ...
            FriendNameView.setup(_loc3_,param1.webID,param1.name,-1,RoomObjectTypeEnum.const_123,param2);
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_216,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_216);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1036,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1036,!!param1 ? "1" : "0");
      }
   }
}
