package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserNotificationEvent.const_502,this.onDisplayNotification);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserNotificationEvent.const_502,this.onDisplayNotification);
      ...
      protected function onDisplayNotification(param1:RoomWidgetUserNotificationEvent) : void
      {
         ...
         _loc2_ = var_72.getLocalization(param1.title);
         var _loc3_:String = !!_loc2_ ? _loc2_.raw : param1.title;
         _loc2_ = var_72.getLocalization(param1.message);
