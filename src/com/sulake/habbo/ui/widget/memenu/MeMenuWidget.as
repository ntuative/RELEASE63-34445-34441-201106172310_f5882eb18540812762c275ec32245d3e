package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_175:String = "me_menu_top_view";
      
      public static const const_653:String = "me_menu_my_clothes_view";
      
      public static const const_1302:String = "me_menu_dance_moves_view";
      
      public static const const_942:String = "me_menu_settings_view";
      
      public static const const_788:String = "me_menu_sound_settings";
      
      private static const const_1043:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2377 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1728 = this._config.getBoolean("menu.own_avatar.enabled",false);
         (param1 as MeMenuWidgetHandler).widget = this;
         this.changeView(const_175);
         this.hide();
      }
      ...
      {
         return var_913 as MeMenuWidgetHandler;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_991,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_859,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_782,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_887,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1296,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1187,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_158,this.onAvatarDeselected);
         ...
         param1.addEventListener(RoomWidgetTutorialEvent.const_647,this.onTutorialEvent);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_442,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_991,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_859,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_782,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_887,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_158,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_248,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1296,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1187,this.onAvatarEditorClosed);
         ...
         param1.removeEventListener(RoomWidgetTutorialEvent.const_647,this.onTutorialEvent);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_529 && this.var_53.window.name == const_653))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_986);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_788)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_647:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_529 + " view: " + this.var_53.window.name);
               if(this.var_529 != true || this.var_53.window.name != const_175)
               {
                  return;
               }
               (this.var_53 as MeMenuMainView).setIconAssets("clothes_icon",const_175,"clothes_highlighter_blue");
               break;
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_529)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_796);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      private function onHabboClubEvent(param1:RoomWidgetHabboClubUpdateEvent) : void
      {
         ...
         this.var_2376 = param1.periodsLeft;
         this.var_3024 = param1.pastPeriods;
         this.var_2379 = param1.allowClubDances;
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2378 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2378.toString());
      }
