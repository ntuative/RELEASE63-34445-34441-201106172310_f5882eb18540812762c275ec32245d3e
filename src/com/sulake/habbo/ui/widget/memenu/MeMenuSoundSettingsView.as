package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_944:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_942 = param1.volume;
         if(this.var_944 != null)
         {
            this.var_944.setValue(this.var_942);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_945 = (_loc5_.content as BitmapData).clone();
         }
         this.var_944 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_790));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_942 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_945);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_943);
         }
         else
         {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_951);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_984);
         }
