package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2045:uint = 0;
      
      private const const_2302:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2045) : uint(this.const_2044);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_925)
         {
            return;
         }
         if(this.var_925 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_925) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_925 % 2) ? uint(this.const_2045) : uint(this.const_2044);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2302;
            this.var_925 = param1;
         }
      }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1714);
      }
