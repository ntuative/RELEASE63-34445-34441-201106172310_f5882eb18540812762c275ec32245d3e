package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1556:int = 9;
      
      private static const const_1555:int = 5;
      ...
      private var var_548:MusicInventoryGridView;
      
      private var var_820:PlayListEditorItemListView;
      
      private var var_244:MusicInventoryStatusView;
      
      private var var_328:PlayListStatusView;
      
      private var var_1910:IScrollbarWindow;
      
      private var var_1911:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_243 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_736,PlayListEditorWidgetAssetsEnum.const_1015,PlayListEditorWidgetAssetsEnum.const_552,PlayListEditorWidgetAssetsEnum.const_512,PlayListEditorWidgetAssetsEnum.const_962];
         ...
         this.createWindow();
         this.var_548 = new MusicInventoryGridView(param1,this.getMusicInventoryGrid(),param2);
         this.var_820 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
      ...
      public function destroy() : void
      {
         if(this.var_243)
         {
            this.var_243.stop(HabboMusicPrioritiesEnum.const_449);
            this.var_243 = null;
         }
         if(this.var_548)
         {
            this.var_548.destroy();
            this.var_548 = null;
         }
         if(this.var_820)
         {
            this.var_820.destroy();
            this.var_820 = null;
         }
         if(this.var_328)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1008,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_736);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_1015)
         {
            this.assignWindowBitmapByAsset(this.var_1007,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_1015);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_552)
         {
            this.var_244.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_552));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_512)
         {
            this.var_244.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_512));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_962)
         {
            this.var_328.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_962);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1910 = this.var_1008.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1911 = this.var_1007.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_328.selectView(PlayListStatusView.const_586);
         }
         else if(_loc1_.length > 0)
         {
            this.var_328.selectView(PlayListStatusView.const_1217);
         }
         else
         {
            this.var_328.selectView(PlayListStatusView.const_969);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_244.show();
            this.var_244.selectView(MusicInventoryStatusView.const_1002);
         }
         else if(this.var_243.getSongDiskInventorySize() <= const_1554)
         {
            this.var_244.show();
            this.var_244.selectView(MusicInventoryStatusView.const_943);
         }
         else
         {
            this.var_244.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_820.refresh(_loc2_,_loc3_);
      }
      ...
      public function onPlayListUpdated() : void
      {
         ...
         this.var_1911.visible = _loc1_.length > const_1555;
      }
      
      public function onSongDiskInventoryReceived() : void
      {
         this.var_548.refresh();
         this.selectMusicStatusViewByMusicState();
         this.var_1910.visible = this.var_548.itemCount > const_1556;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_103:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_820.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_134:
               this.var_548.setPreviewIconToPause();
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_125:
               this.var_548.setPreviewIconToPlay();
               this.selectMusicStatusViewByMusicState();
         }
      }
      ...
      {
         return this.var_243.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_449) != -1;
      }
   }
}
