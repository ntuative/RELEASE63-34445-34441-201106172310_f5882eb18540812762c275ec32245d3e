   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_628);
            }
            return;
         }
         ...
         if(this.var_1311 >= 0 && this.var_1311 < this._items.length)
         {
            _loc2_ = this._items[this.var_1311] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_628);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1148);
      ...
      {
         var _loc4_:int = 0;
         var _loc3_:* = param1.type == WindowMouseEvent.const_155;
