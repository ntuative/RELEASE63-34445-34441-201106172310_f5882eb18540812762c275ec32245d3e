package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_969:String = "PLSV_ADD_SONGS";
      
      public static const const_1217:String = "PLSV_START_PLAYBACK";
      
      public static const const_586:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_586)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_446[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_446[const_969];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_446.add(const_586,_loc1_);
