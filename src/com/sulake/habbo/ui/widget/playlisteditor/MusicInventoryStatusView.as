package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_1002:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_446.getValues())
         {
            _loc1_.destroy();
         }
         this.var_446 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_446[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1887.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_1002,"preview_play_background_image",param1);
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_446.add(const_1002,_loc1_);
            this.var_1888 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1887 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_552));
         ...
         if(_loc1_ != null)
         {
            this.var_446.add(const_943,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_512));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_446[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
