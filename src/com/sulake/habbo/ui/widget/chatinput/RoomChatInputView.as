package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1546:String = "${widgets.chatinput.say}";
      ...
      private var var_1891:IWindow;
      
      private var _button:IWindow;
      
      private var var_1890:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1244 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2613 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2614 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_381 = new Timer(1000,1);
         this.var_381.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_451 = new Timer(10000,1);
         this.var_451.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_451.reset();
            this.var_451.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_451 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1891 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1890 = this._window.findChildByName("send_button_text");
         this.var_1518 = this._window.findChildByName("block_text");
         this.var_1890.caption = const_1546;
         ...
         this.var_27.addEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_326,this.keyUpHandler);
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1891.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1547 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1548);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1244 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_661 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_661.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_660);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_119);
