package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_216);
         }
         this.var_1129 = true;
         this.container = null;
         this.var_13 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_277,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_909,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_866,this.onHelpTutorialEvent);
         ...
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_277,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_909,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_866,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1520)
            {
               ...
               this.var_1895 = _loc1_;
               this.var_1894 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1895;
               _loc2_ = this.var_1894;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_468)
               {
                  ...
                  if(_loc2_.height > const_468 - const_1090)
                  {
                     _loc8_.offset(0,_loc2_.height - const_468 + const_1090);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_972);
         _loc1_.push(RoomWidgetDanceMessage.const_826);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_911);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1158);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1378);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1303);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_872);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_928);
         _loc1_.push(RoomWidgetStopEffectMessage.const_750);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1854);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1326);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_521);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1914);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1245);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_968);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_986);
         _loc1_.push(RoomWidgetMeMenuMessage.const_796);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_790);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1901);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_951);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_984);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1190);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_401);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_986:
               ...
               break;
            case RoomWidgetWaveMessage.const_972:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_826:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_911:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1158:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1378:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_928:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1238)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_872:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1815:
                        this._catalog.openCatalogPage(CatalogPageName.const_1384,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1193:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_308);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1800:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2001:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1303:
            case RoomWidgetStopEffectMessage.const_750:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1326:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_968:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_796:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_521:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_216,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_216);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_594));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_790:
            ...
            case RoomWidgetStoreSettingsMessage.const_951:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_438,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_984:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_438,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1190:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_490));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_121:
               ...
               break;
            case HabboHelpTutorialEvent.const_866:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_647));
         }
      }
