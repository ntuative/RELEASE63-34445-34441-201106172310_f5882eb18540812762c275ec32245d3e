package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_615);
         _loc1_.push(InterstitialEvent.const_580);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_114);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_369);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_615:
               ...
               break;
            case InterstitialEvent.const_580:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_114:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_369:
               this._container.events.dispatchEvent(param1);
         }
      }
