package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_896:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_494.length)
            {
               _loc2_ = this.var_494.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1364)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_890,RoomWidgetChatSelectAvatarMessage.const_805];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_890:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1291))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_426);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_38) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1291))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_805:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_200)
                           {
                              _loc13_ = this.var_344.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_494.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_200:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_494.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1363 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1363);
            }
            if(this.var_896 == null)
            {
               ...
               this.var_584.y = 0;
               this.var_584.z = 0;
               this.var_896 = _loc4_.getScreenPoint(this.var_584);
               this.var_1363 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_584.x = 0;
            this.var_584.y = 0;
            this.var_584.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_584);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_896.x || _loc8_.y != this.var_896.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_896,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_494)
         {
            _loc2_ = this.var_494.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1364.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_115,this);
            if(_loc5_ != null)
            {
               _loc2_ = _loc5_.getCroppedImage(AvatarSetType.const_40);
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2125.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2125.remove(param1);
         if(_loc3_ != null)
         {
