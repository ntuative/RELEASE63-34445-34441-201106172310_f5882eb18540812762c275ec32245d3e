package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_243.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_226,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_226,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_721.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_721.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_243 != null)
         {
            this.var_243.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_659);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_908);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_881);
         _loc1_.push(RoomWidgetFurniActionMessage.const_290);
         _loc1_.push(RoomWidgetFurniActionMessage.const_855);
         _loc1_.push(RoomWidgetFurniActionMessage.const_885);
         _loc1_.push(RoomWidgetFurniActionMessage.const_976);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1200);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_941);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_935);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_929);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1747);
         _loc1_.push(RoomWidgetPetCommandMessage.const_541);
         _loc1_.push(RoomWidgetPetCommandMessage.const_848);
         _loc1_.push(RoomWidgetUserActionMessage.const_596);
         _loc1_.push(RoomWidgetUserActionMessage.const_292);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_858);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_542)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_292 || param1.type == RoomWidgetUserActionMessage.const_596 || param1.type == RoomWidgetUserActionMessage.const_651)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_659:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_908:
            ...
            case RoomWidgetUserActionMessage.const_530:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1330,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_610:
               ...
               break;
            case RoomWidgetUserActionMessage.const_881:
            ...
            case RoomWidgetFurniActionMessage.const_855:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_290:
            ...
            case RoomWidgetFurniActionMessage.const_885:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_976:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1200:
               ...
               break;
            case RoomWidgetUserActionMessage.const_292:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_941:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_935:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_929:
            ...
            case RoomWidgetUserActionMessage.const_520:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_848:
            ...
            case RoomWidgetPetCommandMessage.const_541:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_858:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_246);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_321);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_437) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_437);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_988) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1171;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_246);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1197);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1331);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_614)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_393) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_393.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_200)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_123)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_579)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_319);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_169)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_981);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_831;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1823);
               }
               else
               {
               ...
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_40,4);
                  _loc14_.image = _loc20_.getImage(AvatarSetType.const_40,true);
                  _loc20_.dispose();
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_721.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_721.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_981);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc4_ != null)
            {
               _loc2_ = _loc4_.getCroppedImage(AvatarSetType.const_40);
               _loc4_.dispose();
            }
         }
         else
