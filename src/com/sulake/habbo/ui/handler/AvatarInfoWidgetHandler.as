   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container)
         {
            ...
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_806,this.onUserNameUpdate);
         }
         this._container = param1;
         if(this._container)
         {
            this._container.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_806,this.onUserNameUpdate);
         }
      }
