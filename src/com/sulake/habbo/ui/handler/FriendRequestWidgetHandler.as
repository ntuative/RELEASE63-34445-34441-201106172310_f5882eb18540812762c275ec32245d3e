package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_851);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1000);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_904);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_851:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1000:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_904:
