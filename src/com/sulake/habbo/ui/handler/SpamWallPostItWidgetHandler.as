package com.sulake.habbo.ui.handler
{
   ...
   public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         this.var_2060 = new RequestSpamWallPostItMessageEvent(this.onSpamWallPostItRequest);
      ...
      private function onSpamWallPostItRequest(param1:RequestSpamWallPostItMessageEvent) : void
      {
         ...
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetSpamWallPostItEditEvent(RoomWidgetSpamWallPostItEditEvent.const_657,_loc3_,_loc4_,_loc5_));
            }
         }
      }
      ...
      {
         return [RoomWidgetSpamWallPostItEditEvent.const_657,RoomWidgetSpamWallPostItFinishEditingMessage.const_891];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetSpamWallPostItFinishEditingMessage.const_891:
