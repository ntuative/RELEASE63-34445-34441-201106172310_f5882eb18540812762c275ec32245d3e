package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1564:IMessageEvent;
      
      private var var_1972:IMessageEvent;
      
      private var var_1973:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_166,this.processSoundManagerEvent);
      ...
      {
         this.var_1564 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1972 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1973 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1564);
         this._connection.addMessageEvent(this.var_1972);
         this._connection.addMessageEvent(this.var_1973);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1564);
               this._connection.removeMessageEvent(this.var_1972);
               this._connection.removeMessageEvent(this.var_1973);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_166,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_871,RoomWidgetPlayListModificationMessage.const_963,RoomWidgetPlayListModificationMessage.const_973,RoomWidgetPlayListPlayStateMessage.const_965,RoomWidgetPlayListUserActionMessage.const_913];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_871:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_918,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_963:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_973:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_965:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_913:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_281);
         return _loc1_;
      }
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_810,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_917));
               break;
            case PlayListStatusEvent.const_105:
               ...
               break;
            case PlayListStatusEvent.const_166:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_166));
               break;
