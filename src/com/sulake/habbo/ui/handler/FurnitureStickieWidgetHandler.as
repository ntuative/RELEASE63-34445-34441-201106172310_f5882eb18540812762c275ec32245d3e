package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_815,RoomWidgetStickieSendUpdateMessage.const_906,RoomWidgetStickieSendUpdateMessage.const_495];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_815:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1173);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_990,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
            ...
            case RoomWidgetStickieSendUpdateMessage.const_495:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_906:
