package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_656;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_808 = [];
         this.var_808.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_808.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_808)
         {
            return;
         }
         for each(_loc1_ in this.var_808)
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChangeEmailMessage.const_722);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniActionMessage.const_757:
               ...
               break;
            case RoomWidgetChangeEmailMessage.const_722:
