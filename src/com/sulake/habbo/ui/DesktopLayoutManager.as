package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_705:String = "room_view";
      
      private static const const_1634:String = "room_widget";
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_336)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1634) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_100.getChildByTag(const_705) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_100.findChildByTag(const_705) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
