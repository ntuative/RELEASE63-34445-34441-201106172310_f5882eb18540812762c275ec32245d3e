package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_523:Number = 64;
      
      public static const const_1345:Number = 32;
      ...
      private var var_2036:Number = 1.0;
      ...
      private var var_3040:Number = -500.0;
      
      private var var_3039:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1307 = new Vector3d();
         this.var_2036 = 1;
         this.var_2037 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2038 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_478.assign(this.var_106);
         this.var_478.x *= this.var_475;
         this.var_478.y *= this.var_479;
         this.var_478.z *= this.var_477;
         return this.var_478;
      }
      ...
      {
         if(this.var_475 != param1 * this.var_2036)
         {
            this.var_475 = param1 * this.var_2036;
            ++this.var_183;
         }
      }
      ...
      {
         if(this.var_479 != param1 * this.var_2037)
         {
            this.var_479 = param1 * this.var_2037;
            ++this.var_183;
         }
      }
      ...
      {
         if(this.var_477 != param1 * this.var_2038)
         {
            this.var_477 = param1 * this.var_2038;
            ++this.var_183;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_475;
         this.var_106.y /= this.var_479;
         this.var_106.z /= this.var_477;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1308.assign(this.var_169);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_569 != null)
         {
            ...
            this.var_569.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_569.add(_loc3_,_loc4_);
            ++this.var_183;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_569 != null)
         {
            ...
            return this.var_569.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1307.assign(_loc22_);
         }
         else
         {
            this.var_1307.assign(_loc17_);
         }
         ++this.var_183;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_475;
         _loc2_.y *= this.var_479;
         _loc2_.z *= this.var_477;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1307);
         if(_loc3_ < this.var_3040 || _loc3_ > this.var_3039)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_479;
            _loc2_.z *= this.var_477;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1307);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_170,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_475,this.var_106.y * this.var_479,this.var_106.z * this.var_477);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_169;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_475,param2.y * this.var_479,param2.z * this.var_477);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_475,param3.y * this.var_479,param3.z * this.var_477);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_475,param4.y * this.var_479,param4.z * this.var_477);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1345;
         }
         else
         {
            this.scale = const_523;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_523;
      }
