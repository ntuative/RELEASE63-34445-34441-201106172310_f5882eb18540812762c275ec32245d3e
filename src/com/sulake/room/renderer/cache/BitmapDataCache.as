package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1067 = param1 * 1024 * 1024;
         this.var_2052 = param2 * 1024 * 1024;
         this.var_1612 = param3 * 1024 * 1024;
         if(this.var_1612 < 0)
         {
            this.var_1612 = 0;
         }
      ...
      {
         this.var_1067 += this.var_1612;
         if(this.var_1067 > this.var_2052)
         {
            this.var_1067 = this.var_2052;
         }
      }
