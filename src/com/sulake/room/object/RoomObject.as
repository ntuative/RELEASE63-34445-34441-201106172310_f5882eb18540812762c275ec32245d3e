package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_671:IRoomObjectEventHandler;
      ...
      public function RoomObject(param1:int, param2:int, param3:String)
      {
         ...
         this.var_670 = new Array(param2);
         var _loc4_:Number = param2 - 1;
         while(_loc4_ >= 0)
         {
            this.var_670[_loc4_] = 0;
            _loc4_--;
         }
         this._type = param3;
      ...
      {
         this.var_1951.assign(this.var_106);
         return this.var_1951;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1952.assign(this.var_476);
      ...
      {
         if(param1 >= 0 && param1 < this.var_670.length)
         {
      ...
      {
         if(param2 >= 0 && param2 < this.var_670.length)
         {
            if(this.var_670[param2] != param1)
            {
               this.var_670[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = this.var_671;
         if(_loc2_ != null)
         {
            this.var_671 = null;
            _loc2_.object = null;
