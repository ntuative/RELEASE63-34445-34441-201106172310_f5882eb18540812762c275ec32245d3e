   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_231 != null)
         {
            ...
            {
               _loc1_ = this.var_231[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_902.removeReference();
         }
         this.var_902 = param1;
         if(this.var_902 != null)
         {
            this.var_902.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_231.length > param1)
         {
            _loc2_ = this.var_231[this.var_231.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_231.length;
      }
      
      public function getSprite(param1:int) : IRoomObjectSprite
      {
         if(param1 >= 0 && param1 < this.var_231.length)
         {
