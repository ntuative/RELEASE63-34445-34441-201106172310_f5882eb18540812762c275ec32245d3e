package com.sulake.room
{
   ...
   public class RoomObjectManager implements IRoomObjectManager
   {
      ...
      {
         var _loc3_:Map = this.var_481.getValue(param1);
         if(_loc3_ == null && param2)
         {
            _loc3_ = new Map();
            this.var_481.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function reset() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_481.length)
            {
               _loc4_ = this.var_481.getWithIndex(_loc3_) as Map;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
