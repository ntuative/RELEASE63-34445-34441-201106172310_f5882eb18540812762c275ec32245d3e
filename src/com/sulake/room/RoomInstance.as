package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_174:IRoomRendererBase;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_272 != null)
         {
            ...
            {
               _loc3_ = this.var_272.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1439.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_640.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_640[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_174 != null)
            {
               this.var_174.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_174)
               {
                  this.var_174.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_174)
                  {
                     this.var_174.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_174.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_272.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_272.getValue(_loc2_) != null)
         {
            return this.var_272.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_272.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_272.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_272.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
